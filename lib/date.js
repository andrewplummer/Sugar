  ...
  Locale.prototype = {
    ...
    init: function(def) {
      ...
      function buildTimeFormats() {
        ...
        loc.parsingAliases['timeWithZone'] = getTimeWithZoneFormat();
        loc.parsingAliases['isoTimeWithZone'] = getTimeWithZoneFormat(true);
      }
      ...
      function getTimeWithZoneFormat(iso) {
        ...
        var zone = '(?:{Z}|{GMT?}(?:{tzSign}{tzHour}(?::?{tzMinute}(?: \\([\\w\\s]+\\))?)?)?)?';

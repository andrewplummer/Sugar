  ...
  function createDate(args, forceUTC, prefer) {
    var f;
    if(isNumber(args[1])) {
    ...
    return getExtendedDate(f, args[1], prefer, forceUTC).date;
  }
  ...
  date.extend({
     ...
     ***/
    'past': function() {
      return createDate(arguments, false, -1);
    },
    ...
    'is': function(d, margin) {
      ...
      if(isString(d)) {
        ...
        switch(true) {
          ...
          case (tmp = English['weekdays'].indexOf(d) % 7) > -1: return callDateGet(this, 'Day') === tmp;
          case (tmp = English['months'].indexOf(d) % 12) > -1:  return callDateGet(this, 'Month') === tmp;
        }
      }

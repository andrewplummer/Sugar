...
defineStatic(sugarDate, {
   ...
   * @returns Date
   * @static
   * @short Alternate date constructor which accepts many different text
   *        formats, a timestamp, or another date.
...
defineInstance(sugarDate, {
   ...
   *        used). See `date formats` for more.
   *
   * @example
   *
   ...
   *        also be passed in place of [fn]. For more, see `date formats`.
   *
   * @callback fn
   *
   ...
   *   new Date().relative(function(val, unit, ms, loc) {

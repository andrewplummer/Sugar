...
function collectDateParamsFromArguments(args) {
  var params = {}, index = 0;
  walkFromUnitDown(YEAR_INDEX, function(unit) {
    var arg = args[index++];
    if (isDefined(arg)) {
...
// Years -> Milliseconds skipping where appropriate
function walkFromUnitDown(unitIndex, fn) {
  while (unitIndex >= 0) {
...
// Years -> Milliseconds with "weekday"
...
function setUnitAndLowerToEdge(d, startIndex, end) {
  walkFromUnitDown(startIndex, function(unit) {

  ...
  function compareDate(d, find, buffer, forceUTC, localeCode) {
      ...
      if(i < 3) {
        ['Last','This','Next'].forEach(function(shift) {
          methods['is' + shift + caps] = function() {
            return this.is(shift + ' ' + name, 0, null, 'en');
          };
        });
      }
      if(i < 4) {
  ...
  date.extend({
    ...
    'setWeekday': function(dow) {
     ...
     /***
     * @method getISOWeekday()
     * @returns Nothing
     * @short Set the date's weekday as defined by this ISO-8601 standard.
     * @extra Note that this standard places Sunday at the end of the week (day 7).
     */
    'setISOWeekday': function(dow) {
      if(isUndefined(dow)) return;
      return this.getDay() === 0 ? this.addDays(dow-7).getTime() : this.setWeekday(dow);
    },

     /***
     * @method getISOWeekday()
     * @returns Number
     * @short Get the date's weekday as defined by this ISO-8601 standard.
     * @extra Note that this standard places Sunday at the end of the week (day 7).
     */
     ...
     * @extra Note that this standard places Monday at the start of the week (day 1).
     */
    'beginningOfISOWeek': function() {
      this.setISOWeekday(1);
      return this.reset()
    },
     ...
     * @extra Note that this standard places Sunday at the end of the week (day 1).
     */
    'endOfISOWeek': function() {
      this.setISOWeekday(7);
     ...
     *
     ***/
    'is': function(d, margin, utc, localeCode) {
      var tmp, comp;
      ...
      return compareDate(this, d, margin, utc, localeCode);
    },

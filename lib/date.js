...
defineInstance(sugarDate, {
  ...
  /***
   * @method format([f], [code] = currentLocaleCode)
   * @returns String
   ...
   *        not specified, the locale specific `{long}` format is used. [code]
   ...
   *
   ***
   * @method short([code] = currentLocaleCode)
   * @returns String
   * @short Outputs the date in the short format for the current locale.
   * @extra [code] overrides the current locale code if passed.
   *
   * @example
   *
   ...
   *
   ***
   * @method medium([code] = currentLocaleCode)
   * @returns String
   ...
   *
   ***
   * @method long([code] = currentLocaleCode)
   * @returns String
   ...
   *
   ***
   * @method full([code] = currentLocaleCode)
   * @returns String
  ...
  /***
   * @method relative([code] = currentLocaleCode, [fn])
   * @returns String
  ...
  /***
   * @method relativeTo(d, [code] = currentLocaleCode)
   * @returns String
   * @short Returns the date in a text format relative to `d`, such as
   *        "5 minutes".
   * @extra `d` will accept a date object, timestamp, or string. [code]
  ...
  /***
   * @method reset([unit] = 'day', [code] = currentLocaleCode)
   * @returns Date
   ...
   *        resets the time. [code] is provided for resetting weeks, which
...
defineInstance(sugarNumber, {
  ...
  /***
   * @method duration([code] = currentLocaleCode)
   * @returns String
   ...
   *        equivalent of "from now" or "ago". [code] can be passed as the

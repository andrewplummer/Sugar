  ...
  function getExtendedDate(contextDate, args) {
    ...
    function cloneDateByFlag(d) {
      ...
      if (utc && !isDefined(options.fromUTC)) {
        options.fromUTC = true;
      }
      if (utc && !isDefined(options.setUTC)) {
        options.setUTC = true;
      }
      return clone;
    }
  ...
  defineStaticWithArguments(sugarDate, {
     ...
     * @extra If no argument is given, the date is assumed to be now. %Date.create% additionally can accept enumerated parameters as with the standard date constructor. [options] can be either an options object or a string identifying the locale code for parsing text dates in other languages. For more see %date_options%.
     *
     * @example
     *
  ...
  defineInstanceWithArguments(sugarDate, {
     ...
     * @extra For most purposes, this method is identical to %Date.create%, except that if a relative format such as "next week" is passed, it will be relative to the instance rather than the current time. [options] can be either an options object or a string identifying the locale code for parsing text dates in other languages. For more see %date_options%.
     *
     * @example
     *

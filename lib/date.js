  ...
  // A custom internal date constructor.
  var newDateInternal;
  ...
  function getLocale(code, noFallback) {
  ...
  function getNewDate() {
    return newDateInternal ? newDateInternal() : new Date;
  }
  ...
  function buildEnglish() {
    English = currentLocale = sugarDate.addLocale('en', DefaultEnglish);
  ...
  function getEnglishVariant(v) {
    return simpleMerge(simpleClone(BaseEnglishLocale), v);
  }

  var BaseEnglishLocale = {
    'plural':     true,
    'timeMarker': 'at',
    'ampm':       'AM,PM,a,p',
  ...
  var AmericanEnglish = getEnglishVariant({
    'mdy': true,
    'firstDayOfWeek': 0,
  ...
  var BritishEnglish = getEnglishVariant({
    'short':  '{dd}/{MM}/{yyyy}',
    'medium': '{d} {Month} {yyyy}',
  ...
  var CanadianEnglish = getEnglishVariant({
    'short':  '{yyyy}-{MM}-{dd}',
    'medium': '{d} {Month}, {yyyy}',
    'long':   '{d} {Month}, {yyyy} {H}:{mm}',
    'full':   '{Weekday}, {d} {Month}, {yyyy} {time}',
  ...
  var DefaultEnglish = AmericanEnglish;

  var LazyLoadedLocales = {
    'en-US': AmericanEnglish,
    'en-GB': BritishEnglish,
    'en-AU': BritishEnglish,

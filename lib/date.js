  ...
  // todo add comments
  // TODO this methods = {} needs to go away!
  // TODO GET RID OF Array#has
  // TODO enumerable methods on hashes
  ...
  function getAdjustedUnit(ms) {
    ...
    DateUnitsReversed.slice(1).each(function(u, i) {
  ...
  function buildAsianDigits() {
    ...
    FullWidthDigits.split('').each(function(digit, value) {
      AsianDigitMap[digit] = value;
    });

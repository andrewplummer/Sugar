  ...
  function compareDate(d, find, buffer) {
    ...
    max += (getTimezoneOffset(d) - getTimezoneOffset(p.date)).minutes();
  ...
  date.extend({
    ...
    'getUTCOffset': function(iso) {
      var offset = this.utc ? 0 : getTimezoneOffset(this);
      var colon  = iso === true ? ':' : '';
    ...
    'toUTC': function() {
      ...
      var d = this.clone().addMinutes(getTimezoneOffset(this));
      d.utc = true;
      return d;
    },
     ...
     ***/
    'isUTC': function() {
      return this.utc || getTimezoneOffset(this) === 0;
    },

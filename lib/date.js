  ...
  function collectParamsFromArguments(args) {
    var obj = {}, i = 0, u = dateUnitsByName['year'];
      ...
      if (baseLocale) {
        iterateOverObject(baseLocale.getFormats(), function(i, dif) {
          ...
          if (match) {
            ...
            // Handle fractional time values.
            iterateOverLowerDateUnits(function(name, u, i) {

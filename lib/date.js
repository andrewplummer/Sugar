  ...
  function getExtendedDate(contextDate, args) {
    ...
    function checkNumAsHours(set) {
      if (set.num && !set.month && !set.unit) {
        // If we have just a number and no month or unit, then assume a format
        // like "Sunday at 3" or "yesterday at 12", and set the number as hours.
        set.hours = set.num;
        delete set.num;
      }
    }

  ...
  var EnumerableMapping  = 'map,sum,average,min,max,least,most';
  var EnumerableMatching = 'any,all,none,filter,count,find,findAll';
  ...
  buildEnumerableMethods(EnumerableMatching);
  buildEnumerableMethods(EnumerableMapping, true);

  ...
  extend(Array, {
     ...
     * @extra [context] is the `this` object if passed. When <f> is a function, will use native implementation if it exists. <f> will also match a string, number, array, object, or alternately test against a function or regex. This method implements `enhanced matching`.
     * @example
     *
  ...
  extend(Array, {
     ...
     * @extra <f> will match a string, number, array, object, or alternately test against a function or regex. Will continue from index = 0 if [loop] is true. This method implements `enhanced matching`.
     * @example
     *
     ...
     * @extra <f> will match a string, number, array, object, or alternately test against a function or regex. Starts at [index], and will continue once from index = 0 if [loop] is true. This method implements `enhanced matching`.
     * @example
     *
     ...
     * @extra <f> will match a string, number, array, object, or alternately test against a function or regex. This method implements `enhanced matching`.
     * @example
     *
     *   [1,2,3,1].count(1)       -> 2
     *   ['a','b','c'].count(/b/) -> 1
     ...
     * @extra This is a non-destructive alias for `remove`. It will not change the original array. This method implements `enhanced matching`.
     * @example
     *
     *   [1,2,3].exclude(3)         -> [1,2]
     *   ['a','b','c'].exclude(/b/) -> ['a','c']
     ...
     * @returns Array
     * @short Removes any element in the array that matches [f1], [f2], etc.
     * @extra Will match a string, number, array, object, or alternately test against a function or regex. This method will change the array! Use `exclude` for a non-destructive alias. This method implements `enhanced matching`.
     * @example
     *
     *   [1,2,3].remove(3)         -> [1,2]
     *   ['a','b','c'].remove(/b/) -> ['a','c']

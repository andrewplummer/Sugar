...
defineInstance(sugarArray, {
   ...
   *        that if <el> is an array it will be joined, not inserted. However,
   *        unlike `concat` this method changes the array! `add` is provided as
   *        a non-destructive alias. Additionally, `insert` is also provided as
   *        an alias that reads better when using an index.
   *
   * @example
   *

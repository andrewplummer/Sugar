   ...
   *
   ***/
  function buildObjectEnumerable(names, mapping) {
    names = commaSplit(names);
  ...
  buildArrayAliases();
  buildObjectEnumerable('sum,average,min,max,least,most', true);
  buildObjectEnumerable('any,all,none,count,find,findAll,isEmpty');

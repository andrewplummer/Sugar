...
function buildClassChecks() {
  ...
  function buildClassCheck(className) {
    return className === 'Array' && Array.isArray || function(obj, cached) {
      // PERF: Returning up front on instanceof appears to be slower.
      return isClass(obj, className, cached);
    };
  }
...
function isClass(obj, className, cached) {
  var k = cached || classToString(obj);
  return k === '[object '+ className +']';
}

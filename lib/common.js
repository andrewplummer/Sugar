  ...
  var sugarObject = Sugar.Object, sugarArray = Sugar.Array, sugarDate = Sugar.Date, sugarString = Sugar.String, sugarNumber = Sugar.Number, sugarFunction = Sugar.Function;
  ...
  function defineSimilar(namespace, set, fn, instance) {
    var methods = {};
    if (isString(set)) {
      set = set.split(',');
    }
    ...
    defineMethods(namespace, methods, instance);
  }

...
var TYPE_CHECK_NAMES = ['Boolean','Number','String','Date','RegExp','Function','Array','Set','Map'];
...
function buildClassChecks() {
  ...
  var knownTypes = {}, allowConstructor = false;
  ...
  function addCoreTypes() {
    ...
    isSet = buildClassCheck(TYPE_CHECK_NAMES[7], typeof Set !== 'undefined' && Set);
    isMap = buildClassCheck(TYPE_CHECK_NAMES[8], typeof Map !== 'undefined' && Map);
  ...
  function isKnownType(obj, className) {
    var check = knownTypes[className];
    if (!check && allowConstructor) {
      check = knownTypes[String(obj.constructor)];
    }
    return check;
  }

  function buildClassCheck(className, globalObject) {
    if (globalObject && isClass(globalObject, 'Object')) {

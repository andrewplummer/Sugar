...
Sugar.Date.addLocale('fi', {
    ...
    'ampm':       ',',
    'months':     'tammikuu:ta|,helmikuu:ta|,maaliskuu:ta|,huhtikuu:ta|,toukokuu:ta|,kesäkuu:ta|,heinäkuu:ta|,elokuu:ta|,syyskuu:ta|,lokakuu:ta|,marraskuu:ta|,joulukuu:ta|',
    'weekdays':   'sunnuntai:|na,maanantai:|na,tiistai:|na,keskiviikko:|na,torstai:|na,perjantai:|na,lauantai:|na',
    'units':      'millisekun:ti|tia|nin|teja|tina,sekun:ti|tia|nin|teja|tina,minuut:ti|tia|in|teja|tina,tun:ti|tia|nin|teja|tina,päiv:ä|ää|än|iä|änä,viik:ko|koa|on|koja|kona,kuukau:si|tta|den+kuussa,vuo:si|tta|den|sia|tena',

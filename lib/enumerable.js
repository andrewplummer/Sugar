   ...
   * @package Enumerable
   * @dependency core
   * @description Enumerable methods on both arrays and objects, "fuzzy matching" against elements.
   *
   ***/
  ...
  function buildObjectEnumerable() {
    ...
    defineInstanceAndStaticSimilar(sugarObject, 'any,all,filter,none,count,find,isEmpty', function(methods, name) {

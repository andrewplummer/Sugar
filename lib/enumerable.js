...
defineInstance(sugarArray, {
  ...
  /***
   * @method findFrom(<f>, [start] = 0, [loop] = false)
   * @returns Array
   * @short Returns any element that matches <f>, beginning from [start].
   ...
   *
   ***/
  'findFrom': function(arr, f, start, loop) {
    return arrayFindFrom(arr, f, start, loop);
  },

  /***
   * @method filterFrom(<f>, [start] = 0, [loop] = false)
   * @returns Array
   * @short Returns any elements that match <f>, beginning from [start].
   * @extra <f> will match a string, number, array, object, or alternately test against a function or regex. Will continue from index = 0 if [loop] is true. This method implements `matching shortcuts`.
   * @example
   *
   ...
   *
   ***/
  'filterFrom': function(arr, f, start, loop) {
    return arrayFindFrom(arr, f, start, loop, true);
  },

  /***
   * @method findIndexFrom(<f>, [start] = 0, [loop] = false)
   * @returns Array
   * @short Returns the index of any element that matches <f>, beginning from [start].
   * @extra <f> will match a string, number, array, object, or alternately test against a function or regex. Will continue from index = 0 if [loop] is true. This method implements `matching shortcuts`.
   * @example
   *
   ...
   *
   ***/
  'findIndexFrom': function(arr, f, start, loop) {
    var index = arrayFindFrom(arr, f, start, loop, false, true);

...
function getMinOrMax(obj, map, all, max, asObject) {
  var result = [], pushVal, edge;
...
function getLeastOrMost(obj, map, all, most, asObject) {
  ...
  if (all) {
    result = [];
    // Flatten result
    forEachProperty(minMaxResult, function(val, key) {

...
defineInstance(sugarArray, {
   ...
   *        a property or invokes a function on each element. Functions are
   *        called with no arguments. If arguments are required, pass a
   *        function for <map> instead. Supports `deep properties`.
   *
   * @callback map
   *
   *   el   The element of the current iteration.
...
defineInstanceAndStatic(sugarObject, {
   ...
   *        element in the array. If [init] is not passed, then a

...
defineInstanceAndStatic(sugarObject, {
   ...
   * @returns Object
   * @short Builds a new object containing the properties specified in <find>.
   ...
   * @returns Object
   * @short Builds a new object containing all properties except those in <find>.
...
function buildHashEnumerable() {
  ...
  var methods = [
    'select', 'reject', 'isEmpty','size','each',

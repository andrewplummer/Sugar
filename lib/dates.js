...
(function() {
  ...
  var TimeFormat = ['12hr','hour','minute','second','12hr','utc','offset_sign','offset_hours','offset_minutes']
  var FloatReg = '\\d{1,2}(?:[,.]\\d+)?';
  var RequiredTime = '({t})?\\s*('+FloatReg+'){h}('+FloatReg+')?{m}('+FloatReg+')?{s}\\s*(am|pm)?(?:(Z)|(?:([+-])(\\d{2})(?::?(\\d{2}))?)?)?';

...
(function() {
  ...
  var TimeFormat = ['meridian','hour','minute','second','meridian','utc','offset_sign','offset_hours','offset_minutes']
  var FloatReg = '\\d{1,2}(?:[,.]\\d+)?';
  var RequiredTime = '({meridian})?\\s*('+FloatReg+'){h}('+FloatReg+')?{m}('+FloatReg+')?{s}\\s*(am|pm)?(?:(Z)|(?:([+-])(\\d{2})(?::?(\\d{2}))?)?)?';
  var OptionalTime = '(?:[,\\s]*(?:t|at |[\\s\\u3000]+)' + RequiredTime + ')?';
  var FrontOptionalTime = '(?:' + RequiredTime + ')[,\\s\\u3000]+?';
  ...
  var CommonLocales = {
    ...
    'en': '2;;January,February,March,April,May,June,July,August,September,October,November,December;Sunday,Monday,Tuesday,Wednesday,Thursday,Friday,Saturday;millisecond:|s,second:|s,minute:|s,hour:|s,day:|s,week:|s,month:|s,year:|s;one,two,three,four,five,six,seven,eight,nine,ten;a,an,the;the,st|nd|rd|th,of;am,pm;;{num} {unit} {sign},{num} {unit=4-5} {sign} {day},{weekday?} {month} {date}{1} {year?} {time?},{date?} {month} {year} {time?},{month} {year},{shift?} {weekday} {time?},{shift} week {weekday} {time?},{shift} {unit=5-7},{0} {edge} of {shift?} {unit=4-7?}{month?}{year?},{weekday} {2} {shift} week {time?},{0} {date}{1} of {month} {time?},{0}{month?} {date?}{1} of {shift} {unit=6-7} {time?},{day} {time?},{time} {day};{Month} {d}, {yyyy};,yesterday,today,tomorrow;,ago|before,,from now|after|from;,last,the|this,next;last day,end,,first day|beginning',

    'ja': '1;月;;日曜日,月曜日,火曜日,水曜日,木曜日,金曜日,土曜日;ミリ秒,秒,分,時間,日,週間|週,ヶ月|ヵ月|月,年;;;;午前,午後;時,分,秒;{num}{unit}{sign},{shift}{unit=5-7}{weekday?}{time?},{year}年{month?}月?{date?}日?{time?},{month}月{date?}日?{time?},{date}日{time?};{yyyy}年{M}月{d}日;一昨日,昨日,今日,明日,明後日;,前,,後;,去|先,,来',

    'ko': '1;월;;일요일,월요일,화요일,수요일,목요일,금요일,토요일;밀리초,초,분,시간,일,주,개월|달,년;일|한,이,삼,사,오,육,칠,팔,구,십;;;오전,오후;시,분,초;{num}{unit} {sign},{shift?} {unit=5-7},{shift} {unit=5?} {weekday}{time?},{year}년{month?}월?{date?}일?{time?},{month}월{date?}일?{time?},{date}일{time?};{yyyy}년{M}월{d}일;그저께,어제,오늘,내일,모레;,전,,후;,지난|작,이번,다음|내',

    'ru': '4;;Январ:я|ь,Феврал:я|ь,Март:а|,Апрел:я|ь,Ма:я|й,Июн:я|ь,Июл:я|ь,Август:а|,Сентябр:я|ь,Октябр:я|ь,Ноябр:я|ь,Декабр:я|ь;Воскресенье,Понедельник,Вторник,Среда,Четверг,Пятница,Суббота;миллисекунд:а|у|ы|,секунд:а|у|ы|,минут:а|у|ы|,час:||а|ов,день|день|дня|дней,недел:я|ю|и|ь|е,месяц:||а|ев|е,год|год|года|лет|году;од:ин|ну,дв:а|е,три,четыре,пять,шесть,семь,восемь,девять,десять;;в|на,года;am,pm;;{num} {unit} {sign},{sign} {num} {unit},{date} {month} {year?} {1}{time?},{month} {year},{0} {shift} {unit=5-7},{0} {shift} {weekday}{time?};{d} {month} {yyyy} года;позавчера,вчера,сегодня,завтра,послезавтра;,назад,,через;,прошл:ый|ой|ом,,следующ:ий|ей|ем',

    'es': '6;;enero,febrero,marzo,abril,mayo,junio,julio,agosto,septiembre,octubre,noviembre,diciembre;domingo,lunes,martes,miércoles|miercoles,jueves,viernes,sábado|sabado;milisegundo:|s,segundo:|s,minuto:|s,hora:|s,día|días|dia|dias,semana:|s,mes:|es,año|años|ano|anos;uno,dos,tres,cuatro,cinco,seis,siete,ocho,nueve,diez;;el,de;am,pm;;{sign} {num} {unit},{num} {unit} {sign},{shift} {weekday}{time?},{weekday} {shift}{time?},{date?} {1} {month} {1} {year?}{time?},{0} {unit=5-7} {shift},{0} {shift} {unit=5-7};{d} de {month} de {yyyy};anteayer,ayer,hoy,mañana|manana;,hace,,de ahora;,pasad:o|a,,próximo|próxima|proximo|proxima',

    'pt': '6;;janeiro,fevereiro,março,abril,maio,junho,julho,agosto,setembro,outubro,novembro,dezembro;domingo,segunda-feira,terça-feira,quarta-feira,quinta-feira,sexta-feira,sábado|sabado;milisegundo:|s,segundo:|s,minuto:|s,hora:|s,dia:|s,semana:|s,mês|mêses|mes|meses,ano:|s;um,dois,três|tres,quatro,cinco,seis,sete,oito,nove,dez,uma,duas;;a,de;am,pm;;{num} {unit} {sign},{sign} {num} {unit},{date?} {1} {month} {1} {year?}{time?},{0} {unit=5-7} {shift},{0} {shift} {unit=5-7},{0} {shift} {weekday}{time?};{d} de {month} de {yyyy};anteontem,ontem,hoje,amanh:ã|a;,atrás|atras|há|ha,,daqui a;,passad:o|a,,próximo|próxima|proximo|proxima',

    'fr': '2;;janvier,février|fevrier,mars,avril,mai,juin,juillet,août,septembre,octobre,novembre,décembre|decembre;dimanche,lundi,mardi,mercredi,jeudi,vendredi,samedi;milliseconde:|s,seconde:|s,minute:|s,heure:|s,jour:|s,semaine:|s,mois,an:|s|née|nee;un:|e,deux,trois,quatre,cinq,six,sept,huit,neuf,dix;;l\'|la|le;am,pm;;{sign} {num} {unit},{sign} {num} {unit},{0} {date?} {month} {year?}{time?},{0} {unit=5-7} {shift},{0} {weekday} {shift}{time?};{d} {month} {yyyy};,hier,aujourd\'hui,demain;,il y a,,dans|d\'ici;,derni:èr|er|ère|ere,,prochain:|e',

    'it': '2;;Gennaio,Febbraio,Marzo,Aprile,Maggio,Giugno,Luglio,Agosto,Settembre,Ottobre,Novembre,Dicembre;Domenica,Luned:ì|i,Marted:ì|i,Mercoled:ì|i,Gioved:ì|i,Venerd:ì|i,Sabato;millisecond:o|i,second:o|i,minut:o|i,or:a|e,giorn:o|i,settiman:a|e,mes:e|i,ann:o|i;un:|\'|a|o,due,tre,quattro,cinque,sei,sette,otto,nove,dieci;;l\'|la|il;am,pm;;{num} {unit} {sign},{weekday?} {date?} {month} {year?}{time?},{0} {unit=5-7} {shift},{0} {shift} {unit=5-7},{shift} {weekday}{time?};{d} {month} {yyyy};,ieri,oggi,domani,dopodomani;,fa,,da adesso;,scors:o|a,,prossim:o|a',

    'de': '2;;Januar,Februar,März|Marz,April,Mai,Juni,Juli,August,September,Oktober,November,Dezember;Sonntag,Montag,Dienstag,Mittwoch,Donnerstag,Freitag,Samstag;Millisekunde:|n,Sekunde:|n,Minute:|n,Stunde:|n,Tag:|en,Woche:|n,Monat:|en,Jahr:|en;ein:|e|er|em|en,zwei,drei,vier,fuenf,sechs,sieben,acht,neun,zehn;;der;am,pm;;{sign} {num} {unit},{num} {unit} {sign},{weekday?} {date?} {month} {year?}{time?},{shift} {unit=5-7},{shift} {weekday}{time?};{d}. {Month} {yyyy};vorgestern,gestern,heute,morgen,übermorgen|ubermorgen|uebermorgen;,vor:|her,,in;,letzte:|r|n|s,,nächste:|r|n|s+naechste:|r|n|s+kommende:n|r',

    'zh-TW': '1;月;;日,一,二,三,四,五,六;毫秒,秒鐘,分鐘,小時,天,個星期|週,個月,年;;;日|號;上午,下午;點,分鐘?,秒;{num}{unit}{sign},星期{weekday}{time?},{shift}{unit=5-7},{shift}{unit=5}{weekday}{time?},{year}年{month?}月?{date?}{0}{time?},{month}月{date?}{0}{time?},{date}{0}{time?};{yyyy}年{M}月{d}日;前天,昨天,今天,明天,後天;,前,,後;,上|去,這,下|明',

    'zh-CN': '9;月;;日,一,二,三,四,五,六;毫秒,秒钟,分钟,小时,天,个星期|周,个月,年;;;日|号;上午,下午;点,分钟?,秒;{num}{unit}{sign},星期{weekday}{time?},{shift}{unit=5-7},{shift}{unit=5}{weekday}{time?},{year}年{month?}月?{date?}{0}{time?},{month}月{date?}{0}{time?},{date}{0}{time?};{yyyy}年{M}月{d}日;前天,昨天,今天,明天,后天;,前,,后;,上|去,这,下|明'

  }

  function addDateInputFormat(format, match, variant, locale, front) {
    var target = locale ? locale.compiledFormats : CoreDateFormats;
    target[front ? 'unshift' : 'push']({
      variant: variant,
  ...
  function getLocalization(localeCode, set) {
    var loc;
    if(!localeCode || !object.isString(localeCode)) return CurrentLocalization;
    loc = Localizations[localeCode] || Localizations[localeCode.slice(0,2)];
    if(!loc || set)  loc = setLocalization(localeCode, set);
    return loc;
  }
  ...
  function setLocalization(localeCode, set) {
    ...
    time = prepareTime(OptionalTime, loc);

    addDateInputFormat('(' + loc['months'].compact().join('|') + ')', ['month'], false, loc);
    addDateInputFormat('(' + loc['weekdays'].compact().join('|') + ')' + time, ['weekday'].concat(TimeFormat), false, loc);
    addDateInputFormat('(' + loc['modifiers'].filter(function(m){ return m.name === 'day'; }).map('src').join('|') + ')' + time, ['day'].concat(TimeFormat), false, loc);
  ...
  object.merge(Localization.prototype, {
    ...
    matchPostMeridian: function(str) {
      return str && (str === this['postMeridian'] || str === 'pm');
    },
    ...
    addFormat: function(src, add) {
      ...
      src = src.replace(/\{(.+?)\}/g, function(all, k) {
        ...
        if(key === 's') {
          ...
          return prepareTime(opt ? OptionalTime : RequiredTime, loc);
        }
        if(nc) {
      ...
      addDateInputFormat(src, to, false, this);
    }
  ...
  function convertKanjiDigits(str) {
    return str.replace(KanjiDigitReg, function(full, disallowed, match) {
  ...
  function cleanDateInput(str) {
    ...
    return convertKanjiDigits(str.hankaku('n'));
  }

  function getExtendedDate(f, localeCode) {
    var d = new date(), relative = false, baseLocalization, loc, format, set, unit, num, tmp;
    if(object.isDate(f)) {
      d = f;
      ...
      baseLocalization.compiledFormats.each(function(dif) {
        ...
        if(match) {
          ...
          if(format.variant && !object.isString(set['month']) && (object.isString(set['date']) || loc.hasVariant(localeCode))) {
            tmp = set['month'];
            set['month'] = set['date'];
            set['date']  = tmp;
          }
          ...
          if(loc.matchPostMeridian(set['meridian']) && set['hour'] < 12) {
            set['hour'] += 12;
          }
  ...
  function formatDate(date, f, relative, localeCode) {
    var adu, loc = getLocalization(localeCode), caps = regexp(/^[A-Z]/), value, l;
    if(!date.isValid()) {
      return 'Invalid Date';
    } else if(Date[f]) {
      f = Date[f];
  ...
  function buildDateInputFormats() {
    var leadingTime = prepareTime(FrontOptionalTime),
        trailingTime = prepareTime(OptionalTime),
        month = '\\d{1,2}|' + English['months'].join('|'),
        formats;
    formats = [
      // @date_format 2010
      { src: '(\\d{4})', to: ['year'] },
      ...
      // @date_format 2010/05/25
      { src: '([+-])?(\\d{4})[-.]?('+ month +')[-.]?(\\d{1,2})?', to: ['year_sign','year','month','date'], time: true },
      // @date_format 05-25
      // @date_format 05/25
      // @date_format 05.25
      ...
      // @date_format 05/25/2010
      // @date_format 05.25.2010
      { src: '(\\d{1,2})[-.\\/]('+ month +')[-.\\/]?(\\d{2,4})?', to: ['date','month','year'], variant: true, time: true},
    ...
    formats.each(function(f) {
      var src = f.src, to = f.to;
      if(f.time) {
        src += trailingTime;
        to  = to.concat(TimeFormat);
        addDateInputFormat(leadingTime + f.src, TimeFormat.concat(f.to), f.variant);
      }
      addDateInputFormat(src, to, f.variant);
    });
    addDateInputFormat(prepareTime(RequiredTime), TimeFormat);
    // English has to be initialized to get the months, but initialization adds the
    // CoreDateFormats, which do not exist, so we have a bit of a race condition, so
    // manually prepend the CoreDateFormats here to get around this.
    English.compiledFormats = CoreDateFormats.concat(English.compiledFormats);
  }

  function buildKanjiDigits() {
    KanjiDigits.split('').each(function(digit, value) {
      var holder;
      if(value > 9) {
        value = Math.pow(10, value - 9);
      }
      KanjiDigitMap[digit] = value;
    });
    ...
    KanjiDigitReg = regexp('([期週周])?([' + KanjiDigits + ']+)(?!昨)', 'g');
  }
  ...
  date.extend({
    ...
    'setLocale': function(localeCode, set) {
      var loc = getLocalization(localeCode, set);
      if(loc) {
    ...
    'addFormat': function(format, match, localeCode) {
      addDateInputFormat(format, match, false, getLocalization(localeCode), true);
    }
  ...
  number.extend({
    ...
    'duration': function(localeCode) {
      return Date.getLocale(localeCode).duration(this);
    }

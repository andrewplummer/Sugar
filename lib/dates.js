...
(function() {
  ...
  // TODO String#toDate should be in the dates class!
  // TODO remove Math (and other?) references?
  // TODO Check for capitalized classes Date,Object, etc
  // TODO rethink "initializeClass", etc....
  // todo add comments
  ...
  function setLocalization(localeCode, set, skipFallback) {
    ...
    loc['full_month'] = getDigit(1,2) + '|' + loc['months'].compact().join('|');

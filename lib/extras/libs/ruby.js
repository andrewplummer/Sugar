...
var SugarRubyMethods = [
  {
    ...
    methods: [
      ...
      },
      {
        ...
        sugar_code: "'Hello Mr. {1}'.format(name);",
        sugar_notes: "The %format% method allows a variable to be insterted into a string via a simple format. Both named and numbers tokens are supported."
      },
      {
        name: '+',

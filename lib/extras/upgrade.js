(function(exports, global, __filename) {
  ...
  var PROPERTY_ACCESSOR_MESSAGE = '%type%.%prop% is now Sugar.%type%.%method%(), and is now a static accessor method instead of a property. Calling this method with no arguments will return the default, calling with a single argument will set a new value, and calling with null or undefined will restore the default.';

...
//- Level: Very Minor
  ...
  var METHODS = [
    ...
    },
    {
      type: 'RegExp',
      iName: 'addFlag',
      message: 'RegExp#addFlag is now RegExp#addFlags and works on multiple flags at once.',
      docs: 'RegExp/addFlags'
    },
    {
      type: 'RegExp',
      iName: 'removeFlag',
      message: 'RegExp#removeFlag is now RegExp#removeFlags and works on multiple flags at once.',

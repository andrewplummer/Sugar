(function(exports, global, __filename) {
  ...
  var METHODS = [
    ...
    },
    {
      type: 'Object',
      sName: 'each',
      message: 'Object.each renamed to Object.forEach. Additionally, it no longer allows a return value to break the loop. Use Object.some instead for that functionality. Finally, the method was also moved to the Enumerable module from the Array module. If you were using a custom build you will have to include that module as well.',
      docs: 'Object/forEach'
    },
    {
      type: 'Object',
    ...
    },
    {
      type: 'Object',
      sName: 'all',
      message: "Object.all alias was removed to align with native methods. However, this alias can easily be restored with: Sugar.Object.alias('all', 'every').",
      docs: 'Object/every'
    },
    {
      type: 'Object',
      sName: 'any',
      message: "Object.any alias was removed to align with native methods. However, this alias can easily be restored with: Sugar.Object.alias('any', 'some').",
      docs: 'Object/some'
    },
    {
      type: 'Object',

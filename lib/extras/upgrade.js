(function(exports, global, __filename) {
  ...
  var METHODS = [
    ...
    },
    {
      ...
      iName: 'format',
      check: moreThanOneArgument,
      message: 'Number#format no longer accepts arguments for the thousands separator and decimal point. Instead these can now be set globally by calling "Sugar.thousands()" and Sugar.decimal(). These options will also be respected by Number#abbr, Number#metric, and Number#bytes as well.',
      docs: 'Number/format'
    },
    {
      type: 'String',
    ...
    },
    {
      ...
      method: 'sortCollate',
      docs: 'Array/sortCollate'
    },
    {
      type: 'Array',
      prop: 'AlphanumericSortOrder',
      method: 'sortOrder',
      docs: 'Array/sortOrder'
    },
    {
      type: 'Array',
      prop: 'AlphanumericSortIgnore',
      method: 'sortIgnore',
      docs: 'Array/sortIgnore'
    },
    {
      type: 'Array',
      prop: 'AlphanumericSortIgnoreCase',
      method: 'sortIgnoreCase',
      docs: 'Array/sortIgnoreCase'
    },
    {
      type: 'Array',
      prop: 'AlphanumericSortNatural',
      method: 'sortNatural',
      docs: 'Array/sortNatural'
    },
    {
      type: 'Array',
      prop: 'AlphanumericSortEquivalents',
      method: 'sortEquivalents',
      docs: 'Array/sortEquivalents'
    },
    {
      type: 'Date',
      prop: 'SugarNewDate',
      method: 'newDateInternal',
      docs: 'Date/sortEquivalents'
    }
  ];

  var PROPERTY_ACCESSOR_MESSAGE = '%type%.%prop% is now Sugar.%method%(), and is now a static accessor method instead of a property. Calling this method with no arguments will return the default, calling with a single argument will set a new value, and calling with null or undefined will restore the default.';
  ...
  function fromQueryStringMayBeSmart(str, opt) {
  ...
  function getFull(message, method, caller) {
    ...
    if (method.docs) {
      message += '\n----------- Docs: http://sugarjs.com/docs/' + method.docs + ' ---------';
    }
    message += '\n ';
    return message;
  }
  ...
  function initMethod(method, id) {
    ...
    function getPropMessage() {
      return PROPERTY_ACCESSOR_MESSAGE
        .replace(/%type%/g, method.type)
        .replace(/%prop%/g, method.prop)
        .replace(/%method%/g, method.method);
    }

    function wrapProp(target) {
      var val = target[method.prop];
      method.message = method.clean = getPropMessage();
  ...
  exports['sugarUpgradeClear']    = clearSuppressed;
  exports['sugarUpgradeSummary']  = showSummary;
  exports['sugarUpgradeDetails']  = showDetails;
  exports['sugarUpgradeSuppress'] = getOrSetSuppressed;

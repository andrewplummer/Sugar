...
(function(context) {
  ...
  // The global context
  var globalContext = typeof global !== 'undefined' ? global : context;
  ...
  function extend(methods, override, instance) {
    var klass = this,
        extendee = instance !== false ? klass.prototype : klass;
  ...
  function restore() {
    return batchMethodExecute(context, this, arguments, function(target, name, m) {
  ...
  function wrapNative(nativeFn, extendedFn, condition) {
    return function(a) {
      return condition.apply(context, arguments) ?
             extendedFn.apply(context, arguments) :
             nativeFn.apply(context, arguments);
    }
  }

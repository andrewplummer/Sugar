...
var SugarUnderscoreMethods = [
  ...
  },
  {
    ...
    sugar_compatibility: 0,
    sugar_notes: '_.size does not exist in Sugar. If you need to know the "size" of a hash, you can get the length of Object.keys, although in that case it
...
s likely that you should be using an array in any case.',
    original: '_.size(obj)',
  ...
  },
  {
    ...
    sugar: "Array.prototype.compose = function(){ var i = 0, fn; while(i < arguments.length){ fn = (function(){ return this.apply(this, arguments); }).bind(arguments[i]); i++;  } return fn; } fn1.compose(fn2)",
    ref: 'Function/bind'
  },
  {
    name: 'keys',
  ...
  },
  {
    ...
    sugar: 'Object.merge(obj, defaultProperties, false, false)',
    ref: 'Object/merge'
  },
  {
    name: 'clone',

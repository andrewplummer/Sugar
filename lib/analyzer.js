  ...
  var PrototypeMethods = [
    ...
    },
    {
      ...
      methods: [
        ...
        {
          name: 'ceil',
          description: 'Number#ceil exists in Sugar.\nIt can additionally round to a precision, specified in the first parameter.',
          condition: false,
          ref: 'Number/ceil'
        },
        {
  ...
  var UnderscoreMethods = [
    {
      ...
      methods: [
        ...
        {
          name: 'flatten',
          description: '_.flatten exists in Sugar as Array#flatten.\nSugar can additionally flatten to any level of depth, specified in the first parameter (all levels by default).',

  ...
  function buildTypeCheckMethods() {
    defineInstanceSimilar(sugarObject, TYPE_CHECK_NAMES, function(methods, name) {
  ...
  function buildHashMethods() {
    ...
    setProperty(Hash.prototype, 'get', function(prop) {
      return deepGetProperty(this, prop);
    });
    setProperty(Hash.prototype, 'set', function(prop, val) {
      return deepSetProperty(this, prop, val);
    });
  }

  ...
  function objectMerge(target, source, deep, resolve, hidden, descriptors) {
    ...
    iterateOverProperties(hidden, source, function(prop) {
      ...
      if (goDeep) {
        sourceVal = getMergedObject(targetVal, sourceVal, deep, resolve, hidden, descriptors);
      }

      if (PROPERTY_DESCRIPTOR_SUPPORT && descriptors) {
  ...
  function getMergedObject(target, source, deep, resolve, hidden, descriptors) {
    ...
    return objectMerge(target, source, deep, resolve, hidden, descriptors);
  }
  ...
  defineInstance(sugarObject, {
    ...
    'merge': function(target, source, opts) {
      opts = opts || {};
      return objectMerge(target, source, opts.deep, opts.resolve, opts.hidden, opts.descriptors);
    },

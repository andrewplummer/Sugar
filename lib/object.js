...
defineStatic(sugarObject, {
   ...
   *
   ***/
  'extended': function(obj, nonShadowable) {
    var target = nonShadowable ? NonShadowableHash : Hash;
    return new target(coercePrimitiveToObject(obj));
  },
...
function buildHashBase() {
  ...
  wrapHashMethods('add,clone,select,reject,exclude,invert', HASH_WRAPS_RESULT);

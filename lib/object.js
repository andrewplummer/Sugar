  ...
  defineInstance(sugarObject, {
     ...
     *                If `true` <source> wins, `false` <target> wins. If a
     *                function is passed, its return value will decide the result.
     *                If the function returns `undefined`, the merge will continue
     *                as normal. Resolve functions are passed the arguments:
     ...
     *                properties like `enumerable`, `configurable`, etc.
     *                (Default is `false`)
     *
     * @example
     *

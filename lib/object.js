  ...
  function mapAllObject() {
    buildObjectInstanceMethods(getAllObjectMethods(), object);
  }

  function unmapAllObject() {
    iterateOverObject(getAllObjectMethods(), function(i, name) {
      delete object.prototype[name === 'equal' ? 'equals' : name];
    });
  }

  function getAllObjectMethods() {
    return object.keys(Sugar.Object);
  }

  ...
  function buildNumber() {
    extendSimilar(number, true, false, 'round,floor,ceil', function(name, methods) {
      methods[name] = function(precision) {
        return round(this, precision, name);
      }
    });
    extendSimilar(number, true, false, 'abs,pow,sin,asin,cos,acos,tan,atan,exp,pow,sqrt', function(name, methods) {

  ...
  function buildNumber() {
    extendSimilar(number, true, 'round,floor,ceil', function(name, methods) {
      methods[name] = function(precision) {
        return round(this, precision, name);
      }
    });
    extendSimilar(number, true, 'abs,pow,sin,asin,cos,acos,tan,atan,exp,pow,sqrt', function(name, methods) {

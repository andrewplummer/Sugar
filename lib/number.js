  ...
  extend(number, true, true, {
     ...
     * @method times(<str>)
     * @returns String
     * @short Repeat <str> a number of times equivalent to the number.
     * @example
     *
     *   (3).times("Ho") // returns "HoHoHo"
     *
     * @method times(<arr>)
     * @returns Array
     * @short Concatenates <arr> a number of times equivalent to the number.
     * @example
     *
     *   [1,2,3].times(3) // returns "[1,2,3,1,2,3,1,2,3]"
     *
     ***/
    'times': function(arg) {
      if(Object.isFunction(arg)) {
        ...
        return this.toNumber();
          ...
          return arg.repeat(this);
      } else if(Object.isArray(arg)){
          var arr = [], n=+this;
          while(--n>=0) arr = arr.concat(arg);
          return arr;
      }
    },

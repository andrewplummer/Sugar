(function() {
  ...
  var entryAtIndex = function(arr, args, str) {
  ...
  var activateObjectPrototypeMethods = function() {
  ...
  var checkLocaleFormatsAdded = function(code) {
  ...
  var getVariant = function(locale) {

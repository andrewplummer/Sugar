(function() {
  ...
  */
  ...
  extend(Localization, true, false, {
    ...
    'getMonth': function(n, num) {
      var i;
      if(num && Object.isNumber(n)) {
        return n - 1;
    ...
    if(Object.isDate(f)) {
      ...
      arrayEach(dateInputFormats, function(dif) {
        ...
        if(match) {
          ...
          if(set.month) {
            set.month = loc.getMonth(set.month, true);
          ...
          // Otherwise set a localized weekday.
            ...
            set.weekday = loc.getWeekday(set.weekday, true);
          ...
          } else if(set.day && (tmp = loc.getWeekday(set.day, true)) > -1) {
            delete set.day;
            set.weekday = tmp;
          }

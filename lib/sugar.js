(function(){
  ...
  extend(String, true, {
     ...
     *   'moz-border-radius'.camelize(first) -> 'mozBorderRadius'
     *
     ***/
  ...
  extend(Array, true, {
     ...
     * @example
     *
     *   [{a:1,b:2},{a:1,b:3},{a:1,b:4}].findAll(function(n){
     *     return n['a'] == 1;
     *   });                                        -> [{a:1,b:3},{a:1,b:4}]

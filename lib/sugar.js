(function() {
  ...
  extend(Function, true, false, {
     ...
     * @method after([num])
     * @returns Nothing
     * @short Executes the function after [num] calls.
     * @extra %after% is useful for running a final callback after a series of asynchronous operations, when you don't know the order in which the operations will complete.
     * @example
     *
     *   var f = (function() {

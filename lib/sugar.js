  ...
  */
  ...
  var CommonLanguages = {
    'en': {
      ...
      pluralSuffix: 's',
      pastRelativeFormat: 0,
      futureRelativeFormat: 0,
    ...
    'es': {
      ...
      units: ['milisegundo','segundo','minuto','hora','día','semana','mes','año','milisegundos','segundos','minutos','horas','días','semanas','meses','años'],
      ...
      modifiers: [
        ...
        { name: 'edge', text: 'end', value: -1 },
        { name: 'edge', text: 'last day', value: -2 },
        { name: 'shift', text: 'pasada', value: -1 },
        { name: 'shift', text: 'pasado', value: -1 },
        { name: 'shift', text: 'próximo', value: 1 },
        { name: 'shift', text: 'próxima', value: 1 },
      ],
      abbreviatedMonthLength: 3,
      abbreviatedWeekdayLength: 3,
      formats: [
    ...
    'pt': {
      ...
      units: ['milisegundo','segundo','minuto','hora','dia','semana','mês','ano','milisegundos','segundos','minutos','horas','dias','semanas','mêses','anos'],
      numbers: ['um','dois','três','quatro','cinco','seis','sete','oito','nove','dez','uma','duas'],
      optionals: ['a','de'],
      pastRelativeFormat: 1,
      futureRelativeFormat: 0,
      modifiers: [
        { name: 'day', text: 'anteontem', value: -2 },
        { name: 'day', text: 'ontem', value: -1 },
        { name: 'day', text: 'hoje', value: 0 },
        { name: 'day', text: 'amanhã', value: 1 },
        { name: 'sign', text: 'atrás', value: -1 },
        { name: 'sign', text: 'há', value: -1 },
        { name: 'sign', text: 'daqui a', value: 1 },
        { name: 'edge', text: 'first day', value: 1 },
        { name: 'edge', text: 'beginning', value: 1 },
        { name: 'edge', text: 'end', value: -1 },
        { name: 'edge', text: 'last day', value: -2 },
        { name: 'shift', text: 'passada', value: -1 },
        { name: 'shift', text: 'passado', value: -1 },
        { name: 'shift', text: 'próximo', value: 1 },
        { name: 'shift', text: 'próxima', value: 1 },
      ],
      formats: [
    ...
    'fr': {
      ...
      units: ['millisecond','seconde','minute','heure','jour','semaine','mois','an','millisecondes','secondes','minutes','heures','jours','semaines','mois','ans',,,,,,,,'année'],
      ...
      modifiers: [
        ...
        { name: 'sign', text: 'dans', value: 1 },
        { name: 'sign', text: "d'ici", value: 1 },
        { name: 'edge', text: 'first day', value: 1 },
        { name: 'edge', text: 'beginning', value: 1 },
        { name: 'edge', text: 'end', value: -1 },
        { name: 'edge', text: 'last day', value: -2 },
        { name: 'shift', text: 'dernier', value: -1 },
        { name: 'shift', text: 'dernière', value: -1 },
        { name: 'shift', text: 'prochain', value: 1 },
        { name: 'shift', text: 'prochaine', value: 1 },
      ],
      formats: [
        '{sign} {num} {unit}',
        '{1} {date?} {month} {year?}',
    ...
    'de': {
      ...
      numbers: ['eine','zwei','drei','vier','fuenf','sechs','sieben','acht','neun','zehn','einer',,,,,,,,,,'einem'],
      units: ['Millisekunde','Sekunde','Minute','Stunde','Tag','Woche','Monat','Jahr','Millisekunden','Sekunden','Minuten','Stunden','Tagen','Wochen','Monaten','Jahren'],
      optionals: ['der'],
      pastRelativeFormat: 0,
      futureRelativeFormat: 1,
      modifiers: [
        ...
        { name: 'day', text: 'übermorgen', value: 2 },
        ...
        { name: 'edge', text: 'end', value: -1 },
        { name: 'edge', text: 'last day', value: -2 },
        { name: 'shift', text: 'letzte', value: -1 },
        { name: 'shift', text: 'letzter', value: -1 },
        { name: 'shift', text: 'letzten', value: -1 },
        { name: 'shift', text: 'letztes', value: -1 },
        { name: 'shift', text: 'nächste', value: 1 },
        { name: 'shift', text: 'nächster', value: 1 },
        { name: 'shift', text: 'nächsten', value: 1 },
      ],
      formats: [
        '{num} {unit} {sign}',
        '{sign} {num} {unit}',
    ...
    'it': {
      ...
      units: ['millisecondo','secondo','minuto','ora','giorno','settimana','mese','anno','millisecondi','secondi','minuti','ore','giorni','settimane','mesi','anni'],
      numbers: ['un','due','tre','quattro','cinque','sei','sette','otto','nove','dieci','una',,,,,,,,,,'uno'],
      optionals: ['de'],
      optionals: ["l'|la|il"],
      pastRelativeFormat: 0,
      futureRelativeFormat: 0,
      modifiers: [
        ...
        { name: 'edge', text: 'end', value: -1 },
        { name: 'edge', text: 'last day', value: -2 },
        { name: 'shift', text: 'scorso', value: -1 },
        { name: 'shift', text: 'scorsa', value: -1 },
        { name: 'shift', text: 'prossimo', value: 1 },
        { name: 'shift', text: 'prossima', value: 1 },
      ],
      formats: [
        '{num} {unit} {sign}',
        '{weekday?} {date?} {month} {year?}',
    ...
    'ru': {
      months: ['января','февраля','марта','апреля','мая','июня','июля','августа','сентября','октября','ноября','декабря','Январь','Февраль','Март','Апрель','Май','Июнь','Июль','Август','Сентябрь','Октябрь','Ноябрь','Декабрь'],
      weekdays: ['Воскресенье','Понедельник','Вторник','Среда','Четверг','Пятница','Суббота'],
      units: ['миллисекунда','секунда','минута','час','день','неделя','месяц','год','миллисекунду','секунду','минуту','часов','день','неделю','месяцев','лет','миллисекунд','секунд','минут',,'дней','недель',,,,,,,,'неделе','месяце','году'],
      numbers: ['один','два','три','четыре','пять','шесть','семь','восемь','девять','десять','одну'],
      optionals: ['в|на'],
      pastRelativeFormat: 0,
      futureRelativeFormat: 1,
      modifiers: [
        ...
        { name: 'edge', text: 'end', value: -1 },
        { name: 'edge', text: 'last day', value: -2 },
        { name: 'shift', text: 'прошлой', value: -1 },
        { name: 'shift', text: 'прошлом', value: -1 },
        { name: 'shift', text: 'следующей', value: 1 },
        { name: 'shift', text: 'следующем', value: 1 },
      ],
      abbreviatedMonthLength: 3,
      abbreviatedWeekdayLength: 3,
      formats: [
    ...
    'ja': {
      monthsAreNumeric: true,
      weekdays: ['日曜日','月曜日','火曜日','水曜日','木曜日','金曜日','土曜日'],
      units: ['ミリ秒','秒','分','時間','日','週','月','年'],
      ...
      modifiers: [
        ...
        { name: 'edge', text: '末', value: -1 },
        { name: 'shift', text: '去', value: -1 },
        { name: 'shift', text: '先', value: -1 },
    ...
    'zh-Hans': {
      monthsAreNumeric: true,
      weekdays: ['星期六','星期一','星期二','星期三','星期四','星期五'],
      units: ['毫秒','秒钟','分钟','小时','天','周','月','年',,,,,,'星期'],
      numbers: ['一','二','三','四','五','六','七','八','九','十','十一','十二'],
      optionals: ['个'],
      pastRelativeFormat: 0,
      futureRelativeFormat: 0,
      modifiers: [
        ...
        { name: 'shift', text: '去', value: -1 },
        { name: 'shift', text: '上', value: -1 },
        { name: 'shift', text: '下', value:  1 },
        { name: 'shift', text: '明', value:  1 }
      ],
      formats: [
        '{num}{1}{unit}{sign}',
        '{shift}{1}{unit=5-7}',
    ...
    'ko': {
      ...
      modifiers: [
        ...
        { name: 'shift', text: '지난', value: -1 },
        { name: 'shift', text: '작', value: -1 },
        { name: 'shift', text: '다음', value: 1 },
        { name: 'shift', text: '내', value: 1 }
      ],
      formats: [
        '{num}{unit} {sign}',
        '{shift} {unit=5-7}',
  ...
  var checkLocalizationInitialized = function(lang) {
    if(lang && !DateLanguages[lang]) {
      Date.setLanguage(lang);
    }
  };

  var getLocalization = function(lang) {
    return DateLanguages[lang] || DateLanguages[currentLocalization] || DateLanguages['en'];
  };
    ...
    arrayEach(dateOutputFormats, function(dof) {
      ...
      f = f.replace(new RegExp('\\{('+dof.token+')(?: (pad))?\\}', dof.caps ? '' : 'i'), function(m,t,p) {
        ...
        if(dof.weekdays) {
          ...
          if(abbreviated) value = value.slice(0,3);
  ...
  var createDate = function(args) {
    ...
    if(Object.isString(args[1])) {
      // Pre-initialize the localization.
      checkLocalizationInitialized(args[1]);
    }
  ...
  extend(Date, false, false, {
    ...
    'setLanguage': function(code, set) {

      set = set || CommonLanguages[code];
      if(!set) {
        throw new Error('Invalid language.');
        return;
      }
      currentLocalization = code;
      if(DateLanguages[code]) return;

      //var f = 
//'({MONTHS})[\\s\\-.](\\d{4})'
//
      var setArray = function(name, def, length) {
        var arr = set[name] ? set[name].map('toLowerCase') : def;
      ...
      var getDigit = function(start, stop) {
        var suffix = '{' + start + (stop ? ',' + stop : '') + '}';
        return '[0-9０-９]' + (start ? suffix : '+');
      }
      ...
      setArray('months', [], set.abbreviatedMonthLength);
      setArray('weekdays', [], set.abbreviatedWeekdayLength);
      setArray('numbers', []);
      setArray('units', []);
      setArray('articles', []);
      set.modifiersByName = {};
     ...
     //console.info('hahahaha', getDigit(4), getDigit(1,2), getDigit());

      var poop = {
        'date': getDigit(1,2),
        'year': getDigit(4),
        //'space': '[-,. ]+',
        'num': set.numbers.concat(set.articles).concat(getDigit()).join('|'),
      }

      setModifiers();

      if(set.monthsAreNumeric) {
        poop.month = getDigit(1,2);
      } else {
    ...
    'is': function(d, margin) {
      ...
      if(!Object.isString(d)) {
        ...
        if(d === 'future') {
          ...
          return this.getDay() === 0 || this.getDay() === 6;
        } else if((tmp = EnglishWeekdays.indexOf(d) % 7) > -1) {
          return this.getDay() === tmp;
        } else if((tmp = EnglishMonths.indexOf(d) % 12) > -1) {

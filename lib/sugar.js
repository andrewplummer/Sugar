...
(function(){
  ...
  var extendWithNativeCondition = function(klass, useNative, extend){
    for(var name in extend){
      if(!extend.hasOwnProperty(name)) continue;
      (function(){
        var nativeFunction = klass.prototype[name];
        var extended = extend[name];
        klass.prototype[name] = function(){
          if(nativeFunction && (useNative === true || useNative.apply(this, arguments))){
  ...
  extend(Array, true, {
    ...
    'remove': function(f){
      var self = this;
      return this.findAllFromIndex(0, function(a){ return !multiMatch(a, f, self); });
    },
    ...
    'at': function(){
      ...
      return func.call(this, 0, function(el, i){ return args.has(i); });
    },
    ...
    'inGroupsOf': function(num, padding){
      ...
      if(padding !== undefined && !this.length.multipleOf(num)){
    ...
    'compact': function(){
      return this.filter(function(el){ return el !== undefined && el !== null && (typeof el !== 'number' || !isNaN(el)); });
    },

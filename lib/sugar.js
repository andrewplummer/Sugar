(function() {
  ...
  extend(Function, true, false, {
     ...
     *
     ***/
    'lazy': function(ms, stop) {
      var fn = this;
      if(ms === undefined) ms = 0;
      var run = 0;
      var lazy = function() {
        if(stop && lazy.timers && lazy.timers.length >= stop) return;

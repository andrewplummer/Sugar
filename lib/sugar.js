...
(function(){
  ...
  extend(String, true, {
     ...
     * @example
     *
     *   'broken wear'.word() -> ['broken','wear'];
     *   'broken wear'.word(function(w){
     ...
     * @example
     *
     *   'broken wear\nand\njumpy jump'.word() -> ['broken wear','and','jumpy jump'];
     *   'broken wear\nand\njumpy jump'.word(function(l){
     ...
     * @example
     *
     *   'Once upon a time.\n\nIn the land of oz...'.word() -> ['Once upon a time.','In the land of oz...'];
     *   'Once upon a time.\n\nIn the land of oz...'.word(function(p){

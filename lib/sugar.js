...
(function(){
  ...
  var compareDate = function(d, find, buffer, after, edges){
    var unit, accuracy;
  ...
  extend(Date, true, {
    ...
    'isAfter': function(f, buffer){
      return compareDate(this, f, buffer, true);
    },

    'isBefore': function(f, buffer){
      return compareDate(this, f, buffer, false);
    },

    'isBetween': function(first, second, buffer){
      if(compareDate(this, first, buffer, true, true) && compareDate(this, second, buffer, false, true)){
        return true;
      } else {
        return compareDate(this, second, buffer, true, true) && compareDate(this, first, buffer, false, true);
      }
    },
  ...
  ['Array','Boolean','Date','Function','Number','Object','String','RegExp'].each(function(c){

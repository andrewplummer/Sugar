(function() {
  ...
  function buildWatch() {
    extend(Object, false, true, {
       ...
       * @extra <fn> is passed three arguments: the property (<prop>), the old value, and the new value. The return value of [fn] will be set as the new value. This method is useful for things such as validating or cleaning the value when it is set. Warning: this method WILL NOT work in IE 8 and below (this is the only method in Sugar that is not fully compatible with all browsers).
       * @example
       *
       ...
       * @extra <fn> is passed three arguments: the property (<prop>), the old value, and the new value. The return value of [fn] will be set as the new value. This method is useful for things such as validating or cleaning the value when it is set. Warning: this method WILL NOT work in IE 8 and below (this is the only method in Sugar that is not fully compatible with all browsers). This method is only available on extended objects created with %Object.extended%.
       * @example
       *

(function(){
   ...
   * @method milliseconds()
   * @returns Number
   * @description Takes the number as milliseconds and returns milliseconds. This method is included for completeness and effectively just rounds the number. %millisecond% is provided as an alias.
   * @example
   *
   *   (5).milliseconds() -> 5
   *
   ...
   * @returns Date
   * @description Returns a date <n> milliseconds before [d], where <n> is the number.
   ...
   * @returns Date
   * @description Returns a date <n> milliseconds after [d], where <n> is the number.
   ...
   * @method seconds()
   * @returns Number
   * @description Takes the number as seconds and returns milliseconds. %second% is provided as an alias.
   * @example
   *
   *   (5).seconds() -> 5000
   *
   ...
   * @returns Date
   * @description Returns a date <n> seconds before [d], where <n> is the number.
   ...
   * @returns Date
   * @description Returns a date <n> seconds after [d], where <n> is the number.
   ...
   * @method minutes()
   * @returns Number
   * @description Takes the number as minutes and returns milliseconds. %minute% is provided as an alias.
   * @example
   *
   *   (5).minutes() -> 300000
   *
   ...
   * @returns Date
   * @description Returns a date <n> minutes before [d], where <n> is the number.
   ...
   * @returns Date
   * @description Returns a date <n> minutes after [d], where <n> is the number.
   ...
   * @method hours()
   * @returns Number
   * @description Takes the number as hours and returns milliseconds. %hour% is provided as an alias.
   * @example
   *
   *   (5).hours() -> 18000000
   *
   ...
   * @returns Date
   * @description Returns a date <n> hours before [d], where <n> is the number.
   ...
   * @returns Date
   * @description Returns a date <n> hours after [d], where <n> is the number.
   ...
   * @method days()
   * @returns Number
   * @description Takes the number as days and returns milliseconds. %day% is provided as an alias.
   * @example
   *
   *   (5).days() -> 432000000
   *
   ...
   * @returns Date
   * @description Returns a date <n> days before [d], where <n> is the number.
   ...
   * @returns Date
   * @description Returns a date <n> days after [d], where <n> is the number.
   ...
   * @method weeks()
   * @returns Number
   * @description Takes the number as weeks and returns milliseconds. %week% is provided as an alias.
   * @example
   *
   *   (5).weeks() -> 3024000000
   *
   ...
   * @returns Date
   * @description Returns a date <n> weeks before [d], where <n> is the number.
   ...
   * @returns Date
   * @description Returns a date <n> weeks after [d], where <n> is the number.
   ...
   * @method months()
   * @returns Number
   * @description Takes the number as months and returns milliseconds. %month% is provided as an alias.
   ...
   * @returns Date
   * @description Returns a date <n> months before [d], where <n> is the number.
   ...
   * @returns Date
   * @description Returns a date <n> months after [d], where <n> is the number.
   ...
   * @method years()
   * @returns Number
   * @description Takes the number as years and returns milliseconds. %year% is provided as an alias.
   ...
   * @returns Date
   * @description Returns a date <n> years before [d], where <n> is the number.
   ...
   * @returns Date
   * @description Returns a date <n> years after [d], where <n> is the number.
  ...
  extendWithNativeCondition(String, true, function(s){ return !Object.isRegExp(s); }, {
     ...
     * @returns Array
     * @description Splits the string by [separator] into an Array. This method is native to Javascript, but Sugar patches it to provide cross-browser reliability when splitting on a regex.
     * @example
     *
  ...
  extendWithNativeCondition(Array, true, true, {
     ...
     * @returns Nothing
     * @description Iterates over the array, calling [fn] on each loop. [scope] becomes the %this% object. %Array#each% is provided as an alias. This method is only provided for those browsers that do not support it natively.
     * @example
     *
  ...
  extendWithNativeCondition(Array, true, function(a){ return !Object.isObject(a) && !Object.isFunction(a); }, {
     ...
     * @returns Number
     * @description Searches the array and returns the first index where <a> occurs, or -1 if the element is not found. [offset] is the index from which to begin the search. In addition to providing this method for browsers that don't support it natively, this enhanced method can also perform deep finds on objects or arrays, and accept an iterating function on which to perform the search.
     * @example
     *
     *   [1,2,3].indexOf(3)           -> 1
     *   [1,2,3].indexOf(7)           -> -1
     ...
     * @returns Number
     * @description Searches the array and returns the last index where <a> occurs, or -1 if the element is not found. [offset] is the index from which to begin the search. In addition to providing this method for browsers that don't support it natively, this enhanced method can also perform deep finds on objects or arrays, and accept an iterating function on which to perform the search.
     * @example
     *
  ...
  extendWithNativeCondition(Array, true, function(){ return Object.isFunction(arguments[0]); }, {
     ...
     * @returns Boolean
     * @description Iterates over the array calling <fn>, and returns true if every call also returned a truthy value. [scope] is the %this% object. In addition to providing this method for browsers that don't support it natively, this enhanced method also directly accepts strings, numbers, deep objects, and arrays for <fn>. %Array#all% is provided an alias.
     * @example
     *
     ...
     * @returns Boolean
     * @description Iterates over the array calling <fn>, and returns true if even one call also returned a truthy value. [scope] is the %this% object. In addition to providing this method for browsers that don't support it natively, this enhanced method also directly accepts strings, numbers, deep objects, and arrays for <fn>. %Array#any% and %Array#has% are provided as aliases.
     * @example
     *
     ...
     * @returns Array
     * @description Returns an array containing the elements for which <fn> returned a truthy value. [scope] is the %this% object. In addition to providing this method for browsers that don't support it natively, this enhanced method also directly accepts strings, numbers, deep objects, and arrays for [fn].
     * @example
     *
  ...
  extend(Array, true, {
     ...
     * @returns Mixed
     * @description Returns the first element that matches <f>. Starts at [index].
     ...
     * @returns Array
     * @description Returns all elements that match <f>. Starts at [index].
     * @extra <f> will match a string, number, array, or object, or alternately test against a function or regex.
     * @example
     *
     ...
     * @returns Array
     * @description Runs <fn> against elements in the array starting at <index>. Will run a full loop starting over at index = 0 if [loop] is true.
     * @example
     *
     *   [{a:1,b:2},{a:1,b:3},{a:1,b:4}].findAll(1, function(n){
     *     return n['a'] == 1;
     ...
     * @method split(<f>)
     * @returns Array
     * @description Splits the array on any element that matches <f>.
     * @example
     *
     ...
     * @method compact()
     * @returns Array
     * @description Removes all instances of %undefined%, %null%, and %NaN% from the array. Empty strings and %false% are left untouched.
     * @example
     *
     ...
     * @method isEmpty()
     * @returns Boolean
     * @description Returns true if the array has a length of zero. Also runs %compact% to remove %undefined%, %null%, and %NaN%.
     * @example
     *
     *   [].isEmpty()               -> true
     ...
     * @method flatten()
     * @returns Array
     * @description Returns a flattened, one-dimensional copy of the array.
     * @example
     *
     *   [[1], 2, [3]].flatten()      -> [1,2,3]
     *   [['a'],[],'b','c'].flatten() -> ['a','b','c']
     ...
     * @returns Array
     * @description Sorts the array based on <map>, which may be a function or a string acting as a shortcut. [desc] will sort the array in descending order.
     * @example
     *
     ...
     * @returns Array
     * @description Adds <el> at index <index>.
     * @example
     *
     ...
     * @method randomize()
     * @returns Array
     * @description Randomizes the array (Fisher-Yates algorithm). %Array#shuffle% provided as an alias.
     * @example
     *
     *   [1,2,3,4].randomize()  -> [?,?,?,?]
     *
   ...
   * @returns Number
   * @description Returns the number of milliseconds since [date].
   ...
   * @returns Number
   * @description Returns the number of seconds since [date].
   * @extra [date] will accept a date object, timestamp, or text format. See @date_format for more information. If not specified, [date] is assumed to be now.
   * @example
   *
   ...
   * @returns Number
   * @description Returns the number of minutes since [date].
   * @extra [date] will accept a date object, timestamp, or text format. See @date_format for more information. If not specified, [date] is assumed to be now.
   * @example
   *
   ...
   * @returns Number
   * @description Returns the number of hours since [date].
   * @extra [date] will accept a date object, timestamp, or text format. See @date_format for more information. If not specified, [date] is assumed to be now.
   * @example
   *
   ...
   * @returns Number
   * @description Returns the number of days since [date].
   * @extra [date] will accept a date object, timestamp, or text format. See @date_format for more information. If not specified, [date] is assumed to be now.
   * @example
   *
   ...
   * @returns Number
   * @description Returns the number of weeks since [date].
   * @extra [date] will accept a date object, timestamp, or text format. See @date_format for more information. If not specified, [date] is assumed to be now.
   * @example
   *
   ...
   * @returns Number
   * @description Returns the number of months since [date].
   * @extra [date] will accept a date object, timestamp, or text format. See @date_format for more information. If not specified, [date] is assumed to be now.
   * @example
   *
   ...
   * @returns Number
   * @description Returns the number of years since [date].
   * @extra [date] will accept a date object, timestamp, or text format. See @date_format for more information. If not specified, [date] is assumed to be now.
   * @example
   *
   ...
   * @returns Number
   * @description Returns the number of milliseconds until [date].
   * @extra [date] will accept a date object, timestamp, or text format. See @date_format for more information. If not specified, [date] is assumed to be now.
   * @example
   *
   ...
   * @returns Number
   * @description Returns the number of seconds until [date].
   * @extra [date] will accept a date object, timestamp, or text format. See @date_format for more information. If not specified, [date] is assumed to be now.
   * @example
   *
   ...
   * @returns Number
   * @description Returns the number of minutes until [date].
   * @extra [date] will accept a date object, timestamp, or text format. See @date_format for more information. If not specified, [date] is assumed to be now.
   * @example
   *
   ...
   * @returns Number
   * @description Returns the number of hours until [date].
   * @extra [date] will accept a date object, timestamp, or text format. See @date_format for more information. If not specified, [date] is assumed to be now.
   * @example
   *
   ...
   * @returns Number
   * @description Returns the number of days until [date].
   * @extra [date] will accept a date object, timestamp, or text format. See @date_format for more information. If not specified, [date] is assumed to be now.
   * @example
   *
   ...
   * @returns Number
   * @description Returns the number of weeks until [date].
   * @extra [date] will accept a date object, timestamp, or text format. See @date_format for more information. If not specified, [date] is assumed to be now.
   * @example
   *
   ...
   * @returns Number
   * @description Returns the number of months until [date].
   * @extra [date] will accept a date object, timestamp, or text format. See @date_format for more information. If not specified, [date] is assumed to be now.
   * @example
   *
   ...
   * @returns Number
   * @description Returns the number of years until [date].
   * @extra [date] will accept a date object, timestamp, or text format. See @date_format for more information. If not specified, [date] is assumed to be now.
   * @example
   *
   ...
   * @returns Date
   * @description Adds <num> milliseconds to the date.
   * @example
   *
   ...
   * @returns Date
   * @description Adds <num> seconds to the date.
   * @example
   *
   ...
   * @returns Date
   * @description Adds <num> minutes to the date.
   * @example
   *
   ...
   * @method addHours(<num>)
   * @returns Date
   * @description Adds <num> hours to the date.
   * @example
   *
   ...
   * @method addDays(<num>)
   * @returns Date
   * @description Adds <num> days to the date.
   * @example
   *
   ...
   * @method addWeeks(<num>)
   * @returns Date
   * @description Adds <num> weeks to the date.
   * @example
   *
   ...
   * @returns Date
   * @description Adds <num> months to the date.
   * @example
   *
   ...
   * @method addYears(<num>)
   * @returns Date
   * @description Adds <num> years to the date.
   * @example
   *
   ...
   * @method isLastWeek()
   * @returns Boolean
   * @description Returns true if the date is last week. False otherwise.
   * @example
   *
   ...
   * @method isThisWeek()
   * @returns Boolean
   * @description Returns true if the date is this week. False otherwise.
   * @example
   *
   ...
   * @method isNextWeek()
   * @returns Boolean
   * @description Returns true if the date is next week. False otherwise.
   * @example
   *
   ...
   * @method isLastMonth()
   * @returns Boolean
   * @description Returns true if the date is last month. False otherwise.
   * @example
   *
   ...
   * @method isThisMonth()
   * @returns Boolean
   * @description Returns true if the date is this month. False otherwise.
   * @example
   *
   ...
   * @method isNextMonth()
   * @returns Boolean
   * @description Returns true if the date is next month. False otherwise.
   * @example
   *
   ...
   * @method isLastYear()
   * @returns Boolean
   * @description Returns true if the date is last year. False otherwise.
   * @example
   *
   ...
   * @method isThisYear()
   * @returns Boolean
   * @description Returns true if the date is this year. False otherwise.
   * @example
   *
   ...
   * @method isNextYear()
   * @returns Boolean
   * @description Returns true if the date is next year. False otherwise.
   * @example
   *
   ...
   * @returns Date
   * @description Sets the date to the beginning of the week.
   * @example
   *
   ...
   * @method endOfWeek()
   * @returns Date
   * @description Sets the date to the end of the week.
   * @example
   *
   ...
   * @returns Date
   * @description Sets the date to the beginning of the month.
   * @example
   *
   ...
   * @method endOfMonth()
   * @returns Date
   * @description Sets the date to the end of the month.
   * @example
   *
   ...
   * @returns Date
   * @description Sets the date to the beginning of the year.
   * @example
   *
   ...
   * @method endOfYear()
   * @returns Date
   * @description Sets the date to the end of the year.
   * @example
   *
   ...
   * @method isToday()
   * @returns Boolean
   * @description Returns true if the date is today. False otherwise.
   * @example
   *
   ...
   * @method isYesterday()
   * @returns Boolean
   * @description Returns true if the date is yesterday. False otherwise.
   * @example
   *
   ...
   * @method isTomorrow()
   * @returns Boolean
   * @description Returns true if the date is tomorrow. False otherwise.
   * @example
   *
   ...
   * @method isWeekday()
   * @returns Boolean
   * @description Returns true if the date is a weekday. False otherwise.
   * @example
   *
   ...
   * @method isFuture()
   * @returns Boolean
   * @description Returns true if the date is in the future. False otherwise.
   * @example
   *
   ...
   * @method isPast()
   * @returns Boolean
   * @description Returns true if the date is in the past. False otherwise.
   * @example
   *
  ...
  extend(Date, true, {
     ...
     * @method set()
     * @returns Date
     * @description Sets the date object.
     ...
     * @method setUTC()
     * @returns Date
     * @description Sets the date object according to universal time.
     * @extra This method can accept multiple formats including a single number as a timestamp, an object, or enumerated parameters (as with the Date constructor).
     * @example
     *
     ...
     * @method setWeekday()
     * @returns Nothing
     * @description Sets the weekday of the date.
     * @example
     *
     ...
     * @returns Nothing
     * @description Sets the weekday of the date according to universal time.
     * @example
     *
     ...
     * @method setUTCWeek()
     * @returns Nothing
     * @description Sets the week (of the year) according to universal time.
     * @example
     *
     ...
     * @method getWeek()
     * @returns Number
     * @description Gets the date's week (of the year).
     * @example
     *
     ...
     * @method getUTCWeek()
     * @returns Number
     * @description Gets the date's week (of the year) according to universal time.
     * @example
     *
     ...
     * @returns String
     * @description Returns a string representation of the offset from UTC time. If [iso] is true the offset will be in ISO8601 format.
     * @example
     *
     ...
     * @method toUTC()
     * @returns Date
     * @description Converts the date to UTC time, effectively subtracting the timezeone offset.
     * @example
     *
     ...
     * @method isUTC()
     * @returns Boolean
     * @description Returns true if the date has no timezone offset. False otherwise.
     * @example
     *
     ...
     * @method advance()
     * @returns Date
     * @description Sets the date forward.
     * @extra This method can accept multiple formats including a single number as a timestamp, an object, or enumerated parameters (as with the Date constructor).
     * @example
     *
     ...
     * @method rewind()
     * @returns Date
     * @description Sets the date back.
     * @extra This method can accept multiple formats including a single number as a timestamp, an object, or enumerated parameters (as with the Date constructor).
     * @example
     *
     ...
     * @method isValid()
     * @returns Boolean
     * @description Returns true if the date is valid. False otherwise.
     * @example
     *
     ...
     * @returns Boolean
     * @description Returns true if the date is after the <d>. [margin] is to allow extra margin of error (in ms).
     ...
     * @returns Boolean
     * @description Returns true if the date is before <d>. [margin] is to allow extra margin of error (in ms).
     * @extra <d> will accept a date object, timestamp, or text format (see @date_format for more information). If not specified, <d> is assumed to be now.
     * @example
     *
     ...
     * @returns Boolean
     * @description Returns true if the date falls between <d1> and <d2>. [margin] is to allow extra margin of error (in ms).
     ...
     * @method isLeapYear()
     * @returns Boolean
     * @description Returns true if the date is a leap year. False otherwise.
     * @example
     *
     ...
     * @method daysInMonth()
     * @returns Number
     * @description Returns the number of days in the date's month.
     * @example
     *
     ...
     * @returns String
     * @description Formats the date for the given <format>. If [utc] is true, date will be formatted in UTC time.
     ...
     * @method is(<d>, [margin])
     * @returns Boolean
     * @description Returns true if the date is <d>. [margin] is to allow extra margin of error (in ms).
     ...
     * @method resetTime()
     * @returns Date
     * @description Resets the time in the date to 00:00:00.000.
     * @example
     *
     ...
     * @method toISOString()
     * @returns String
     * @description Formats the string to ISO8601 format.
     * @example
     *
  ...
  extend(Date, false, {
     ...
     * @returns Date
     * @description Alternate Date constructor which understands many more formats.
  ...
  extend(Function, true, {
     ...
     * @returns Function
     * @description Binds <scope> as the %this% object for the function when it is called. Also allows currying an unlimited number of parameters.
     * @example
     *
     ...
     * @returns Number
     * @description Delays the function for <duration> milliseconds. Returns the timer to be used with %clearTimeout%.
     ...
     * @method defer()
     * @returns Function
     * @description Defers the function to be called after the stack is empty.
     ...
     * @method cancel()
     * @returns Nothing
     * @description Cancels a function scheduled to be called with %delay%.

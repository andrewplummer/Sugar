(function() {
  ...
  var numeralInputFormats = [
    ...
    // @date_format 2010/05/25
    { src: '([+-])?(\\d{4})[-\\/.]?(\\d{1,2})[-\\/.]?(\\d{1,2})', to: ['year_sign','year','month','date'] },
    ...
    // @date_format 05/25/2010
    // @date_format 05.25.2010
    { src: '(\\d{1,2})[-\\/.](\\d{1,2})[-\\/.](\\d{2,4})', to: ['month','date','year'], variant: true },
    ...
    if(Object.isDate(f)) {
      ...
      arrayEach(dateInputFormats, function(dif) {
        ...
        if(match) {
          ...
          console.info("HOOHA", match, dif, set, Date.allowVariant, format.variant);

(function() {
  ...
  var buildObject = function() {
    extend(Object, false, { isArray: Array.isArray });
    buildTypeMethods();
    buildHashMethods();
  }
  ...
  extend(Object, false, {
     ...
     ***/
    'merge': function() {
      var target = arguments[0], key, i;
      arrayEach(arguments, function(o){
        if(typeof o !== 'object') return;
        iterateOverObject(o, function(key, value) {
          target[key] = value;
        });
      }, 1);
      return target;
  ...
  extend(Array, true, {
    ...
    'remove': function() {
      var i, arr = this;
      arrayEach(arguments, function(f){
        i = 0;
        while(i < arr.length) {
    ...
    'union': function() {
      var arr = this;
      arrayEach(arguments, function(a){
        arr = arr.concat(a);
      });
    ...
    'intersect': function() {
      var result = [], arr = this;
      arrayEach(arguments, function(merge){
        if(!Array.isArray(merge)) merge = [merge];
        merge.each(function(el) {
          if(arrayFind(arr, el) !== undefined) {
            result.push(el);
          }
        });
      });
    ...
    'subtract': function(a) {
      ...
      arrayEach(arguments, function(subtract){
  ...
  extend(Number, true, {
     ...
     * @extra If [pad] is false it will not pad the result to 2 places.
     * @example
     *
     *   (255).hex()   -> 'ff';
     *   (23654).hex() -> '5c66';
  ...
  var buildTrim = function() {
    ...
    try { String.prototype.trim.call([1]); } catch(e) { supported = false; }
  ...
  var getExtendedDate = function(f) {
    ...
    if(Object.isDate(f)) {
      ...
      dateInputFormats.forEach(function(df) {
        if(match) return;
  ...
  var getAdjustedDateUnit = function(d) {
    ...
    dateUnits.concat().reverse().slice(1).forEach(function(u) {
  ...
  var checkMonthTraversal = function(d, set, advance) {
    ...
    dateUnits.slice(2).forEach(function(u) {
  ...
  var buildDateInputFormats = function() {
    ...
    dateInputFormats.forEach(function(m) {
      var src = '^' + m.reg;
  ...
  var buildRelativeAliases = function() {
    ['today','yesterday','tomorrow','weekday','weekend','future','past'].concat(weekdays).concat(months).forEach(function(s) {
  ...
  extend(Date, true, {
    ...
    'is': function(d, margin) {
      ...
      if(Object.isString(margin)) {
        var u = dateUnits.filter(function(u) {
          return u.unit === margin;
        });
        if(u.length > 0) {
          margin = u[0].multiplier();
        }
      }
  ...
  extend(Function, true, {
     ...
     * @returns Number
     * @short Delays the function for <duration> milliseconds.
     * @extra Functions using the delay method can be canceled using the %cancel% method. Can also curry arguments passed in after the duration.
     * @example
     *
     *   (function(arg1) {
     *     // called 1s later

(function() {
  ...
  var isArrayIndex = function(arr, i) {
    return arr.hasOwnProperty(i) && ToUint32(i) == i && i != 0xffffffff;
  };
  ...
  extendWithNativeCondition(Array, true, function() { return arguments.length === 0 || Object.isFunction(arguments[0]); }, {
    ...
    'some': function(f, scope) {
      ...
      checkFirstArgumentExists(arguments);
      while(index < length) {
        if(isArrayIndex(this, index) && multiMatch(this[index], f, scope, [index, this])) {
          return true;
        }
        index++;
      }
  ...
  extend(Number, true, {
    ...
    'pad': function(place, sign) {
      ...
      str = str.padLeft('0', place - str.length);
      if(sign || this < 0) {
        str = (this < 0 ? '-' : '+') + str;
      }
      return str;
  ...
  extend(String, true, {
    ...
    'capitalize': function(all) {
      ...
      return this.toLowerCase().replace(reg, function(letter, two, three) {

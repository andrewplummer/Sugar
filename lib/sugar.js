(function(){
  ...
  extend(Object, false, {
     ...
     * @extra This method is only available on objects created with the alternate constructor %Object.create%.
     * @example
     *
     ...
     * @extra This method is only available on objects crated with the alternate constructor %Object.create%.
     * @example
     *
   ...
   * @extra %month% is provided as an alias. Note that "a month" as a unit of time has inherent ambiguity. When no specific month can be infered, the value 30.4375 is used, which is the average number of days in a months.
   * @example
   *
   ...
   * @extra %year% is provided as an alias. Note that "a year" as a unit of time has inherent ambiguity. When no specific year can be infered, a calculation of 325 days is used, however exact calculations that take leap years into consideration should not use these methods.
   * @example
   *
  ...
  extend(String, true, {
     ...
     * @extra [search] may be either a string or regex. If [search] isn't specified, it defaults to each character in the string. Returns an array of matches.
     * @example
     *
     ...
     * @extra Negative [n] will return a blank string.
     * @example
     *

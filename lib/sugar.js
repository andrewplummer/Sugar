  ...
  var CommonLanguages = {
    ...
    'pt': {
      ...
      modifiers: [
        ...
        { name: 'sign', text: 'atrás|atras', value: -1 },
        { name: 'sign', text: 'há|ha', value: -1 },
...
//
      ...
      var setArray = function(name, abbreviate, multiple) {
        ...
        if(set[name]) {
          ...
          if(abbreviate) arr.add(set[name].map(function(m) { return m.slice(0,3).toLowerCase(); }));
        }
        //revisit!!
      ...
      */
      ...
      addFormat('(' + set.weekdays.join('|') + ')', { to: ['weekday'] });
    ...
    'is': function(d, buffer) {
      ...
      if(Object.isString(d)) {
        ...
        switch(true) {
          ...
          case (tmp = EnglishWeekdays.indexOf(d) % 7) > -1: return this.getDay() === tmp;
          case (tmp = EnglishMonths.indexOf(d) % 12) > -1:  return this.getMonth() === tmp;
        }
      }

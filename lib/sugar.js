(function(){
  ...
  extend(String, true, {
     ...
     * @method from([index] = 0)
     * @returns String
     * @description Returns a section of the string starting from [index]. Shortcut for %slice([index])%.
     * @example
     *
     ...
     * @method to([index] = end)
     * @returns String
     * @description Returns a section of the string ending at [index]. Shortcut for %slice(0, [index])%.
     * @example
     *
  ...
  extend(Array, true, {
     ...
     * @method find(<s>)
     * @returns Mixed
     * @description Returns the first element that matches <s>.
     * @example
     *
     *   [1,2,3].find(3)                           -> 3
     *   [{a:1},{a:2},{a:3}].find(/{a:2}/);        -> {a:2}
     *   [{a:1},{a:2},{a:3}].find(function(n){
     *     return n['a'] == 3;
     *   });                                       -> {a:3}
     *   ['spain','germany','france'].find(/^fr/); -> 'france'
     *
     ***/
    'find': function(f){
     ...
     * @method findAll(<s>)
     * @returns Array
     * @description Returns all elements that match <s>.
     * @example
     *
     *   [1,2,3].find(3)                         -> [3]
     *   [{a:1},{a:2},{a:3}].find(/{a:2}/);      -> [{a:2}]
     *   [{a:1,b:2},{a:1,b:3}].find(function(n){
     *     return n['a'] == 1;
     *   });                                     -> [{a:1,b:2},{a:1,b:3}]
     *   ['cuba','japan','canada'].find(/^c/);   -> ['cuba','canada']
     *
     ***/
    ...
    /***
     * @method findFromIndex(<index> = 0, <s>)
     * @returns Mixed
     * @description Returns the first element that matches <s>. Starts at [index].
     * @example
     *
     *   [{a:1,b:2},{a:1,b:3},{a:1,b:4}].findFromIndex(1, function(n){
     *     return n['a'] == 1;
     *   });                                      -> {a:1,b:3}
    ...
    /***
     * @method findAllFromIndex(<index> = 0, <s>)
     * @returns Array
     * @description Returns all elements that match <s>. Starts at [index].
     * @example
     *
     *   [{a:1,b:2},{a:1,b:3},{a:1,b:4}].findAllFromIndex(1, function(n){
     *     return n['a'] == 1;
     *   });                                               -> [{a:1,b:3},{a:1,b:4}]
     *   ['cuba','japan','canada'].findFromIndex(2, /^c/); -> 'canada'
     *
     ***/

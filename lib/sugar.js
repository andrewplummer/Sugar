(function() {
      ...
      arrayEach(DateInputFormats, function(dif) {
        ...
        if(match) {
          ...
          if(set[tokens.unit]) {
            ...
            if(isDefined(set[tokens.weekday])) {
  ...
  function updateDate(date, params, reset, utc, advance) {
    ...
    if(!advance && isUndefined(params[tokens.day]) && isDefined(params[tokens.weekday])) {
    ...
    if(advance && isDefined(params[tokens.month])) {

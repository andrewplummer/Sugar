...
(function(){
  ...
  var extendWithNativeCondition = function(klass, instance, condition, methods){
    ...
    for(var name in extend){
      ...
      klass.prototype[name] = wrapNative(klass.prototype[name], extend[name], condition);
    }
  };
  ...
  var hashMethods = ['keys','values','each','merge','clone','empty','equals'];
  ...
  extend(Object, false, {
     ...
     * @example
     *
     *   var f = Object.extend({ broken: 'wear', fire: 'breath' });
     *   f.keys() -> ['broken', 'fire'];
     *
     ***/
    'extend': function(obj){
  ...
  extend(String, true, {
     ...
     *
     *   'jumpy'.blank('py')         -> true;
     *   'jumpy'.blank(/[q-z]/)      -> true;
     *   'jumpy'.blank('MPY')        -> false;
     *   'jumpy'.blank('MPY', false) -> true;
     *
     ***/
    'blank': function(){
  ...
  extendWithNativeCondition(String, true, function(r){ return RegExp.NPCGSupport || r.global; }, {
  ...
  extendWithNativeCondition(Function, true, function(scope, args){ return args === undefined; }, {

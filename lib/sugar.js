(function() {
  ...
  extend(Array, true, {
    ...
    'each': function(fn, fromIndex, loop) {
      ...
      while(i < length) {
        index = i % this.length;
        if(this.hasOwnProperty(index) && fn.call(this, this[index], index, this) === false) {
          break;
        }
        i++;
      }
  ...
  var buildWidthConversionTables = function() {
    ...
    widthConversionRanges.each(function(r) {
      r.start.upto(r.end, function(n) {
        setWidthConversion(r.type, String.fromCharCode(n), String.fromCharCode(n + r.shift));
      });
    });
  ...
  var buildBind = function() {
    ...
    extendWithNativeCondition(Function, true, supported, {
      ...
      'bind': function(scope) {
        ...
        bound = function() {
          return fn.apply(this instanceof fn ? this : scope, args.concat(Array.prototype.slice.call(arguments)));
        }
        nop = function() {};

(function() {
  ...
  function mergeObject(target, source, deep) {
    iterateOverObject(source, function(k, v) {
      if(isObjectPrimitive(v) && deep === true) {
        if(!target[k]) target[k] = Object.isArray(v) ? [] : {};
        mergeObject(target[k], v, deep);
      } else {
        target[k] = v;
      }
    });

(function() {
  ...
  function buildWatch() {
    extend(Object, false, true, {
       ...
       * @extra <fn> is passed three arguments: the property (<prop>), the old value, and the new value. The return value of [fn] will be set as the new value. This method is useful for things such as validating or cleaning the value when it is set. Warning: this method WILL NOT work in browsers that don't support Object.defineProperty. This notably includes IE 8 and below and Opera. This is the only method in Sugar that is not fully compatible with all browsers.
       * @example
       *
       ...
       * @extra <fn> is passed three arguments: the property (<prop>), the old value, and the new value. The return value of [fn] will be set as the new value. This method is useful for things such as validating or cleaning the value when it is set. Warning: this method WILL NOT work in browsers that don't support Object.defineProperty. This notably includes IE 8 and below and Opera. This is the only method in Sugar that is not fully compatible with all browsers. This method is only available on extended objects created with %Object.extended%.
       * @example
       *
  ...
  function formatDate(date, f, relative, locale) {
    var adu, loc = getLocalization(locale, true), caps = /^[A-Z]/, value, l;
    if(!date.isValid()) {
      return 'Invalid Date';
    } else if(Date[f]) {
      f = Date[f];

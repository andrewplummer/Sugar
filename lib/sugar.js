(function() {
  ...
  function multiArgs(args, fn, flatten) {
    args = getArgs(args);
  ...
  extend(number, true, false, {
    ...
    'format': function(place, thousands, decimal) {
      var str, split, method, after, r = reg(/(\d+)(\d{3})/);
  ...
  extend(Function, true, false, {
     ...
     * @example
     *
     *   var delay = setTimeout.fill(undefined, 1000);
     *   delay(function() {
     ...
     ***/
    'fill': function() {
      var fn = this, curried = arguments;
      return function() {
        var args = getArgs(arguments);
        iterateOverObject(curried, function(index, arg) {
          if(arg !== Undefined || index >= args.length) args.insert(arg, index);
        });

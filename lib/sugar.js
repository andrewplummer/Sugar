...
(function(){
  ...
  dateFormats.each(function(d){
    ...
    d.to = d.to.concat(['hours','minutes','seconds','milliseconds','meridian','timezone']);
  });
  ...
  console.info(dateFormats);
    ...
    dateFormats.each(function(format){
      ...
      if(match){
        console.info('match? ', format.reg, match);

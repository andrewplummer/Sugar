(function() {
  ...
  var typeMethods = ['Array','Arguments','Boolean','Date','Function','Number','String','RegExp'];
  ...
  var buildWatch = function() {
    extend(Object, false, true, {
      /***
       * @method Object.watch(<str>, [deep] = true)
       * @returns Object
       ...
       * @example
       *
       *   Object.watch('foo=bar&broken=wear') -> { foo: 'bar', broken: 'wear' }
       *   Object.watch('foo[]=1&foo[]=2')     -> { foo: [1,2] }
       *
       ***/
  ...
  extend(Array, false, false, {
     ...
     * @extra This method will create a single arrray by calling %concat% on all arguments passed. In addition to ensuring that an unknown variable is in an array (the standard constructor will create nested arrays, this one will not), it is also a useful shorthand to convert a function's arguments object into a standard array.
     * @example
     *
     *   Array.create('one', true, 3)   -> ['one', true, 3]
     *   Array.create(['one', true, 3]) -> ['one', true, 3]
     *   Array.create(arguments) -> Array with arguments
     *
     ***/
    'create': function(obj) {
      var result = [];
      multiArgs(arguments, function(a) {
        if(Object.isArguments(a)) a = Array.prototype.slice.call(a);
   ...
   * @method [unit]()
   * @returns Number
   * @short Takes the number as one of that unit and converts to milliseconds.
   * @extra Method names can be both singular and plural.  Note that as "a month" is ambiguous as a unit of time, %months% will use the value 30.4375 instead, which is the average number of days in a month. Be careful using %months% if you need exact precision.
   * @example
   *
   *   (5).milliseconds() -> 5
   *   (10).hours()       -> 36000000
   ...
   *
   ***
   * @method [unit]sBefore([d])
   * @returns Date
   * @short Returns a date that is <n> units before [d], where <n> is the number.
   * @extra [d] will accept a date object, timestamp, or text format. See @date_format for more information. If not specified, [d] is assumed to be now. %[unit]sAgo% is provided as an alias to make this more readable. Singular form also improves readability here. Note that "months" is ambiguous as a unit of time. If the target date falls on a day that does not exist (ie. August 31 -> February 31), the date will be shifted to the last day of the month. Be careful using %monthsBefore% if you need exact precision.
   * @example
   *
   ...
   *
   ***
   * @method [unit]sAfter([d])
   * @returns Date
   * @short Returns a date <n> units after [d], where <n> is the number.
   * @extra [d] will accept a date object, timestamp, or text format. See @date_format for more information. If not specified, [d] is assumed to be now. %[unit]sFromNow% is provided as an alias to make this more readable. Singular form also improves readability here. Note that "months" is ambiguous as a unit of time. If the target date falls on a day that does not exist (ie. August 31 -> February 31), the date will be shifted to the last day of the month. Be careful using %monthsAfter% if you need exact precision.
   * @example
   *
  ...
  var CommonLocales = {
    ...
    'en': '2;;January,February,March,April,May,June,July,August,September,October,November,December;Sunday,Monday,Tuesday,Wednesday,Thursday,Friday,Saturday;millisecond:|s,second:|s,minute:|s,hour:|s,day:|s,week:|s,month:|s,year:|s;one,two,three,four,five,six,seven,eight,nine,ten;a,an,the;the,st|nd|rd|th,of;{num} {unit} {sign},{num} {unit4} {sign} {day},{weekday?} {month} {date}{2} {year?} {time?},{date} {month} {year},{month} {year},{shift?} {weekday} {time?},{shift} week {weekday?} {time?},{shift} {unit=5-7},{1} {edge} of {shift?} {unit=4-7?}{month?}{year?},{weekday} {3} {shift} week,{1} {date}{2} of {month},{1}{month?} {date?}{2} of {shift} {unit=6-7},{day} at {time?},{time} {day};,yesterday,today,tomorrow;,ago|before,,from now|after|from;,last,the|this,next;last day,end,,first day|beginning',

    'ja': '1;月;;日曜日,月曜日,火曜日,水曜日,木曜日,金曜日,土曜日;ミリ秒,秒,分,時間,日,週間|週,ヶ月|ヵ月|月,年;一,二,三,四,五,六,七,八,九,十;;;{num}{unit}{sign},{shift}{unit=5-7}{weekday?},{year}年{month?}月?{date?}日?,{month}月{date?}日?,{date}日;一昨日,昨日,今日,明日,明後日;,前,,後;,去|先,,来',

    'ko': '1;월;;일요일,월요일,화요일,수요일,목요일,금요일,토요일;밀리초,초,분,시간,일,주,개월|달,년;일|한,이,삼,사,오,육,칠,팔,구,십;;;{num}{unit} {sign},{shift} {unit=5-7},{shift} {unit=5?} {weekday},{year}년{month?}월?{date?}일?,{month}월{date?}일?,{date}일;그저께,어제,오늘,내일,모레;,전,,후;,지난|작,이번,다음|내',

    'ru': '4;;Январ:я|ь,Феврал:я|ь,Март:а|,Апрел:я|ь,Ма:я|й,Июн:я|ь,Июл:я|ь,Август:а|,Сентябр:я|ь,Октябр:я|ь,Ноябр:я|ь,Декабр:я|ь;Воскресенье,Понедельник,Вторник,Среда,Четверг,Пятница,Суббота;миллисекунд:а|у|ы|,секунд:а|у|ы|,минут:а|у|ы|,час:||а|ов,день|день|дня|дней,недел:я|ю|и|ь|е,месяц:||а|ев|е,год|год|года|лет|году;од:ин|ну,дв:а|е,три,четыре,пять,шесть,семь,восемь,девять,десять;;в|на;{num} {unit} {sign},{sign} {num} {unit},{date} {month} {year?},{month} {year},{1} {shift} {unit=5-7};позавчера,вчера,сегодня,завтра,послезавтра;,назад,,через;,прошло:й|м,,следующе:й|м',

    'es': '6;;enero,febrero,marzo,abril,mayo,junio,julio,agosto,septiembre,octubre,noviembre,diciembre;domingo,lunes,martes,miércoles|miercoles,jueves,viernes,sábado|sabado;milisegundo:|s,segundo:|s,minuto:|s,hora:|s,día|días|dia|dias,semana:|s,mes:|es,año|años|ano|anos;uno,dos,tres,cuatro,cinco,seis,siete,ocho,nueve,diez;;el,de;{sign} {num} {unit},{num} {unit} {sign},{date?} {2} {month} {2} {year?},{1} {unit=5-7} {shift},{1} {shift} {unit=5-7};anteayer,ayer,hoy,mañana|manana;,hace,,de ahora;,pasad:o|a,,próximo|próxima|proximo|proxima',

    'pt': '6;;janeiro,fevereiro,março,abril,maio,junho,julho,agosto,setembro,outubro,novembro,dezembro;domingo,segunda-feira,terça-feira,quarta-feira,quinta-feira,sexta-feira,sábado|sabado;milisegundo:|s,segundo:|s,minuto:|s,hora:|s,dia:|s,semana:|s,mês|mêses|mes|meses,ano:|s;um,dois,três|tres,quatro,cinco,seis,sete,oito,nove,dez,uma,duas;;a,de;{num} {unit} {sign},{sign} {num} {unit},{date?} {2} {month} {2} {year?},{1} {unit=5-7} {shift},{1} {shift} {unit=5-7};anteontem,ontem,hoje,amanh:ã|a;,atrás|atras|há|ha,,daqui a;,passad:o|a,,próximo|próxima|proximo|proxima',

    'fr': '2;;janvier,février|fevrier,mars,avril,mai,juin,juillet,août,septembre,octobre,novembre;dimanche,lundi,mardi,mercredi,jeudi,vendredi,samedi;milliseconde:|s,seconde:|s,minute:|s,heure:|s,jour:|s,semaine:|s,mois,an:|s|née|nee;un:|e,deux,trois,quatre,cinq,six,sept,huit,neuf,dix;;l\'|la|le;{sign} {num} {unit},{sign} {num} {unit},{1} {date?} {month} {year?},{1} {unit=5-7} {shift};,hier,aujourd\'hui,demain;,il y a,,dans|d\'ici;,derni:er|ère|ere,,prochain:|e',

    'it': '2;;Gennaio,Febbraio,Marzo,Aprile,Maggio,Giugno,Luglio,Agosto,Settembre,Ottobre,Novembre,Dicembre;Domenica,Luned:ì|i,Marted:ì|i,Mercoled:ì|i,Gioved:ì|i,Venerd:ì|i,Sabato;millisecond:o|i,second:o|i,minut:o|i,or:a|e,giorn:o|i,settiman:a|e,mes:e|i,ann:o|i;un:|a|o,due,tre,quattro,cinque,sei,sette,otto,nove,dieci;;l\'|la|il;{num} {unit} {sign},{weekday?} {date?} {month} {year?},{1} {unit=5-7} {shift},{1} {shift} {unit=5-7};,ieri,oggi,domani,dopodomani;,fa,,da adesso;,scors:o|a,,prossim:o|a',

    'de': '2;;Januar,Februar,März|Marz,April,Mai,Juni,Juli,August,September,November,Dezember;Sonntag,Montag,Dienstag,Mittwoch,Donnerstag,Freitag,Samstag;Millisekunde:|n,Sekunde:|n,Minute:|n,Stunde:|n,Tag:|en,Woche:|n,Monat:|en,Jahr:|en;ein:|e|er|em|en,zwei,drei,vier,fuenf,sechs,sieben,acht,neun,zehn;;der;{sign} {num} {unit},{num} {unit} {sign},{num} {unit} {sign},{sign} {num} {unit},{weekday?} {date?} {month} {year?},{shift} {unit=5-7};vorgestern,gestern,heute,morgen,übermorgen|ubermorgen|uebermorgen;,vor:|her,,in;,letzte:|r|n|s,,nächste:|r|n|s+nachste:|r|n|s+naechste:|r|n|s',

    'zh-TW': '1;月;;日,一,二,三,四,五,六;毫秒,秒鐘,分鐘,小時,天,個星期|週,個月,年;一,二,三,四,五,六,七,八,九,十;;;{num}{unit}{sign},星期{weekday},{shift}{unit=5-7},{shift}{unit=5}{weekday},{year}年{month?}月?{date?}日?,{month}月{date?}日?,{date}日;前天,昨天,今天,明天,後天;,前,,後;,上|去,這,下|明',

    'zh-CN': '1;月;;日,一,二,三,四,五,六;毫秒,秒钟,分钟,小时,天,个星期|周,个月,年;一,二,三,四,五,六,七,八,九,十;;;{num}{unit}{sign},星期{weekday},{shift}{unit=5-7},{shift}{unit=5}{weekday},{year}年{month?}月?{date?}日?,{month}月{date?}日?,{date}日;前天,昨天,今天,明天,后天;,前,,后;,上|去,这,下|明'
  ...
  var initializeLocale = function(code, set, current) {
    ...
    var eachAlternate = function(n, fn) {
      n = n.split('+').map(function(q) {
        return q.replace(/(.+):(.+)$/, function(full, base, suffixes) {
    ...
    var getDigit = function(start, stop) {
      ...
      if(set.extraDigits) str += '|[' + set.extraDigits + ']+';
      return str;
    }

    var getNum = function() {
      var arr = [getDigit()].concat(set.articles);
      if(!set.extraDigits) arr = arr.concat(set.numbers);
  ...
  var getLocalizationSet = function(code) {
    var set = { modifiers: [], pastRelativeFormat: 0 }, pre = CommonLocales[code].split(';');
    var bool = function(n) {
  ...
  var getExtendedDate = function(f, locale) {
    var d = new Date(), relative = false, format, set, unit, amt, loc, tmp;
    if(Object.isDate(f)) {
      d = f;
  ...
  var formatDate = function(date, f, locale) {
    var adu, loc = getLocalization(locale);
    if(!f) {
    ...
    if(f == 'relative') {
      ...
      return loc.relative(adu[0],adu[1],adu[3]);
    }
   ...
   * @extra [d] will accept a date object, timestamp, or text format. If not specified, [d] is assumed to be now. %[unit]sAgo% is provided as an alias to make this more readable. For more see @date_format.
   * @example
   *
   ...
   * @extra [d] will accept a date object, timestamp, or text format. If not specified, [d] is assumed to be now. %[unit]sFromNow% is provided as an alias to make this more readable. For more see @date_format.
   * @example
   *
   ...
   * @method add[Unit](<num>)
   * @returns Date
   * @short Adds <num> to the date of the appropriate unit.
  ...
  extend(Date, true, false, {
    ...
    'format': function(f, locale) {
      return formatDate(this, f, locale);
    },
    ...
    'relative': function(fn, locale) {
      return formatDate(this, fn || 'relative', locale);
    },
  ...
  var setDelay = function(fn, ms, after, scope, args) {
    ...
    var timer = setTimeout(function(){
      ...
      fn.timers.remove(timer);
    }, ms);
    fn.timers.push(timer);
  };
  ...
  extend(Function, true, false, {
    ...
    'lazy': function(ms, limit) {
      ...
      var run = 0;
      var lazy = function() {
        if(lazy.timers && lazy.timers.length >= limit) return;
        setDelay(lazy, Math.round(++run * ms), fn, this, arguments);
      }
      return lazy;
    },
    ...
    'debounce': function(ms, wait) {
      var fn = this, before, after, lock;
      if(wait === undefined) wait = true;
      if(wait) {
        before = function() { fn.cancel(); }
        after  = fn;
      } else {
        before = fn;
        after  = function() { lock = false; }
      }
      return function() {
        if(lock) return;
        before.apply(this, arguments);
        setDelay(fn, ms, after, this, arguments);
        lock = !wait;
      };
    },

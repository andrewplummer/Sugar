(function() {
  ...
  extend(object, false, false, {
    ...
    /***
     * @method Object.merge(<target>, <source>, [resolve] = true)
     * @returns Merged object
     * @short Merges all the properties of <source> into <target>.
     * @extra Properties of <source> will win in the case of conflicts, unless [resolve] is %false%. [resolve] can also be a function that resolves the conflict. In this case it will be passed 3 arguments, %key%, %targetVal%, and %sourceVal%, and the context (%this% argument) will be <source>. This will allow you to solve conflict any way you want, ie. adding two numbers together or etc. The instance method alias is only available on extended objects created with %Object.extended%.
     * @example
     *

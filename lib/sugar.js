(function() {
  ...
  function mapHashMethods(obj) {
    arrayEach(['keys','values','each','merge','isEmpty','clone','equal','watch','tap'], function(m) {
  ...
  extend(object, false, false, {
     ...
     * @extra This method is used to run an intermediary function in the middle of method chaining, and so as a standalone method on the Object class it doesn't have too much use. The power of %tap% comes when using %Object.sugar% to augment Object.prototype. After this point the %tap% method will be available on all objects. A string can also be passed as a shortcut to a method.
     * @example
     *
     *   Object.sugar();

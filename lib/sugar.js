(function() {
  ...
  var CommonLocales = {
    ...
    'de': '6;;Januar,Februar,März|Marz,April,Mai,Juni,Juli,August,September,November,Dezember;Sonntag,Montag,Dienstag,Mittwoch,Donnerstag,Freitag,Samstag;Millisekunde:|n,Sekunde:|n,Minute:|n,Stunde:|n,Tag:|en,Woche:|n,Monat:|en,Jahr:|en;eine:|r|m,zwei,drei,vier,fuenf,sechs,sieben,acht,neun,zehn;;der;{num} {unit} {sign},{sign} {num} {unit},{num} {unit} {sign},{sign} {num} {unit},{weekday?} {date?} {month} {year?},{shift} {unit=5-7};vorgestern,gestern,heute,morgen,übermorgen|ubermorgen;,vor,,in;,letzte:|r|n|s,,nächste|nächster|nächsten|nachste|nachster|nachsten',

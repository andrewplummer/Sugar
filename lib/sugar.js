...
(function(){
  ...
  extend(Number, true, {
    ...
    'pad': function(num, force){
      ...
      return (force ? sign : '') + str.padLeft(num - str.length, '0');
    },
  ...
  extend(String, true, {
    ...
    /***
     * @method pad([num], [padding], [side])
     * @returns String
     * @description Pads the string. [num] is the number of characters on each side, and [padding] is the character to pad with. [direction] can be "left", "right", or "both".
     ...
     * @returns String
     * @description Pads the left side of the string with [num] characters. [padding] is the character to pad with.
     ...
     * @returns String
     * @description Pads the right side of the string with [num] characters. [padding] is the character to pad with.
     * @defaults [num] = 0, [padding] = ' '
     * @example
     *

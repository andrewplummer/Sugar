(function(){
   ...
   * @returns Boolean
   * @short Returns true if <obj> is an Array. False otherwise.
   * @example
   *
   ...
   * @returns Boolean
   * @short Returns true if <obj> is a Boolean. False otherwise.
   * @example
   *
   ...
   * @returns Boolean
   * @short Returns true if <obj> is a Date. False otherwise.
   * @example
   *
   ...
   * @returns Boolean
   * @short Returns true if <obj> is a Function. False otherwise.
   * @example
   *
   ...
   * @returns Boolean
   * @short Returns true if <obj> is a Number. False otherwise.
   * @example
   *
   ...
   * @returns Boolean
   * @short Returns true if <obj> is a String. False otherwise.
   * @example
   *
   ...
   * @returns Boolean
   * @short Returns true if <obj> is a RegExp. False otherwise.
   * @example
   *
  ...
  extend(Object, false, {
     ...
     * @returns Boolean
     * @short Returns true if <obj> is a "plain object" or "object literal". Instances of inherited classes return false here.
     * @example
     *
     ...
     * @returns Object
     * @short Iterates over each property in <obj>.
     * @example
     *
     ...
     * @method each([fn])
     * @returns Object
     * @short Iterates over each property in the object. This method is only available on objects created with the alternate constructor %Object.create%.
     * @example
     *
     ...
     * @returns Merged object
     * @short Accepts an arbitrary number of objects as arguments and merges them all into itself. This method is only available on objects created with the alternate constructor %Object.create%.
     * @example
     *
     ...
     * @method clone()
     * @returns Cloned object
     * @short Creates a deep clone (copy) of the object. This method is only available on objects created with the alternate constructor %Object.create%.
     * @example
     *
     ...
     * @returns Boolean
     * @short Returns true if <obj> is empty. False otherwise.
     * @example
     *
     *   Object.isEmpty({})          -> true
     ...
     * @method isEmpty()
     * @returns Boolean
     * @short Returns true if the object is empty. False otherwise. This method is only available on objects created with the alternate constructor %Object.create%.
     * @example
     *
     ...
     * @returns Boolean
     * @short Returns true if <a> and <b> are equal. False otherwise.
     * @example
     *
     ...
     * @method equals(<obj>)
     * @returns Boolean
     * @short Returns true if <obj> is equal to the object. False otherwise. This method is only available on objects created with the alternate constructor %Object.create%.
     * @example
     *
  ...
  extendWithNativeCondition(Object, false, function(){ return arguments.length == 1; }, {
     ...
     * @method keys([fn])
     * @returns Array
     * @short Returns an array containing the keys in the object. Optionally calls [fn] for each key. This method is only available on objects created with the alternate constructor %Object.create%.
     * @example
     *
     ...
     * @method values([fn])
     * @returns Array
     * @short Returns an array containing the values in the object. Optionally calls [fn] for each value. This method is only available on objects created with the alternate constructor %Object.create%.
     * @example
     *
   ...
   * @method milliseconds()
   * @returns Number
   * @short Takes the number as milliseconds and returns milliseconds. This method is included for completeness and effectively just rounds the number. %millisecond% is provided as an alias.
   * @example
   *
   *   (5).milliseconds() -> 5
   *
   ***
   * @method millisecondsBefore([date])
   * @returns Date
   * @short Returns a date <n> milliseconds before [d], where <n> is the number.
   * @extra [date] will accept a date object, timestamp, or text format (see @date_format for more information). If not specified, [date] is assumed to be now. %millisecondsAgo% is provided as an alias. Also accepts %millisecondBefore% and %millisecondAgo%.
   * @example
   *
   ...
   *
   ***
   * @method millisecondsAfter([date])
   * @returns Date
   * @short Returns a date <n> milliseconds after [d], where <n> is the number.
   * @extra [date] will accept a date object, timestamp, or text format. See @date_format for more information. If not specified, [date] is assumed to be now. %millisecondsFromNow% is provided as an alias. Also accepts %millisecondAfter% and %millisecondAgo%.
   * @example
   *
   ...
   * @method seconds()
   * @returns Number
   * @short Takes the number as seconds and returns milliseconds. %second% is provided as an alias.
   * @example
   *
   *   (5).seconds() -> 5000
   *
   ***
   * @method secondsBefore([date])
   * @returns Date
   * @short Returns a date <n> seconds before [d], where <n> is the number.
   * @extra [date] will accept a date object, timestamp, or text format (see @date_format for more information). If not specified, [date] is assumed to be now. %secondsAgo% is provided as an alias. Also accepts %secondBefore% and %secondAgo%.
   * @example
   *
   ...
   *
   ***
   * @method secondsAfter([date])
   * @returns Date
   * @short Returns a date <n> seconds after [d], where <n> is the number.
   * @extra [date] will accept a date object, timestamp, or text format. See @date_format for more information. If not specified, [date] is assumed to be now. %secondsFromNow% is provided as an alias. Also accepts %secondAfter% and %secondAgo%.
   * @example
   *
   ...
   * @method minutes()
   * @returns Number
   * @short Takes the number as minutes and returns milliseconds. %minute% is provided as an alias.
   * @example
   *
   *   (5).minutes() -> 300000
   *
   ***
   * @method minutesBefore([date])
   * @returns Date
   * @short Returns a date <n> minutes before [d], where <n> is the number.
   * @extra [date] will accept a date object, timestamp, or text format (see @date_format for more information). If not specified, [date] is assumed to be now. %minutesAgo% is provided as an alias. Also accepts %minuteBefore% and %minuteAgo%.
   * @example
   *
   ...
   *
   ***
   * @method minutesAfter([date])
   * @returns Date
   * @short Returns a date <n> minutes after [d], where <n> is the number.
   * @extra [date] will accept a date object, timestamp, or text format. See @date_format for more information. If not specified, [date] is assumed to be now. %minutesFromNow% is provided as an alias. Also accepts %minuteAfter% and %minuteAgo%.
   * @example
   *
   ...
   * @method hours()
   * @returns Number
   * @short Takes the number as hours and returns milliseconds. %hour% is provided as an alias.
   * @example
   *
   *   (5).hours() -> 18000000
   *
   ***
   * @method hoursBefore([date])
   * @returns Date
   * @short Returns a date <n> hours before [d], where <n> is the number.
   * @extra [date] will accept a date object, timestamp, or text format (see @date_format for more information). If not specified, [date] is assumed to be now. %hoursAgo% is provided as an alias. Also accepts %hourBefore% and %hourAgo%.
   * @example
   *
   ...
   *
   ***
   * @method hoursAfter([date])
   * @returns Date
   * @short Returns a date <n> hours after [d], where <n> is the number.
   * @extra [date] will accept a date object, timestamp, or text format. See @date_format for more information. If not specified, [date] is assumed to be now. %hoursFromNow% is provided as an alias. Also accepts %hourAfter% and %hourAgo%.
   * @example
   *
   ...
   * @method days()
   * @returns Number
   * @short Takes the number as days and returns milliseconds. %day% is provided as an alias.
   * @example
   *
   *   (5).days() -> 432000000
   *
   ***
   * @method daysBefore([date])
   * @returns Date
   * @short Returns a date <n> days before [d], where <n> is the number.
   * @extra [date] will accept a date object, timestamp, or text format (see @date_format for more information). If not specified, [date] is assumed to be now. %daysAgo% is provided as an alias. Also accepts %dayBefore% and %dayAgo%.
   * @example
   *
   ...
   *
   ***
   * @method daysAfter([date])
   * @returns Date
   * @short Returns a date <n> days after [d], where <n> is the number.
   * @extra [date] will accept a date object, timestamp, or text format. See @date_format for more information. If not specified, [date] is assumed to be now. %daysFromNow% is provided as an alias. Also accepts %dayAfter% and %dayAgo%.
   * @example
   *
   ...
   * @method weeks()
   * @returns Number
   * @short Takes the number as weeks and returns milliseconds. %week% is provided as an alias.
   * @example
   *
   *   (5).weeks() -> 3024000000
   *
   ***
   * @method weeksBefore([date])
   * @returns Date
   * @short Returns a date <n> weeks before [d], where <n> is the number.
   * @extra [date] will accept a date object, timestamp, or text format (see @date_format for more information). If not specified, [date] is assumed to be now. %weeksAgo% is provided as an alias. Also accepts %weekBefore% and %weekAgo%.
   * @example
   *
   ...
   *
   ***
   * @method weeksAfter([date])
   * @returns Date
   * @short Returns a date <n> weeks after [d], where <n> is the number.
   * @extra [date] will accept a date object, timestamp, or text format. See @date_format for more information. If not specified, [date] is assumed to be now. %weeksFromNow% is provided as an alias. Also accepts %weekAfter% and %weekAgo%.
   * @example
   *
   ...
   * @method months()
   * @returns Number
   * @short Takes the number as months and returns milliseconds. %month% is provided as an alias.
   * @extra Note that "a month" as a unit of time has inherent ambiguity. When no specific month can be infered, the value 30.4375 is used, which is the average number of days in a months.
   * @example
   *
   *   (5).months() -> 13149000000
   *
   ***
   * @method monthsBefore([date])
   * @returns Date
   * @short Returns a date <n> months before [d], where <n> is the number.
   * @extra [date] will accept a date object, timestamp, or text format (see @date_format for more information). If not specified, [date] is assumed to be now. %monthsAgo% is provided as an alias. Also accepts %monthBefore% and %monthAgo%.
   * @example
   *
   ...
   *
   ***
   * @method monthsAfter([date])
   * @returns Date
   * @short Returns a date <n> months after [d], where <n> is the number.
   * @extra [date] will accept a date object, timestamp, or text format. See @date_format for more information. If not specified, [date] is assumed to be now. %monthsFromNow% is provided as an alias. Also accepts %monthAfter% and %monthAgo%.
   * @example
   *
   ...
   * @method years()
   * @returns Number
   * @short Takes the number as years and returns milliseconds. %year% is provided as an alias.
   * @extra Note that "a year" as a unit of time has inherent ambiguity. When no specific year can be infered, a calculation of 325 days is used, however exact calculations that take leap years into consideration should not use these methods.
   * @example
   *
   *   (5).years() -> 157788000000
   *
   ***
   * @method yearsBefore([date])
   * @returns Date
   * @short Returns a date <n> years before [d], where <n> is the number.
   * @extra [date] will accept a date object, timestamp, or text format (see @date_format for more information). If not specified, [date] is assumed to be now. %yearsAgo% is provided as an alias. Also accepts %yearBefore% and %yearAgo%.
   * @example
   *
   ...
   *
   ***
   * @method yearsAfter([date])
   * @returns Date
   * @short Returns a date <n> years after [d], where <n> is the number.
   * @extra [date] will accept a date object, timestamp, or text format. See @date_format for more information. If not specified, [date] is assumed to be now. %yearsFromNow% is provided as an alias. Also accepts %yearAfter% and %yearAgo%.
   * @example
   *
  ...
  extend(Number, true, {
     ...
     * @returns Number
     * @short Rounds the number up. If [precision] is specified it will round to the given precision.
     * @example
     *
     *   (4.434).ceil()  -> 5
     *   (-4.434).ceil() -> -4
     ...
     * @returns Number
     * @short Rounds the number down. If [precision] is specified it will round to the given precision.
     * @example
     *
     *   (4.434).floor()  -> 4
     *   (-4.434).floor() -> -5
     ...
     * @returns String
     * @short Pads a number with "0" to <place>. [sign] allows you to force the sign as well (+05, etc).
     * @example
     *
     *   (5).pad(2)  -> '05'
     *   (-5).pad(4) -> '-0005'
     ...
     * @returns String
     * @short Formats a string separating the thousands into groups. [comma] is the character used for the thousands separator. [period] is the character used for the decimal point.
     * @example
     *
     *   (56782).format()           -> '56,782'
  ...
  extend(String, true, {
    ...
    'escapeRegExp': function(){
      ...
      * @returns String
      * @short Escapes characters in a string to make a valid URL. If [param] is true, it will also escape valid URL characters for use as a URL param.
      * @example
      *
    ...
    'escapeURL': function(param){
      ...
      * @returns String
      * @short Restores escaped characters in a URL escaped string. If [partial] is true, it will only unescape non-valid URL characters. [partial] is included here for completeness, but should very rarely be needed.
      * @example
      *
     ...
     * @returns String
     * @short Pads both sides of the string. [num] is the number of characters on each side, and [padding] is the character to pad with.
     * @example
     *
     *   'wasabi'.pad(2)               -> '  wasabi  '
     *   'wasabi'.pad(2, '--')         -> '--wasabi--'
     ...
     * @returns String
     * @short Pads the left side of the string. [num] is the number of characters on each side, and [padding] is the character to pad with.
     * @example
     *
     ...
     * @returns String
     * @short Pads the right side of the string. [num] is the number of characters on each side, and [padding] is the character to pad with.
     * @example
     *
     ...
     * @returns Array
     * @short Runs callback [fn] against each occurence of [search]. [search] may be either a string or regex. If [search] isn't specified, it defaults to each character in the string. Return value is an array of matches.
     * @example
     *
     ...
     * @method codes([fn])
     * @returns Array
     * @short Runs callback [fn] against each character in the string, passing in the character code for each character. Returns an array of character codes.
     * @example
     *
     ...
     * @method words([fn])
     * @returns Array
     * @short Runs callback [fn] against each "word" in the string. Returns an array of "words". A "word" here is defined as any sequence of non-whitespace characters.
     * @example
     *
     ...
     * @returns Array
     * @short Runs callback [fn] against each paragraph in the string. Returns an array of paragraphs. A paragraph here is defined as a block of text bounded by two or more line breaks.
     * @example
     *
     ...
     * @method normalize()
     * @returns String
     * @short Returns the string with non-standard Latin-based characters converted into standard ASCII, diacritics removed, etc.
     * @example
     *
     *   'á'.normalize()                  -> 'a'
     ...
     * @returns Boolean
     * @short Returns true if the string starts with <find> which may be either a string or RegExp, false otherwise.
     * @example
     *
     ...
     * @returns Boolean
     * @short Returns true if the string ends with <find> which may be either a string or RegExp, false otherwise.
     * @example
     *
     ...
     * @method has(<find>)
     * @returns Boolean
     * @short Returns true if the string matches <find>, which can be a string or regex.
     * @example
     *
     *   'jumpy'.has('py')     -> true
     *   'broken'.has(/[a-n]/) -> true
     ...
     * @returns String
     * @short Inserts <str> at [index]. Negative values are also allowed.
     * @example
     *
     ...
     * @returns String
     * @short Converts full-width characters (zenkaku) to half-width (hankaku). [mode] accepts any combination of "a" (alphabet), "n" (numbers), "k" (katakana), "s" (spaces), "p" (punctuation), or "all".
     * @example
     *
     ...
     * @returns String
     * @short Converts half-width characters (hankaku) to full-width (zenkaku). [mode] accepts any combination of "a" (alphabet), "n" (numbers), "k" (katakana), "s" (spaces), "p" (punctuation), or "all".
     * @example
     *
     ...
     * @returns String
     * @short Converts katakana into hiragana. If [all] is false, only convert full-width katakana, otherwise convert all.
     * @example
     *
     *   'カタカナ'.hiragana()   -> 'かたかな'
     ...
     * @returns Number
     * @short Converts the string into a number. Any value with a "." fill be converted to a floating point value, otherwise an integer.
     * @example
     *
     *   '153'.toNumber()    -> 153
     ...
     * @method compact()
     * @returns String
     * @short Compacts all white space in the string to a single space and trims whitespace off the ends.
     * @example
     *
     ...
     * @short Gets the character at a given index. When [loop] is true, overshooting the end of the string (or the beginning) will begin counting from the other end. As an alternate syntax, passing multiple indexes will get the characters at those indexes.
     * @example
     *
     *   'jumpy'.at(0)               -> 'j'
     *   'jumpy'.at(2)               -> 'm'
     ...
     * @method first([n] = 0)
     * @returns String
     * @short Returns the first [n] characters of the string. Negative [n] will return a blank string.
     * @example
     *
     ...
     * @method last([n] = 0)
     * @returns String
     * @short Returns the last [n] characters of the string. Negative [n] will return a blank string.
     * @example
     *
     *   'lucky charms'.last()   -> 's'
     ...
     * @method toDate()
     * @returns Date
     * @short Creates a date from the string. Accepts a wide range of inputs. See %Date.create% for more information.
     * @example
     *
     ...
     * @returns String
     * @short Converts underscores and hyphens to camel case. If mode is "upper" the first letter will also be capitalized.
     * @example
     *
     ...
     * @returns String
     * @short Strips all HTML tags from the string. Tags to strip may be enumerated in the parameters, otherwise will strip all.
     * @example
     *
     ...
     * @returns String
     * @short Removes all HTML tags and their contents from the string. Tags to remove may be enumerated in the parameters, otherwise will remove all.
     * @example
     *
     ...
     * @returns Object
     * @short Converts a string into an object based on a compound set of separators, such as would be found in URL params. Defaults are set up to quickly convert the URL query string.
     * @example
     *
  ...
  extendWithNativeCondition(String, true, function(s){ return !Object.isRegExp(s); }, {
     ...
     * @returns Array
     * @short Splits the string by [separator] into an Array. This method is native to Javascript, but Sugar patches it to provide cross-browser reliability when splitting on a regex.
     * @example
     *
  ...
  extendWithNativeCondition(Array, true, true, {
     ...
     * @returns Nothing
     * @short Iterates over the array, calling [fn] on each loop. [scope] becomes the %this% object. %Array#each% is provided as an alias. This method is only provided for those browsers that do not support it natively.
     * @example
     *
     ...
     * @returns Mixed
     * @short Reduces the array to a single result by stepping through it from the left, applying a callback on each iteration and using the result as the accumulated value in the next iteration. [init] can be passed to provide an initial value. This method is only provided for those browsers that do not support it natively.
     * @example
     *
     ...
     * @returns Mixed
     * @short Reduces the array to a single result by stepping through it from the right, applying a callback on each iteration and using the result as the accumulated value in the next iteration. [init] can be passed to provide an initial value. This method is only provided for those browsers that do not support it natively.
     * @example
     *
  ...
  extendWithNativeCondition(Array, true, function(a){ return !Object.isObject(a) && !Object.isFunction(a); }, {
    ...
    /***
     * @method indexOf(<a>, [offset])
     * @returns Number
     * @short Searches the array and returns the first index where <a> occurs, or -1 if the element is not found. [offset] is the index from which to begin the search. In addition to providing this method for browsers that don't support it natively, this enhanced method can also perform deep finds on objects or arrays, and accept an iterating function on which to perform the search.
     * @example
     *
     *   [1,2,3].indexOf(3)           -> 1
     *   [1,2,3].indexOf(7)           -> -1
    ...
    /***
     * @method lastIndexOf(<a>, [offset])
     * @returns Number
     * @short Searches the array and returns the last index where <a> occurs, or -1 if the element is not found. [offset] is the index from which to begin the search. In addition to providing this method for browsers that don't support it natively, this enhanced method can also perform deep finds on objects or arrays, and accept an iterating function on which to perform the search.
     * @example
     *
  ...
  extendWithNativeCondition(Array, true, function(){ return Object.isFunction(arguments[0]); }, {
    ...
    /***
     * @method every(<fn>, [scope])
     * @returns Boolean
     * @short Iterates over the array calling <fn>, and returns true if every call also returned a truthy value. [scope] is the %this% object. In addition to providing this method for browsers that don't support it natively, this enhanced method also directly accepts strings, numbers, deep objects, and arrays for <fn>. %Array#all% is provided an alias.
     * @example
     *
     +   ['a','a','a'].every(function(n){
     *     return n == 'a';
     *   });
     +   ['a','b','c'].every(function(n){
     *     return n == 'a';
     *   });
     *   ['a','a','a'].every('a')   -> true
     ...
     * @returns Boolean
     * @short Iterates over the array calling <fn>, and returns true if even one call also returned a truthy value. [scope] is the %this% object. In addition to providing this method for browsers that don't support it natively, this enhanced method also directly accepts strings, numbers, deep objects, and arrays for <fn>. %Array#any% and %Array#has% are provided as aliases.
     * @example
     *
    ...
    /***
     * @method filter(<fn>, [scope])
     * @returns Array
     * @short Returns an array containing the elements for which <fn> returned a truthy value. [scope] is the %this% object. In addition to providing this method for browsers that don't support it natively, this enhanced method also directly accepts strings, numbers, deep objects, and arrays for [fn].
     * @example
     *
     ...
     * @method map(<fn>, [scope])
     * @returns Array
     * @short Maps the array to another array, containing the values that are the result of [fn], which is called for each element. [scope] is the %this% object. In addition to providing this method for browsers that don't support it natively, this enhanced method also directly accepts a string, which is a shortcut for a function that calls that method on each element. %Array#collect% is provided as an alias.
     * @example
     *
  ...
  extend(Array, true, {
     ...
     * @returns Mixed
     * @short Returns the first element that matches <f>. Starts at [index].
     * @extra <f> will match a string, number, array, or object, or alternately test against a function or regex.
     * @example
     *
     *   [{a:1,b:2},{a:1,b:3},{a:1,b:4}].find(1, function(n){
     *     return n['a'] == 1;
     *   });                                     -> {a:1,b:3}
     *   ['cuba','japan','canada'].find(2, /^c/) -> 'canada'
     *
     ***/
     ...
     * @returns Array
     * @short Returns all elements that match <f>. Starts at [index].
     * @extra <f> will match a string, number, array, or object, or alternately test against a function or regex.
     * @example
     *
     *   [{a:1,b:2},{a:1,b:3},{a:1,b:4}].findAll(1, function(n){
     *     return n['a'] == 1;
     *   });                                        -> [{a:1,b:3},{a:1,b:4}]
     *   ['cuba','japan','canada'].findAll(2, /^c/) -> 'canada'
     *
     ***/
     ...
     * @returns Array
     * @short Runs <fn> against elements in the array starting at <index>. Will run a full loop starting over at index = 0 if [loop] is true.
     * @example
     *
     *   [{a:1,b:2},{a:1,b:3},{a:1,b:4}].findAll(1, function(n){
     *     return n['a'] == 1;
    ...
    'eachFromIndex': function(index, fn, loop){
      if(!loop && (index < 0 || index > this.length));
     ...
     ***/
    'count': function(f){
      return this.findAll(f, 0).length;
    },
     ...
     * @returns Array
     * @short Removes element at <start>. If [end] is specified, removes the range between <start> and [end].
     * @example
     *
    ...
    'removeAtIndex': function(start, end){
      ...
      return this.findAll(function(el, i){
     ...
     * @method union(<a>)
     * @returns Array
     * @short Merges the array with <a> and removes duplictes.
     * @example
     *
     ...
     * @method subtract(<a>)
     * @returns Array
     * @short Removes elements found in <a> from the array.
     * @example
     *
     ...
     * @method at(<index>, [loop] = true)
     * @returns Mixed
     * @short Gets the element at a given index. When [loop] is true, overshooting the end of the array (or the beginning) will begin counting from the other end. As an alternate syntax, passing multiple indexes will get the elements at those indexes.
     * @example
     *
     *   [1,2,3].at(0)        -> 1
     *   [1,2,3].at(2)        -> 3
     ...
     * @method first(<num>)
     * @returns Mixed
     * @short Returns the first element in the array. When <num> is passed, returns the first <num> elements in the array.
     * @example
     *
     *   [1,2,3].first()        -> 1
     *   [1,2,3].first(2)       -> [1,2]
     ...
     * @method last(<num>)
     * @returns Mixed
     * @short Returns the last element in the array. When <num> is passed, returns the last <num> elements in the array.
     * @example
     *
     *   [1,2,3].last()        -> 3
     *   [1,2,3].last(2)       -> [2,3]
     ...
     * @method min(<map>)
     * @returns Array
     * @short Returns an array of elements with the lowest value. <map> may be a function mapping the value to be checked or a string acting as a shortcut.
     * @example
     *
     *   [1,2,3].min()                    -> [1]
     ...
     * @method max(<map>)
     * @returns Array
     * @short Returns an array of elements with the greatest value. <map> may be a function mapping the value to be checked or a string acting as a shortcut.
     * @example
     *
     *   [1,2,3].max()                    -> [3]
     ...
     * @method least(<map>)
     * @returns Array
     * @short Returns an array of elements with the least commonly occuring value. <map> may be a function mapping the value to be checked or a string acting as a shortcut.
     * @example
     *
     *   [1,2,2].least()                   -> [1]
     ...
     * @method most(<map>)
     * @returns Array
     * @short Returns an array of elements with the most commonly occuring value. <map> may be a function mapping the value to be checked or a string acting as a shortcut.
     * @example
     *
     *   [1,2,2].most()                   -> [2]
     ...
     * @method sum(<map>)
     * @returns Number
     * @short Sums all values in the array. <map> may be a function mapping the value to be summed or a string acting as a shortcut.
     * @example
     *
     *   [1,2,2].sum()                           -> 5
     ...
     * @method average(<map>)
     * @returns Number
     * @short Averages all values in the array. <map> may be a function mapping the value to be averaged or a string acting as a shortcut.
     * @example
     *
     *   [1,2,3].average()                           -> 2
     ...
     * @returns Object
     * @short Groups the array by <property>, which may be a mapping function, or a string acting as a shortcut.
     * @example
     *
     ...
     * @returns Array
     * @short Groups the array into <num> arrays. [padding] specifies a value with which to pad the last array so that they are all equal length.
     * @example
     *
     ...
     * @returns Array
     * @short Groups the array into arrays of <num> entries. [padding] specifies a value with which to pad the last array so that they are all equal length.
     * @example
     *
     ...
     * @method compact()
     * @returns Array
     * @short Removes all instances of %undefined%, %null%, and %NaN% from the array. Empty strings and %false% are left untouched.
     * @example
     *
     ...
     * @method isEmpty()
     * @returns Boolean
     * @short Returns true if the array has a length of zero. Also runs %compact% to remove %undefined%, %null%, and %NaN%.
     * @example
     *
     *   [].isEmpty()               -> true
    ...
    /***
     * @method sortBy(<map>, [desc])
     * @returns Array
     * @short Sorts the array based on <map>, which may be a function or a string acting as a shortcut. [desc] will sort the array in descending order.
     * @example
     *
    ...
    /***
     * @method addAtIndex(<index>, <el>)
     * @returns Array
     * @short Adds <el> at index <index>.
     * @example
     *
     *   [1,2,3,4].addAtIndex(1, 8)          -> [1,8,2,3,4]
     *   ['a','b','c'].addAtIndex(3, 'doof') -> ['a','b','c','doof']
     *
     ***/
     ...
     * @method randomize()
     * @returns Array
     * @short Randomizes the array (Fisher-Yates algorithm). %Array#shuffle% provided as an alias.
     * @example
     *
     *   [1,2,3,4].randomize()  -> [?,?,?,?]
     *
  ...
  var createDate = function(args){
   ...
   /***
   * @method millisecondsSince([date])
   * @returns Number
   * @short Returns the number of milliseconds since [date].
   * @extra [date] will accept a date object, timestamp, or text format. See @date_format for more information. If not specified, [date] is assumed to be now.
   * @example
   *
   *   Date.create().millisecondsSince('1 hour ago') -> Milliseconds since 1 hour ago
   *   Date.create().millisecondsSince()             -> 0
   *
   ***
   * @method secondsSince([date])
   * @returns Number
   * @short Returns the number of seconds since [date].
   * @extra [date] will accept a date object, timestamp, or text format. See @date_format for more information. If not specified, [date] is assumed to be now.
   * @example
   *
   *   Date.create().secondsSince('1 hour ago') -> Seconds since 1 hour ago
   *   Date.create().secondsSince()             -> 0
   *
   ***
   * @method minutesSince([date])
   * @returns Number
   * @short Returns the number of minutes since [date].
   * @extra [date] will accept a date object, timestamp, or text format. See @date_format for more information. If not specified, [date] is assumed to be now.
   * @example
   *
   *   Date.create().minutesSince('1 hour ago') -> minutes since 1 hour ago
   *   Date.create().minutesSince()             -> 0
   *
   ***
   * @method hoursSince([date])
   * @returns Number
   * @short Returns the number of hours since [date].
   * @extra [date] will accept a date object, timestamp, or text format. See @date_format for more information. If not specified, [date] is assumed to be now.
   * @example
   *
   *   Date.create().hoursSince('1 hour ago') -> hours since 1 hour ago
   *   Date.create().hoursSince()             -> 0
   *
   ***
   * @method daysSince([date])
   * @returns Number
   * @short Returns the number of days since [date].
   * @extra [date] will accept a date object, timestamp, or text format. See @date_format for more information. If not specified, [date] is assumed to be now.
   * @example
   *
   *   Date.create().daysSince('1 week ago') -> days since 1 week ago
   *   Date.create().daysSince()             -> 0
   *
   ***
   * @method weeksSince([date])
   * @returns Number
   * @short Returns the number of weeks since [date].
   * @extra [date] will accept a date object, timestamp, or text format. See @date_format for more information. If not specified, [date] is assumed to be now.
   * @example
   *
   *   Date.create().weeksSince('1 month ago') -> weeks since 1 month ago
   *   Date.create().weeksSince()              -> 0
   *
   ***
   * @method monthsSince([date])
   * @returns Number
   * @short Returns the number of months since [date].
   * @extra [date] will accept a date object, timestamp, or text format. See @date_format for more information. If not specified, [date] is assumed to be now.
   * @example
   *
   *   Date.create().monthsSince('1 year ago') -> months since 1 year ago
   *   Date.create().monthsSince()             -> 0
   *
   ***
   * @method yearsSince([date])
   * @returns Number
   * @short Returns the number of years since [date].
   * @extra [date] will accept a date object, timestamp, or text format. See @date_format for more information. If not specified, [date] is assumed to be now.
   * @example
   *
   *   Date.create().yearsSince('5 years ago') -> years since 5 years ago
   *   Date.create().yearsSince()              -> 0
   *
   ***
   * @method millisecondsUntil([date])
   * @returns Number
   * @short Returns the number of milliseconds until [date].
   * @extra [date] will accept a date object, timestamp, or text format. See @date_format for more information. If not specified, [date] is assumed to be now.
   * @example
   *
   *   Date.create().millisecondsUntil('1 hour from now') -> Milliseconds until 1 hour from now
   *   Date.create().millisecondsUntil()                  -> 0
   *
   ***
   * @method secondsUntil([date])
   * @returns Number
   * @short Returns the number of seconds until [date].
   * @extra [date] will accept a date object, timestamp, or text format. See @date_format for more information. If not specified, [date] is assumed to be now.
   * @example
   *
   *   Date.create().secondsUntil('1 hour from now') -> Seconds until 1 hour from now
   *   Date.create().secondsUntil()                  -> 0
   *
   ***
   * @method minutesUntil([date])
   * @returns Number
   * @short Returns the number of minutes until [date].
   * @extra [date] will accept a date object, timestamp, or text format. See @date_format for more information. If not specified, [date] is assumed to be now.
   * @example
   *
   *   Date.create().minutesUntil('1 hour from now') -> minutes until 1 hour from now
   *   Date.create().minutesUntil()                  -> 0
   *
   ***
   * @method hoursUntil([date])
   * @returns Number
   * @short Returns the number of hours until [date].
   * @extra [date] will accept a date object, timestamp, or text format. See @date_format for more information. If not specified, [date] is assumed to be now.
   * @example
   *
   *   Date.create().hoursUntil('1 hour from now') -> hours until 1 hour from now
   *   Date.create().hoursUntil()                  -> 0
   *
   ***
   * @method daysUntil([date])
   * @returns Number
   * @short Returns the number of days until [date].
   * @extra [date] will accept a date object, timestamp, or text format. See @date_format for more information. If not specified, [date] is assumed to be now.
   * @example
   *
   *   Date.create().daysUntil('1 week from now') -> days until 1 week from now
   *   Date.create().daysUntil()                  -> 0
   *
   ***
   * @method weeksUntil([date])
   * @returns Number
   * @short Returns the number of weeks until [date].
   * @extra [date] will accept a date object, timestamp, or text format. See @date_format for more information. If not specified, [date] is assumed to be now.
   * @example
   *
   *   Date.create().weeksUntil('1 month from now') -> weeks until 1 month from now
   *   Date.create().weeksUntil()                   -> 0
   *
   ***
   * @method monthsUntil([date])
   * @returns Number
   * @short Returns the number of months until [date].
   * @extra [date] will accept a date object, timestamp, or text format. See @date_format for more information. If not specified, [date] is assumed to be now.
   * @example
   *
   *   Date.create().monthsUntil('1 year from now') -> months until 1 year from now
   *   Date.create().monthsUntil()                  -> 0
   *
   ***
   * @method yearsUntil([date])
   * @returns Number
   * @short Returns the number of years until [date].
   * @extra [date] will accept a date object, timestamp, or text format. See @date_format for more information. If not specified, [date] is assumed to be now.
   * @example
   *
   *   Date.create().yearsUntil('5 years from now') -> years until 5 years from now
   *   Date.create().yearsUntil()                   -> 0
   *
   ***
   ...
   * @method isLastWeek()
   * @returns Boolean
   * @short Returns true if the date is last week. False otherwise.
   * @example
   *
   ...
   * @method isThisWeek()
   * @returns Boolean
   * @short Returns true if the date is this week. False otherwise.
   * @example
   *
   ...
   * @method isNextWeek()
   * @returns Boolean
   * @short Returns true if the date is next week. False otherwise.
   * @example
   *
   ...
   * @method isLastMonth()
   * @returns Boolean
   * @short Returns true if the date is last month. False otherwise.
   * @example
   *
   ...
   * @method isThisMonth()
   * @returns Boolean
   * @short Returns true if the date is this month. False otherwise.
   * @example
   *
   ...
   * @method isNextMonth()
   * @returns Boolean
   * @short Returns true if the date is next month. False otherwise.
   * @example
   *
   ...
   * @method isLastYear()
   * @returns Boolean
   * @short Returns true if the date is last year. False otherwise.
   * @example
   *
   ...
   * @method isThisYear()
   * @returns Boolean
   * @short Returns true if the date is this year. False otherwise.
   * @example
   *
   ...
   * @method isNextYear()
   * @returns Boolean
   * @short Returns true if the date is next year. False otherwise.
   * @example
   *
   ...
   * @method isToday()
   * @returns Boolean
   * @short Returns true if the date is today. False otherwise.
   * @example
   *
   ...
   * @method isYesterday()
   * @returns Boolean
   * @short Returns true if the date is yesterday. False otherwise.
   * @example
   *
   ...
   * @method isTomorrow()
   * @returns Boolean
   * @short Returns true if the date is tomorrow. False otherwise.
   * @example
   *
   ...
   * @method isWeekday()
   * @returns Boolean
   * @short Returns true if the date is a weekday. False otherwise.
   * @example
   *
   ...
   * @method isWeekend()
   * @returns Boolean
   * @short Returns true if the date is a weekend. False otherwise.
   * @example
   *
   ...
   * @method isFuture()
   * @returns Boolean
   * @short Returns true if the date is in the future. False otherwise.
   * @example
   *
   ...
   * @method isPast()
   * @returns Boolean
   * @short Returns true if the date is in the past. False otherwise.
   * @example
   *
   *   Date.create('last week').isFuture() -> true
   *   Date.create('next week').isFuture() -> false
   *
   ***/
  ...
  extend(Date, true, {
     ...
     * @method isUTC()
     * @returns Boolean
     * @short Returns true if the date has no timezone offset. False otherwise.
     * @example
     *
     ...
     * @method isValid()
     * @returns Boolean
     * @short Returns true if the date is valid. False otherwise.
     * @example
     *
     ...
     * @returns Boolean
     * @short Returns true if the date is after the <d>. [margin] is to allow extra margin of error (in ms).
     * @extra <d> will accept a date object, timestamp, or text format (see @date_format for more information). If not specified, <d> is assumed to be now.
     * @example
     *
     ...
     * @returns Boolean
     * @short Returns true if the date is before <d>. [margin] is to allow extra margin of error (in ms).
     * @extra <d> will accept a date object, timestamp, or text format (see @date_format for more information). If not specified, <d> is assumed to be now.
     * @example
     *
     ...
     * @returns Boolean
     * @short Returns true if the date falls between <d1> and <d2>. [margin] is to allow extra margin of error (in ms).
     * @extra <d1> and <d2> will accept a date object, timestamp, or text format (see @date_format for more information). If not specified, they are assumed to be now.
     * @example
     *
     ...
     * @method isLeapYear()
     * @returns Boolean
     * @short Returns true if the date is a leap year. False otherwise.
     * @example
     *
    ...
    'daysInMonth': function(){
     ...
     /***
     * @method format(<format>, [utc])
     * @returns String
     * @short Formats the date for the given <format>. If [utc] is true, date will be formatted in UTC time.
     * @extra <format> will accept a number of tokens as well as pre-determined formats. See @date_format for more details.
     * @example
     *
    ...
    'format': function(str, utc){
      ...
      utc = (utc === true || str === Date.ISO8601_DATETIME) ? 'UTC' : '';
     ...
     * @method is(<d>, [margin])
     * @returns Boolean
     * @short Returns true if the date is <d>. [margin] is to allow extra margin of error (in ms).
     * @extra <d> will accept a date object, timestamp, or text format. If not specified, <d> is assumed to be now. %Is% additionally understands more generalized expressions like month/weekday names, 'today', etc. Dates will be compared to the precision implied in <d>. For more information, see @date_format.
     * @example
     *
  ...
  extend(Date, false, {
     ...
     * @returns Date
     * @short Alternate Date constructor which understands many more formats.
     * @extra <d> will accept a multitude of text formats, a timestamp, or another date. If not specified, <d> is assumed to be now. %Date.create% additionally can accept enumerated parameters as with the standard date constructor. For more information, see @date_format.
     * @example
     *
  ...
  extend(Function, true, {
     ...
     * @example
     *
     *   (function(){ return this; }).bind('woof')()     -> returns 'woof'; function is bound with 'woof' as the this object.
     *   (function(a){ return a; }).bind(1, 2)()         -> returns 2; function is bound with 1 as the this object and 2 curried as the first parameter
     *   (function(a, b){ return a + b; }).bind(1, 2)(3) -> returns 5; function is bound with 1 as the this object, 2 curied as the first parameter and 3 passed as the second when calling the function
     *
     ***/
    'bind': function(scope){
      var fn = this;

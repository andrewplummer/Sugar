...
(function(){
  ...
  // Alias
  extend(Number, true, {
      'ago': Number.prototype.before,
      'fromNow': Number.prototype.after
  });


  var timeAlias = function(type, multiplier){
    var baseFunc   = function(){ return this * multiplier; }
    var beforeFunc = function(time){ return this[type]().before(time); }
    var afterFunc  = function(time){ return this[type]().after(time); }
    Number.prototype[type] = baseFunc;
    Number.prototype[type + 's'] = baseFunc;
    Number.prototype[type + 'Ago'] = beforeFunc;
    Number.prototype[type + 'sAgo'] = beforeFunc;
    Number.prototype[type + 'Before'] = beforeFunc;
    Number.prototype[type + 'sBefore'] = beforeFunc;
    Number.prototype[type + 'After'] = afterFunc;
    Number.prototype[type + 'sAfter'] = afterFunc;
    Number.prototype[type + 'FromNow'] = afterFunc;
    Number.prototype[type + 'sFromNow'] = afterFunc;
  }
      ...
      if(match){
        ...
        if(m.modifier_unit && m.modifier_sign){
          ...
          if(m.modifier_unit === 'day'){
            ...
            amt *= 7;
            set.day = format.relative ? amt : d.getDate() + amt;
  ...
  var updateDate = function(date, params, reset, utc, advance){
    ...
    dateUnitsReversed.each(function(u){
      if(!u.method) return;
      var unit = u.unit;
      var value = getpoofvalue(params, unit, reset);
      if(value === undefined) return;
      if(advance){
        value = (value * advance) + callDateMethod(date, 'get', '', u.method);
      }
      callDateMethod(date, 'set', utc, u.method, value);
      return;
      var value  = params[u.unit];
      var method = m.method;
      if(advance && m.unit === 'day') method = 'date';
    ...
    if(!advance){
      var weekday = getpoofvalue(params, 'weekday', reset);
  ...
  var callDateMethod = function(d, g, utc, method, value,fu){
  ...
  extend(Date, true, {
    ...
    'is': function(find, buffer){
      ...
      if(Object.isDate(find)){
        ...
        dateUnits.each(function(u){
          if(p.set[u.unit] !== undefined && !accuracy){
  ...
  extend(Date, true, {
    ...
    'getUTCWeekday': Date.prototype.getDay,
    'setUTCWeekday': Date.prototype.setWeekday
  });
  ...
  var dateUnitsReversed = dateUnits.concat().reverse();

...
(function(){
  ...
  var buildObject = function(){
    ...
    hashInstanceAndObjectClassMethods.each(function(name, method){
      Hash.prototype[name] = method;
      Object[name] = function(obj){
        return method.apply(obj, Array.prototype.slice.call(arguments, 1));
      };
    });
  };
  ...
  extend(Object, false, {
     ...
     * @description This method is equivalent to the standard Object constructor (new Object()) but additionally returns an object with extended methods.
     * @example
     *
  ...
  var hashInstanceAndObjectClassMethods = new Hash({

    /***
     * @method keys([fn])
     * @returns Array
     * @description Returns an array containing the keys of this object. Optionally calls [fn] for each key.
     * @example
     *
     *   Object.create({ broken: 'wear' }).keys() -> ['broken']
     *   Object.create({ broken: 'wear' }).keys(function(key, value){
     *     // This function will be called once receiving the key as the first argument.
     *   });
     *
     ***/
    'keys': function(fn){
     ...
     * @method values([fn])
     * @returns Array
     * @description Returns an array containing the values of this object. Optionally calls [fn] for each value.
     * @example
     *
     *   Object.create({ broken: 'wear' }).values() -> ['wear']
     *   Object.create({ broken: 'wear' }).values(function(value){
     *     // This function will be called once receiving the value as the first argument.
     *   });
     *
     ***/
    'values': function(fn){
     ...
     * @method each(<fn>)
     * @returns nothing
     * @description Iterates over each property in the object.
     * @example
     *
     *   Object.create({ broken: 'wear' }).each(function(key, value){
     *     // This function will be called once receiving both the key and value as arguments.
     *   });
     *
     ***/
    'each': function(fn){
     ...
     * @description This method accepts an arbitrary number of objects as arguments and merges them all into the first.
     * @example
     *
     ...
     * @description This method creates a clone (copy) of the object passed in.
     * @example
     *
    ...
    /***
     * @method Object.empty(<obj>)
     * @returns Boolean
     * @description Returns true if the object is empty. False otherwise.
     * @example
     *
     *
     ***/
    'empty': function(){
      return deepEquals(this, {});
    },

    /***
     * @method Object.equals(<obj1>,<obj2>)
     * @returns Boolean
     * @description Returns true if the objects are equal. False otherwise.
     * @example
     *
     *
     ***/
    'equals': function(obj){
      return deepEquals(this, obj);
    }
  ...
  extend(Number, true, {
     ...
     * @method empty()
     * @returns Boolean
     * @description Always false for numbers. This method is for compatibility with other classes.
     * @example
     *
     *   (255).empty(); -> false
     *   (0).empty();   -> false
  ...
  extend(String, true, {
     ...
     * @method accent(<mark>)
     * @returns String
     * @description Applies an intuitive mapping of punctuation marks to create accented Latin characters. This method is expected to be called on a single character string.
     * @example
     *
     *   'o'.accent('-') -> 'ō';
     *   'e'.accent(':') -> 'ë';
    ...
    /***
     * @method startsWith(<find>, [caseSensitive])
     * @returns Boolean
    ...
    /***
     * @method endsWith(<find>, [caseSensitive])
     * @returns Boolean
     ...
     *
     *   'jumpy'.empty('py')         -> true;
     *   'jumpy'.empty(/[q-z]/)      -> true;
     *   'jumpy'.empty('MPY')        -> false;
     *   'jumpy'.empty('MPY', false) -> true;
     *
     ***/
    'empty': function(){

(function(){
  ...
  extend(String, true, {
    ...
    'escapeRegExp': function(){
     ...
     /***
      * @method escapeURL([all])
      * @returns String
      * @description Escapes all characters in the string that are not valid in a URL.
      * @defaults [all] = false
      * @example
      *
      *   'really'.escapeRegExp()       -> 'really\?'
      ...
      *
      ***/
    'escapeURL': function(full){
      return full ? encodeURIComponent(this) : encodeURI(this);
    },

    'unescapeURL': function(full){
      return full ? decodeURIComponent(this) : decodeURI(this);
    },

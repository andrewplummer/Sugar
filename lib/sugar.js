...
(function(){
  ...
  var dateFormats = [
    { reg: /^(\d{4})$/, to: ['year'] },
    { reg: /^(\d{1,2})[-\/.](\d{1,2})$/, to: ['month','day'] },
    { reg: /^(\d{2,4})-(\d{2})-(\d{2})$/, to: ['year','month','day'] },
    { reg: /^(\d{1,2})[-\/.](\d{1,2})[-\/.](\d{2,4})$/, to: ['month','day','year'] }
  ];
  ...
  var getDateFromString = function(str){
    ...
    var d = new Date();
    d.set(result, true);
    console.info(match, result, iso, d);
    if(!iso){

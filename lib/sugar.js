(function() {
  ...
  var setDelay = function(fn, wait, after, scope, args) {
  ...
  extend(Function, true, false, {
    ...
    'lazy': function(wait) {
      ...
      var run = 0;
      var lazy = function() {
        setDelay(lazy, Math.round(++run * wait), fn, this, arguments);
      }
      return lazy;
    },
     ...
     *
     ***/
    'debounce': function(wait, now) {
      var fn = this, before, after, lock;
      if(now) {
        before = function(){ fn.apply(this, arguments); lock = true; };
      ...
      return function() {
        ...
        setDelay(fn, wait, after, this, arguments);
      };
    },

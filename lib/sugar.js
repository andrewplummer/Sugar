...
(function(){
  ...
  var extendWithNativeReference = function(klass, extend){
    for(var name in extend){
      if(!extend.hasOwnProperty(name)) continue;
      (function(){
        var native   = klass.prototype[name];
        var extended = extend[name];
        klass.prototype[name] = function(){
          if(Object.isFunction(arguments[0]) && native){
  ...
  extendWithNativeReference(Array, {

    'every': function(f, scope){
      for(var i=0,len=this.length; i < len; i++){
        var match = multiMatch(this[i], f, i);
        if(!match){
          return false;
        }
      }

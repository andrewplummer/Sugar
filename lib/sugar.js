...
(function(){
  ...
  var extendWithNative = function(klass, nativeHandlesAll, extend){
    for(var name in extend){
      ...
      (function(){
        ...
        klass.prototype[name] = function(){
          if(original && (nativeHandlesAll || Object.isFunction(arguments[0]))){

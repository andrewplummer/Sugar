(function(){
  ...
  extend(Object, false, {
     ...
     * @example
     *
     *   Object.merge({ foo:'bar' }, { moe:'joe' }); -> { foo:'bar', moe:'joe'}
     *
     ***
     * @method merge(<obj1>, <obj2>, ...)
     * @returns Merged object
     * @description Accepts an arbitrary number of objects as arguments and merges them all into itself.
     * @example
     *
     *   Object.create({ foo:'bar' }).merge({ moe:'joe' }); -> { foo:'bar', moe:'joe'}
     *
     ***/
    'merge': function(){
     ...
     * @method clone()
     * @returns Cloned object
     * @description Creates a deep clone (copy) of the object.
     * @example
     *
     ...
     * @method equals(<obj>)
     * @returns Boolean
     * @description Returns true if <obj> is equal to the object. False otherwise.
     * @example
     *
  ...
  extendWithNativeCondition(Object, false, function(){ return arguments.length == 1; }, {
     ...
     * @method keys([fn])
     * @returns Array
     * @description Returns an array containing the keys in the object. Optionally calls [fn] for each key.
     * @example
     *
     ...
     * @method values([fn])
     * @returns Array
     * @description Returns an array containing the values in the object. Optionally calls [fn] for each value.
     * @example
     *
  ...
  extend(String, true, {
    ...
    'escapeRegExp': function(){
      ...
      * @example
      *
      *   'need to be escaped'.escapeURL()       -> 'need%20to%20be%20escaped'
      *   'http://twitter.com/'.escapeURL()      -> 'http://twitter.com'
      *   'http://twitter.com/'.escapeURL(true)  -> 'http%3A%2F%2Ftwitter.com%2F'
      *
      ***/
    'escapeURL': function(param){
     ...
     /***
      * @method unescapeURL([param] = false)
      * @returns String
      * @description Restores special characters in a URL escaped string. If [param] is true, it will also unescape valid URL characters for use as a URL param.
      * @example
      *
      *   'http%3A%2F%2Ftwitter.com%2F'.unescapeURL()     -> 'yes\.'
      *   'http%3A%2F%2Ftwitter.com%2F'.unescapeURL(true) -> 'yes\.'

      *
      ***/
    'unescapeURL': function(param){
      return param ? decodeURIComponent(this) : decodeURI(this);
    },

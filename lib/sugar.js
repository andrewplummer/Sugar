(function(){
  ...
  extend(Array, true, {
    /***
     * @method collect()
     * @description Alias for %Array#map%.
     *
     ***
     * @method shuffle()
     * @description Alias for %Array#randomize%.
     *
     ***
     * @method each()
     * @description Alias for %Array#forEach%.
     *
     ***
     * @method all()
     * @description Alias for %Array#every%.
     *
     ***
     * @method any()
     * @description Alias for %Array#some%.
     *
     ***
     * @method has()
     * @description Alias for %Array#some%.
     ...
     ***
     * @method add()
     * @description Alias for %Array#concat%.
     *
     ***/

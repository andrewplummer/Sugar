  ...
  var _lock     = privateGetterSetter('lock');
  var _timers   = privateGetterSetter('timers');
  var _partial  = privateGetterSetter('partial');
  var _canceled = privateGetterSetter('canceled');

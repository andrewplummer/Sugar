  ...
  function setupNamespace(i, name) {
    var isObject = name === 'Object', namespace;
    ...
    function wrapNamespace(name, fn) {
      setProperty(namespace, name, function(arg1, arg2, arg3) {
        fn(namespace, arg1, arg2, arg3);
      });
    }

    wrapNamespace('alias', alias);
    wrapNamespace('defineStatic', defineStatic);
    wrapNamespace('defineInstance', defineInstance);
    wrapNamespace('defineStaticWithArguments', defineStaticWithArguments);
    wrapNamespace('defineInstanceWithArguments', defineInstanceWithArguments);
  ...
  function collectMethods(instance, args) {
    return function(sugarNamespace, arg1, arg2, arg3) {
      var methods, flags;
      ...
      defineMethods(sugarNamespace, methods, instance, args, flags);
    }
  }

  var defineStatic                = collectMethods();
  var defineInstance              = collectMethods(true, false);
  var defineStaticWithArguments   = collectMethods(false, true);
  var defineInstanceWithArguments = collectMethods(true, true);
  ...
  function alias(namespace, name, source) {

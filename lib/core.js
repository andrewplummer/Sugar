...
function setupGlobal() {
  ...
  forEachProperty(NATIVE_NAMES.split(','), function(name, i) {
...
function mapObjectChainableToAllNamespaces(methodName, fn) {
  forEachProperty(namespacesByName, function(sugarNamespace, name) {
...
function mapNativeToChainable(name, methodNames) {
  ...
  forEachProperty(methodNames, function(methodName, i) {

...
// Property descriptors exist in IE8 but error when defining a property on native objects.
...
function createNamespace(name, isObject) {
  ...
  namespace = function(arg) {
    ...
    function canExtend(methodName, method) {
      return !objectRestricted() && !disallowedByFlags(method.flags) && !methodExcepted(methodName);
    }

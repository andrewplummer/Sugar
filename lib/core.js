...
// RegExp    - yes
// Function  - yes
// Number    - yes - TRICKY if (sugarNumber.add(5)) ...
// String    - yes - TRICKY if (sugarString.remove('foo')) ...
// Symbol    - yes
// null      - no
// undefined - no

// if (sugarObject.get(key)) prop is wrapped boolean...doesn't work
// if (sugarObject.get(key).raw) prop is unwrapped boolean... errors
// if (string.replaceAll('asdfas'))

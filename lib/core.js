  ...
  function isObject(obj) {
    ...
    return !!obj && isClass(obj, 'Object') && 'hasOwnProperty' in obj;
  }
  ...
  function objectIsMatchedByValue(obj) {
    return isString(obj) || isNumber(obj) || isBoolean(obj) || // Primitives
           isArray(obj)  || isDate(obj)   || isRegExp(obj)  || // Other
           isObject(obj);                                      // True objects (not host objects)
  }

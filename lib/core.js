  ...
  function setupGlobal() {
    ...
    setProperty(Sugar, 'toString', function() {
      return SUGAR_GLOBAL;
    });
  ...
  function setupNamespace(i, name) {
    ...
    function defineWithOptionCollect(methodName, instance, args) {
      setProperty(namespace, methodName, function(arg1, arg2, arg3) {
        ...
        defineMethods(namespace, opts.methods, instance, args, opts.flags);
      });
    }
    ...
    setProperty(namespace, 'toString', function() {
      // Print out something nicer than just a garbage function.
      return SUGAR_GLOBAL + name;
    });

    defineWithOptionCollect('defineStatic');
    defineWithOptionCollect('defineInstance', true);
    defineWithOptionCollect('defineStaticWithArguments', false, true);
    defineWithOptionCollect('defineInstanceWithArguments', true, true);
    ...
    setProperty(namespace, 'defineStaticPolyfill', function(arg1, arg2) {
      extendNative(globalContext[name], collectDefineOptions(arg1, arg2).methods, true);
    });

    setProperty(namespace, 'defineInstancePolyfill', function(arg1, arg2) {
      extendNative(globalContext[name].prototype, collectDefineOptions(arg1, arg2).methods, true);
    });

  }

  function setupUtil() {
    setProperty(Sugar, 'hasOwn', hasOwnProperty);

...
function mapNativeToChainable(name, names) {
  var sugarNamespace = namespacesByName[name],
      nativeProto = globalContext[name].prototype;

  if (!names && ownPropertyNames) {
    names = ownPropertyNames(nativeProto);
  }

  iterateOverObject(names, function(i, name) {
    if (name === 'constructor' || name === 'valueOf' || name === '__proto__') {

  ...
  function setupNamespace(i, namespace) {
    var native = globalContext[namespace],
        isObject = native === object;

    // Namespace method, i.e. Sugar.Array() or Sugar.Array.extend()
    function extend(arg) {
      var staticMethods = {}, instanceMethods = {}, allowObjectInstance, methodsByName;
      ...
      extendNative(native, staticMethods);
      extendNative(native.prototype, instanceMethods);
      if (!methodsByName) {

  ...
  extend(Array, {
     ...
     * @extra [scope] is the `this` object. `all` is provided an alias. In addition to providing this method for browsers that don't support it natively, this method also implements `enhanced matching`.
     * @example
     *
     ...
     * @extra [scope] is the `this` object. `any` is provided as an alias. In addition to providing this method for browsers that don't support it natively, this method also implements `enhanced matching`.
     * @example
     *
     ...
     * @extra [scope] is the `this` object. In addition to providing this method for browsers that don't support it natively, this method also implements `enhanced matching`.
     * @example
     *

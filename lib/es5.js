...
function buildNativeToChainableFallback() {
  ...
  // properties, so the only way to access native methods previous to ES5 is to
  // provide them as a list of tokens here.

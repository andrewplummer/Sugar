 ...
 * @package ES5
 * @namespace Object
 * @description Shim methods that provide ES5 compatible functionality. This package is excluded from default builds, and can be included if you need legacy browser support (IE8 and below).
 *
 ***/

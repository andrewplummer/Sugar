...
function buildInflector() {
  ...
  var plurals, singulars, uncountables, humans, acronyms;
  ...
  Inflector = {
    ...
    'humanize': function(str) {
      ...
      str = str.replace(/(_)?([a-z\d]*)/gi, function(match, _, word){
        ...
        acronym = hasOwn(Inflector.acronyms, lower) ? Inflector.acronyms[lower] : null;
...
defineInstance(sugarString, {
   ...
   * @extra If [num] is passed, the word will be singularized if equal to 1. Otherwise it will be pluralized. The %Inflector% object on %String% can be used to customize forms.
   * @example
   *
   ...
   *   String.Inflector.plural('platypus', 'platypuses');
   *
   ***/
   ...
   * @extra The %Inflector% object on %String% can be used to customize forms.
   * @example
   *
   ...
   *   String.Inflector.singular('platypuses', 'platypus');
   *
   ***/
   ...
   * @extra Capitalizes the first word and turns underscores into spaces and strips a trailing '_id', if any. Like String#titleize, this is meant for creating pretty output. The %Inflector% object on %String% can be used for custom cases.
   * @example
   *
   *   'employee_salary'.humanize() -> 'Employee salary'
   *   'author_id'.humanize()       -> 'Author'
   *   String.Inflector.human('_cnt', 'Count');
   *
   ***/
  'humanize': function(str) {
  ...
  'titleize': function(str) {
    ...
    var str = Inflector.humanize(spacify(str));

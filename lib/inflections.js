...
defineInstance(sugarString, {
   ...
   *        Otherwise it will be pluralized. The `Inflector` object on `String`
   *        can be used to customize forms.
   *
   * @example
   *
   ...
   *        for creating pretty output. The `Inflector` object on `String` can
   *        be used for custom cases.
   *
   * @example
   *

xpackage('Date | Norwegian', function () {
  ...
  method('create', function() {
    ...
    dateEqual(testCreateDate('den 15 maj 2011'), new Date(2011, 4, 15), 'basic Norwegian date');
    dateEqual(testCreateDate('15 maj 2011'), new Date(2011, 4, 15), 'basic Norwegian date');
    ...
    dateEqual(testCreateDate('15 maj 2011 3:45'), new Date(2011, 4, 15, 3, 45), 'basic Norwegian date 3:45');
    dateEqual(testCreateDate('15 maj 2011 3:45pm'), new Date(2011, 4, 15, 15, 45), 'basic Norwegian date 3:45pm');

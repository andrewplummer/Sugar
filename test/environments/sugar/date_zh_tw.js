test('Dates | Traditional Chinese', function () {
  ...
  dateEqual(Date.create('星期天'), getDateWithWeekdayAndOffset(0), 'Date#create | Traditional Chinese | Sunday');
  ...
  dateEqual(Date.create('大前天'), getRelativeDate(null, null, -3).reset(), 'Date#create | Traditional Chinese | day before day before yesterday');
  dateEqual(Date.create('前天'), getRelativeDate(null, null, -2).reset(), 'Date#create | Traditional Chinese | day before yesterday');
  ...
  dateEqual(Date.create('後天'), getRelativeDate(null, null, 2).reset(), 'Date#create | Traditional Chinese | day after tomorrow');
  dateEqual(Date.create('大後天'), getRelativeDate(null, null, 3).reset(), 'Date#create | Traditional Chinese | day after day after tomorrow');

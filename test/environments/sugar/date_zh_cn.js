package('Date | Simplified Chinese', function () {
  ...
  method('relative', function() {
    ...
    test(testCreateDate('1 month from now', 'en'),  '1个月后');
    test(testCreateDate('1 year from now', 'en'),   '1年后');

    test(testCreateDate('5 second from now', 'en'), '5秒钟后');
    test(testCreateDate('5 minute from now', 'en'), '5分钟后');
    test(testCreateDate('5 hour from now', 'en'),   '5小时后');
    test(testCreateDate('5 day from now', 'en'),    '5天后');
    test(testCreateDate('5 week from now', 'en'),   '1个月后');
    test(testCreateDate('5 month from now', 'en'),  '5个月后');
    test(testCreateDate('5 year from now', 'en'),   '5年后');
  });

test('Date Ranges', function () {
  ...
  range1 = Date.range(getDate('2001'), getDate('2003'));
  range2 = Date.range(getDate('2002'), getDate('2004'));

  range = range1.union(range2);

  dateRangeEqual(range, Date.range(getDate('2001'), getDate('2004')), 'Date Range#union | simple merge');
  dateRangeEqual(range1, Date.range(getDate('2001'), getDate('2003')), 'Date Range#union | range1 has not changed');
  dateRangeEqual(range2, Date.range(getDate('2002'), getDate('2004')), 'Date Range#union | range2 has not changed');
  ...
  range1 = Date.range(getDate('2001'), getDate('2003'));
  range2 = Date.range(getDate('2005'), getDate('2008'));

  range = range1.union(range2);

  dateRangeEqual(range, Date.range(getDate('2001'), getDate('2008')), 'Date Range#union | non-overlapping includes middle');
  dateRangeEqual(range1, Date.range(getDate('2001'), getDate('2003')), 'Date Range#union | range1 has not changed');
  dateRangeEqual(range2, Date.range(getDate('2005'), getDate('2008')), 'Date Range#union | range2 has not changed');


  // Union of reversed overlapping ranges

  range1 = Date.range(getDate('2002'), getDate('2004'));
  range2 = Date.range(getDate('2001'), getDate('2003'));

  range = range1.union(range2);

  dateRangeEqual(range, Date.range(getDate('2001'), getDate('2004')), 'Date Range#union | reversed | simple merge');


  // Union of reversed non-overlapping ranges

  range1 = Date.range(getDate('2005'), getDate('2008'));
  range2 = Date.range(getDate('2001'), getDate('2003'));

  range = range1.union(range2);

  dateRangeEqual(range, Date.range(getDate('2001'), getDate('2008')), 'Date Range#union | reversed | includes middle');
  ...
  dateRangeEqual(range, Date.range(getDate('2002'), getDate('2003')), 'Date Range#intersect | simple merge');
  dateRangeEqual(range1, Date.range(getDate('2001'), getDate('2003')), 'Date Range#intersect | range1 has not changed');
  dateRangeEqual(range2, Date.range(getDate('2002'), getDate('2004')), 'Date Range#intersect | range2 has not changed');
  ...
  var testStart = Date.create ? Date.create('2001') : new Date('2001');
  var testEnd   = Date.create ? Date.create('2003') : new Date('2003');
  ...
  if(Date.create) {
    var range = Date.range('monday to thursday');

    equal(Date.range('monday to thursday'), Date.range('monday', 'thursday'), 'Date Range | advanced text ranges');
    equal(Date.range('from monday to thursday'), Date.range('monday', 'thursday'), 'Date Range | advanced text ranges | from');
    equal(Date.range('from monday until thursday'), Date.range('monday', 'thursday'), 'Date Range | advanced text ranges | from..until');
    equal(Date.range('tomorrow at 3pm for 30 minutes'), Date.range('3pm tomorrow', '3:30pm tomorrow'), 'Date Range | advanced text ranges | for');
    equal(Date.range('1 hour starting at 3:15 monday'), Date.range('3:15 monday', '4:15 monday'), 'Date Range | advanced text ranges | starting at');
    equal(Date.range('for 1 hour starting at 3:15 monday'), Date.range('3:15 monday', '4:15 monday'), 'Date Range | advanced text ranges | for..starting at');
    equal(Date.range('foobar'), Date.range(), 'Date Range | invalid string is the same as no arguments');
  }

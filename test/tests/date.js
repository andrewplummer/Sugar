namespace('Date', function () {
  ...
  group('Create | Options', function() {
    ...
    // Issue #582 "now" is failing with fromUTC.
    var d1 = new Date();
    var d2 = testCreateDate('now', { fromUTC: true });
    equal(d1, d2, 'fromUTC flag with "now" should do nothing as they are the same moment');

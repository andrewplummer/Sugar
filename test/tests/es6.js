package('ES6', function () {
  ...
  method('find', function() {
    ...
    equal(visited, ['a', undefined, 'b'], 'Array#find | should visit undefined indexes');
  ...
  method('findIndex', function() {
    ...
    equal(visited, ['a', undefined, 'b'], 'Array#findIndex | should visit undefined indexes');
  ...
  method('Array.from', function() {
    ...
    equal(Array.from([undefined]), [undefined], 'in array | undefined');

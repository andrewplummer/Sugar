...
(function(){
  ...
  test('Element.getSize', function() {

    equal(div.getSize().x, 108, 'should measure the width and height of the element');
    equal(div.getSize().y, 108, 'should measure the width and height of the element');

  });

  test('Element.getPosition', function() {

    same(div.getPosition(), {x: 102, y: 102}, 'should measure the x and y position of the element');

  });

  test('Element.getCoordinates', function() {

    same(absDiv.getCoordinates(relDiv), {left:16, top:16, width:22, height:22, right:38, bottom:38}, 'should return the coordinates relative to parent');

  });

  test('Element.getScrollSize', function() {

    same(scrollDiv.getScrollSize(), {x:200, y:200}, 'should return the scrollSize');

  });

  test('Element.scrollTo', function() {

    same(scrollDiv.scrollTo(20,20).getScroll(), {x:20, y:20}, 'should scroll the element');

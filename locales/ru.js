...
Sugar.Date.addLocale('ru', {
  ...
  'months': 'янв:аря||арь,фев:раля|р|раль,март:а|,апр:еля||ель,мая|май,июня|июнь,июля|июль,авг:уста||уст,сен:тября|т|тябрь,окт:ября||ябрь,ноя:бря||брь,дек:абря||абрь',

...
defineInstance('isArray', methods.isArray);
defineInstance('isBoolean', methods.isBoolean);
defineInstance('isDate', methods.isDate);
defineInstance('isEmpty', methods.isEmpty);
defineInstance('isEqual', methods.isEqual);
defineInstance('isFunction', methods.isFunction);
defineInstance('isMap', methods.isMap);
defineInstance('isNumber', methods.isNumber);
defineInstance('isPlainObject', methods.isPlainObject);
defineInstance('isPrimitive', methods.isPrimitive);
defineInstance('isObject', methods.isObject);
defineInstance('isRegExp', methods.isRegExp);
defineInstance('isSet', methods.isSet);
defineInstance('isString', methods.isString);
defineInstance('isTypedArray', methods.isTypedArray);

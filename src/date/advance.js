...
/**
 * Advances the date by specific units or a timestamp.
 *
 * @extra This method will modify the date!
 *
 * @param {Date} date - The date.
 * @param {DateProps|number|string} props - The units to advance. May be a
 *   number in which case the date will be advanced using `setTime`. A string

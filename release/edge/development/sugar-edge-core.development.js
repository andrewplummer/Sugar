  ...
  extend(array, true, false, {
    ...
    'sample': function(num) {
      ...
      return arguments.length > 0 ? result : result[0];
		...
		/***
     * @method punctuate([fn(<n>)], [conjunction] = true [useOnly] = true)
     * @returns String
     ...
     *   ['a', 2, {c:3}].punctuate()					 		-> 'a, 2 and [object Object]';
		 ...
		 *   	return n.repeat(2);
		 *	 })
		 * 	 ['a', 'b', 'c'].punctuate(false, 'et')		-> 'a, b, et c';
		 *	 ['a'].punctuate(false, false, false)			-> 'a';
     *
     ***/
		'punctuate': function(handler, conjunction, useOnly) {
		  var sentence = "";

...
F(Function,k,m,{bind:function(a){var b=this,c=G(arguments).slice(1),d,e;if(!A(this))throw new TypeError("Function.prototype.bind called on a non-function");e=function(){return b.apply(b.prototype&&this instanceof b?this:a,c.concat(G(arguments)))};d=function(){};d.prototype=this.prototype;e.prototype=new d;return e}});F(s,m,m,{now:function(){return(new s).getTime()}});

 ...
 *
 * ---------------------------- */
(function(){var k=true,l=null,m=false;function ca(a){return function(){return a}}var o=Object,p=Array,q=RegExp,s=Date,t=String,u=Number,v=Math,da=typeof global!=="undefined"?global:this,ea=o.defineProperty&&o.defineProperties,w="Array,Boolean,Date,Function,Number,String,RegExp".split(","),fa=x(w[0]),ga=x(w[1]),ha=x(w[2]),A=x(w[3]),B=x(w[4]),D=x(w[5]),E=x(w[6]);function x(a){return function(b){return ia(b,a)}}function ia(a,b){return o.prototype.toString.call(a)==="[object "+b+"]"}
function ja(a){if(!a.SugarMethods){ka(a,"SugarMethods",{});F(a,m,m,{restore:function(){var b=arguments.length===0,c=G(arguments);H(a.SugarMethods,function(d,e){if(b||c.indexOf(d)>-1)ka(e.za?a.prototype:a,d,e.method)})},extend:function(b,c,d){F(a,d!==m,c,b)}})}}function F(a,b,c,d){var e=b?a.prototype:a,f;ja(a);H(d,function(g,i){f=e[g];if(typeof c==="function")i=la(e[g],i,c);if(c!==m||!e[g])ka(e,g,i);a.SugarMethods[g]={za:b,method:i,Ia:f}})}
function I(a,b,c,d,e){var f={};d=D(d)?d.split(","):d;d.forEach(function(g,i){e(f,g,i)});F(a,b,c,f)}function la(a,b,c){return function(){return a&&(c===k||!c.apply(this,arguments))?a.apply(this,arguments):b.apply(this,arguments)}}function ka(a,b,c){if(ea)o.defineProperty(a,b,{value:c,configurable:k,enumerable:m,writable:k});else a[b]=c}function G(a,b){var c=[],d=0;for(d=0;d<a.length;d++){c.push(a[d]);b&&b.call(a,a[d],d)}return c}function J(a){return a!==void 0}function K(a){return a===void 0}
function ma(a){return a&&typeof a==="object"}function na(a){return!!a&&ia(a,"Object")&&t(a.constructor)===t(o)}function oa(a,b){return o.hasOwnProperty.call(a,b)}function H(a,b){for(var c in a)if(oa(a,c))if(b.call(a,c,a[c])===m)break}function pa(a,b){H(b,function(c){a[c]=b[c]});return a}function L(a){pa(this,a)}L.prototype.constructor=o;function M(a,b,c,d){var e=[];a=parseInt(a);for(var f=d<0;!f&&a<=b||f&&a>=b;){e.push(a);c&&c.call(this,a);a+=d||1}return e}
function N(a,b,c){c=v[c||"round"];var d=v.pow(10,v.abs(b||0));if(b<0)d=1/d;return c(a*d)/d}function O(a,b){return N(a,b,"floor")}function P(a,b,c,d){d=v.abs(a).toString(d||10);d=qa(b-d.replace(/\.\d+/,"").length,"0")+d;if(c||a<0)d=(a<0?"-":"+")+d;return d}function ra(a){if(a>=11&&a<=13)return"th";else switch(a%10){case 1:return"st";case 2:return"nd";case 3:return"rd";default:return"th"}}
function sa(){return"\t\n\u000b\u000c\r \u00a0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u2028\u2029\u3000\ufeff"}function qa(a,b){return p(v.max(0,J(a)?a:1)+1).join(b||"")}function ta(a,b){var c=a.toString().match(/[^/]*$/)[0];if(b)c=(c+b).split("").sort().join("").replace(/([gimy])\1+/g,"$1");return c}function R(a){D(a)||(a=t(a));return a.replace(/([\\/'*+?|()\[\]{}.^$])/g,"\\$1")}
function S(a,b){var c,d,e,f,g,i,j=typeof a;if(j==="string")return a;d=o.prototype.toString.call(a);c=d==="[object Object]";e=d==="[object Array]";if(a!=l&&c||e){b||(b=[]);if(b.length>1)for(g=b.length;g--;)if(b[g]===a)return"CYC";b.push(a);c=t(a.constructor);f=e?a:o.keys(a).sort();for(g=0;g<f.length;g++){i=e?g:f[g];c+=i+S(a[i],b)}b.pop()}else c=1/a===-Infinity?"-0":t(a&&a.valueOf());return j+d+c}
function ua(a,b,c){var d=[],e=a.length,f=b[b.length-1]!==m,g;G(b,function(i){if(ga(i))return m;if(f){i%=e;if(i<0)i=e+i}g=c?a.charAt(i)||"":a[i];d.push(g)});return d.length<2?d[0]:d}function va(a,b){I(b,k,m,a,function(c,d){c[d+(d==="equal"?"s":"")]=function(){return o[d].apply(l,[this].concat(G(arguments)))}})}ja(o);H(w,function(a,b){ja(da[b])});
F(o,m,m,{keys:function(a){var b=[];if(!ma(a)&&!E(a)&&!A(a))throw new TypeError("Object required");H(a,function(c){b.push(c)});return b}});function wa(a,b,c,d){var e=a.length,f=d==-1,g=f?e-1:0;c=isNaN(c)?g:parseInt(c>>0);if(c<0)c=e+c;if(!f&&c<0||f&&c>=e)c=g;for(;f&&c>=0||!f&&c<e;){if(a[c]===b)return c;c+=d}return-1}
function xa(a,b,c,d){var e=a.length,f=0,g=J(c);ya(b);if(e==0&&!g)throw new TypeError("Reduce called on empty array with no initial value");else if(g)c=c;else{c=a[d?e-1:f];f++}for(;f<e;){g=d?e-f-1:f;if(g in a)c=b(c,a[g],g,a);f++}return c}function ya(a){if(!a||!a.call)throw new TypeError("Callback is not callable");}function za(a){if(a.length===0)throw new TypeError("First argument must be defined");}F(p,m,m,{isArray:function(a){return ia(a,"Array")}});
...
(function(){var a=sa().match(/^\s+$/);try{t.prototype.trim.call([1])}catch(b){a=m}F(t,k,!a,{trim:function(){return this.toString().trimLeft().trimRight()},trimLeft:function(){return this.replace(q("^["+sa()+"]+"),"")},trimRight:function(){return this.replace(q("["+sa()+"]+$"),"")}})})();
(function(){var a=m;if(Function.prototype.ta){a=function(){};var b=a.ta();a=new b instanceof b&&!(new a instanceof b)}F(Function,k,!a,{bind:function(c){var d=this,e=G(arguments).slice(1),f,g;if(!A(this))throw new TypeError("Function.prototype.bind called on a non-function");g=function(){return d.apply(d.prototype&&this instanceof d?this:c,e.concat(G(arguments)))};f=function(){};f.prototype=this.prototype;g.prototype=new f;return g}})})();
...
function Aa(a,b,c,d){var e=k;if(a===b)return k;else if(E(b)&&D(a))return q(b).test(a);else if(A(b))return b.apply(c,d);else if(na(b)&&ma(a)){H(b,function(f){Aa(a[f],b[f],c,[a[f],a])||(e=m)});return e}else return S(a)===S(b)}function T(a,b,c,d){return K(b)?a:A(b)?b.apply(c,d||[]):A(a[b])?a[b].call(a):a[b]}function U(a,b,c,d){var e,f;if(c<0)c=a.length+c;f=isNaN(c)?0:c;for(c=d===k?a.length+f:a.length;f<c;){e=f%a.length;if(e in a){if(b.call(a,a[e],e,a)===m)break}else return Ba(a,b,f,d);f++}}
function Ba(a,b,c){var d=[],e;for(e in a)e in a&&e>>>0==e&&e!=4294967295&&e>=c&&d.push(parseInt(e));d.sort().each(function(f){return b.call(a,a[f],f,a)});return a}function Ca(a,b,c,d,e){var f,g;U(a,function(i,j,h){if(Aa(i,b,h,[i,j,h])){f=i;g=j;return m}},c,d);return e?g:f}function Ea(a,b){var c=[],d={},e;U(a,function(f,g){e=b?T(f,b,a,[f,g,a]):f;Fa(d,e)||c.push(f)});return c}
function Ga(a,b,c){var d=[],e={};b.each(function(f){Fa(e,f)});a.each(function(f){var g=S(f),i=A(f);if(Ha(e,g,f,i)!=c){var j=0;if(i)for(g=e[g];j<g.length;)if(g[j]===f)g.splice(j,1);else j+=1;else delete e[g];d.push(f)}});return d}function Ia(a,b,c){b=b||Infinity;c=c||0;var d=[];U(a,function(e){if(fa(e)&&c<b)d=d.concat(Ia(e,b,c+1));else d.push(e)});return d}function Ja(a){var b=[];G(a,function(c){b=b.concat(c)});return b}
function Ha(a,b,c,d){var e=b in a;if(d){a[b]||(a[b]=[]);e=a[b].indexOf(c)!==-1}return e}function Fa(a,b){var c=S(b),d=A(b),e=Ha(a,c,b,d);if(d)a[c].push(b);else a[c]=b;return e}function Ka(a,b,c,d){var e,f=[],g=c==="max",i=c==="min",j=Array.isArray(a);H(a,function(h){var n=a[h];h=T(n,b,a,j?[n,parseInt(h),a]:[]);if(h===e)f.push(n);else if(K(e)||g&&h>e||i&&h<e){f=[n];e=h}});j||(f=Ia(f,1));return d?f:f[0]}function La(a){if(p[Ma])a=a.toLowerCase();return a.replace(p[Na],"")}
function Oa(a,b){var c=a.charAt(b);return(p[Pa]||{})[c]||c}function Qa(a){var b=p[Ra];return a?b.indexOf(a):l}var Ra="AlphanumericSortOrder",Na="AlphanumericSortIgnore",Ma="AlphanumericSortIgnoreCase",Pa="AlphanumericSortEquivalents";F(p,m,m,{create:function(){var a=[];G(arguments,function(b){if(ma(b))a=a.concat(p.prototype.slice.call(b));else a.push(b)});return a}});
...
a.sum()/a.length:0},inGroups:function(a,b){var c=arguments.length>1,d=this,e=[],f=N(this.length/a,void 0,"ceil");M(0,a-1,function(g){g=g*f;var i=d.slice(g,g+f);c&&i.length<f&&M(1,f-i.length,function(){i=i.add(b)});e.push(i)});return e},inGroupsOf:function(a,b){var c=[],d=this.length,e=this,f;if(d===0||a===0)return e;if(K(a))a=1;if(K(b))b=l;M(0,N(d/a,void 0,"ceil")-1,function(g){for(f=e.slice(a*g,a*g+a);f.length<a;)f.push(b);c.push(f)});return c},isEmpty:function(){return this.compact().length==0},
sortBy:function(a,b){var c=this.clone();c.sort(function(d,e){var f,g;f=T(d,a,c,[d]);g=T(e,a,c,[e]);if(D(f)&&D(g)){f=f;g=g;var i,j,h,n,r=0,y=0;f=La(f);g=La(g);do{h=Oa(f,r);n=Oa(g,r);i=Qa(h);j=Qa(n);if(i===-1||j===-1){i=f.charCodeAt(r)||l;j=g.charCodeAt(r)||l}h=h!==f.charAt(r);n=n!==g.charAt(r);if(h!==n&&y===0)y=h-n;r+=1}while(i!=l&&j!=l&&i===j);f=i===j?y:i<j?-1:1}else f=f<g?-1:f>g?1:0;return f*(b?-1:1)});return c},randomize:function(){for(var a=this.concat(),b,c,d=a.length;d;b=parseInt(v.random()*
d),c=a[--d],a[d]=a[b],a[b]=c);return a},zip:function(){var a=G(arguments);return this.map(function(b,c){return[b].concat(a.map(function(d){return c in d?d[c]:l}))})},sample:function(a){var b=[],c=this.clone(),d;if(K(a))a=1;for(;b.length<a;){d=O(v.random()*(c.length-1));b.push(c[d]);c.removeAt(d);if(c.length==0)break}return arguments.length>0?b:b[0]},each:function(a,b,c){U(this,a,b,c);return this},add:function(a,b){if(!B(u(b))||isNaN(b))b=this.length;p.prototype.splice.apply(this,[b,0].concat(a));
...
function(b){var c=b.charAt(0);U(b.slice(1).split(""),function(d){a[d]=c;a[d.toLowerCase()]=c.toLowerCase()})});p[Ma]=k;p[Pa]=a})();Ta("each,any,all,none,count,find,findAll,isEmpty");Ta("sum,average,min,max,least,most",k);va("map,reduce,size",L);
var V,Ua,Va=["ampm","hour","minute","second","ampm","utc","offset_sign","offset_hours","offset_minutes","ampm"],Wa="({t})?\\s*(\\d{1,2}(?:[,.]\\d+)?)(?:{h}(\\d{1,2}(?:[,.]\\d+)?)?{m}(?::?(\\d{1,2}(?:[,.]\\d+)?){s})?\\s*(?:({t})|(Z)|(?:([+-])(\\d{2,2})(?::?(\\d{2,2}))?)?)?|\\s*({t}))",Xa={},Ya,Za,W,$a=[],ab=[{ba:"f{1,4}|ms|milliseconds",format:function(a){return X(a,"Milliseconds")}},{ba:"ss?|seconds",format:function(a){return X(a,"Seconds")}},{ba:"mm?|minutes",format:function(a){return X(a,"Minutes")}},
{ba:"hh?|hours|12hr",format:function(a){a=X(a,"Hours");return a===0?12:a-O(a/13)*12}},{ba:"HH?|24hr",format:function(a){return X(a,"Hours")}},{ba:"dd?|date|day",format:function(a){return X(a,"Date")}},{ba:"dow|weekday",oa:k,format:function(a,b,c){a=X(a,"Day");return b.weekdays[a+(c-1)*7]}},{ba:"MM?",format:function(a){return X(a,"Month")+1}},{ba:"mon|month",oa:k,format:function(a,b,c){a=X(a,"Month");return b.months[a+(c-1)*12]}},{ba:"y{2,4}|year",format:function(a){return X(a,"FullYear")}},{ba:"[Tt]{1,2}",
format:function(a,b,c,d){a=X(a,"Hours");b=b.ampm[O(a/12)];if(d.length===1)b=b.slice(0,1);if(d.slice(0,1)==="T")b=b.toUpperCase();return b}},{ba:"z{1,4}|tz|timezone",text:k,format:function(a,b,c,d){a=a.getUTCOffset();if(d=="z"||d=="zz")a=a.replace(/(\d{2})(\d{2})/,function(e,f){return P(f,d.length)});return a}},{ba:"iso(tz|timezone)",format:function(a){return a.getUTCOffset(k)}},{ba:"ord",format:function(a){a=X(a,"Date");return a+ra(a)}}],bb=[{$:"year",method:"FullYear",ka:k,da:function(a){return(365+
(a?a.isLeapYear()?1:0:0.25))*24*60*60*1E3}},{$:"month",method:"Month",ka:k,da:function(a,b){var c=30.4375,d;if(a){d=a.daysInMonth();if(b<=d.days())c=d}return c*24*60*60*1E3}},{$:"week",method:"Week",da:ca(6048E5)},{$:"day",method:"Date",ka:k,da:ca(864E5)},{$:"hour",method:"Hours",da:ca(36E5)},{$:"minute",method:"Minutes",da:ca(6E4)},{$:"second",method:"Seconds",da:ca(1E3)},{$:"millisecond",method:"Milliseconds",da:ca(1)}],cb={};function db(a){pa(this,a);this.ha=$a.concat()}
db.prototype={getMonth:function(a){return B(a)?a-1:this.months.indexOf(a)%12},la:function(a){return this.weekdays.indexOf(a)%7},ra:function(a){var b;return B(a)?a:a&&(b=this.numbers.indexOf(a))!==-1?(b+1)%10:1},xa:function(a){var b=this;return a.replace(q(this.num,"g"),function(c){return b.ra(c)||""})},va:function(a){return V.units[this.units.indexOf(a)%8]},Ea:function(a){return this.qa(a,a[2]>0?"future":"past")},ua:function(a){return this.qa(eb(a),"duration")},ya:function(a){a=a||this.code;return a===
"en"||a==="en-US"?k:this.variant},Ba:function(a){return a===this.ampm[0]},Ca:function(a){return a===this.ampm[1]},qa:function(a,b){var c=a[0],d=a[1],e=a[2],f,g,i;if(this.code=="ru"){i=c.toString().slice(-1);switch(k){case i==1:i=1;break;case i>=2&&i<=4:i=2;break;default:i=3}}else i=this.plural&&c>1?1:0;g=this.units[i*8+d]||this.units[d];if(this.capitalizeUnit)g=fb(g);f=this.modifiers.filter(function(j){return j.name=="sign"&&j.value==(e>0?1:-1)})[0];return this[b].replace(/\{(.*?)\}/g,function(j,
h){switch(h){case "num":return c;case "unit":return g;case "sign":return f.src}})},wa:function(){return this.pa?[this.pa].concat(this.ha):this.ha},addFormat:function(a,b,c,d,e){var f=c||[],g=this,i;a=a.replace(/\s+/g,"[-,. ]*");a=a.replace(/\{([^,]+?)\}/g,function(j,h){var n=h.match(/\?$/),r=h.match(/(\d)(?:-(\d))?/),y=h.match(/^\d+$/),z=h.replace(/[^a-z]+$/,""),C,aa;if(y)C=g.optionals[y[0]];else if(g[z])C=g[z];else if(g[z+"s"]){C=g[z+"s"];if(r){aa=[];C.forEach(function(ba,Da){var Q=Da%(g.units?8:
C.length);if(Q>=r[1]&&Q<=(r[2]||r[1]))aa.push(ba)});C=aa}C=gb(C)}if(y)return"(?:"+C+")?";else{c||f.push(z);return"("+C+")"+(n?"?":"")}});if(b){b=hb(Wa,g,e);e=["t","[\\s\\u3000]"].concat(g.timeMarker);i=a.match(/\\d\{\d,\d\}\)+\??$/);ib(g,"(?:"+b+")[,\\s\\u3000]+?"+a,Va.concat(f),d);ib(g,a+"(?:[,\\s]*(?:"+e.join("|")+(i?"+":"*")+")"+b+")?",f.concat(Va),d)}else ib(g,a,f,d)}};function jb(a,b){var c;D(a)||(a="");c=cb[a]||cb[a.slice(0,2)];if(b===m&&!c)throw Error("Invalid locale.");return c||Ua}
function kb(a,b){function c(j){var h=g[j];if(D(h))g[j]=h.split(",");else h||(g[j]=[])}function d(j,h){j=j.split("+").map(function(n){return n.replace(/(.+):(.+)$/,function(r,y,z){return z.split("|").map(function(C){return y+C}).join("|")})}).join("|");return j.split("|").forEach(h)}function e(j,h,n){var r=[];g[j].forEach(function(y,z){if(h)y+="+"+y.slice(0,3);d(y,function(C,aa){r[aa*n+z]=C.toLowerCase()})});g[j]=r}function f(j,h,n){j="\\d{"+j+","+h+"}";if(n)j+="|(?:"+gb(g.numbers)+")+";return j}var g,
i;g=new db(b);c("modifiers");"months,weekdays,units,numbers,articles,optionals,timeMarker,ampm,timeSuffixes,dateParse,timeParse".split(",").forEach(c);i=!g.monthSuffix;e("months",i,12);e("weekdays",i,7);e("units",m,8);e("numbers",m,10);g.code=a;g.date=f(1,2,g.digitDate);g.year=f(4,4);g.num=function(){var j=["\\d+"].concat(g.articles);if(g.numbers)j=j.concat(g.numbers);return gb(j)}();(function(){var j=[];g.ia={};g.modifiers.forEach(function(h){var n=h.name;d(h.src,function(r){var y=g[n];g.ia[r]=h;
j.push({name:n,src:r,value:h.value});g[n]=y?y+"|"+r:r})});g.day+="|"+gb(g.weekdays);g.modifiers=j})();if(g.monthSuffix){g.month=f(1,2);g.months=M(1,12).map(function(j){return j+g.monthSuffix})}g.full_month=f(1,2)+"|"+gb(g.months);g.timeSuffixes.length>0&&g.addFormat(hb(Wa,g),m,Va);g.addFormat("{day}",k);g.addFormat("{month}"+(g.monthSuffix||""));g.addFormat("{year}"+(g.yearSuffix||""));g.timeParse.forEach(function(j){g.addFormat(j,k)});g.dateParse.forEach(function(j){g.addFormat(j)});return cb[a]=
g}function ib(a,b,c,d){a.ha.unshift({Ga:d,Aa:a,Da:q("^"+b+"$","i"),to:c})}function fb(a){return a.slice(0,1).toUpperCase()+a.slice(1)}function gb(a){return a.filter(function(b){return!!b}).join("|")}function lb(a,b){var c;if(na(a[0]))return a;else if(B(a[0])&&!B(a[1]))return[a[0]];else if(D(a[0])&&b)return[mb(a[0]),a[1]];c={};Za.forEach(function(d,e){c[d.$]=a[e]});return[c]}
function mb(a,b){var c={};match=a.match(/^(\d+)?\s?(\w+?)s?$/i);if(K(b))b=parseInt(match[1])||1;c[match[2].toLowerCase()]=b;return c}function nb(a,b){var c={},d,e;b.forEach(function(f,g){d=a[g+1];if(!(K(d)||d==="")){if(f==="year")c.Ha=d;e=parseFloat(d.replace(/,/,"."));c[f]=!isNaN(e)?e:d.toLowerCase()}});return c}function ob(a){a=a.trim().replace(/^(just )?now|\.+$/i,"");return pb(a)}
function pb(a){return a.replace(Ya,function(b,c,d){var e=0,f=1,g,i;if(c)return b;d.split("").reverse().forEach(function(j){j=Xa[j];var h=j>9;if(h){if(g)e+=f;f*=j/(i||1);i=j}else{if(g===m)f*=10;e+=f*j}g=h});if(g)e+=f;return e})}
function qb(a,b,c,d){var e=new s,f=m,g,i,j,h,n,r,y,z,C;d&&e.na();if(ha(a))e=a.clone();else if(B(a))e=new s(a);else if(na(a)){e.set(a,k);h=a}else if(D(a)){g=jb(b);a=ob(a);g&&H(g.wa(),function(aa,ba){var Da=a.match(ba.Da);if(Da){j=ba;i=j.Aa;h=nb(Da,j.to,i);h.utc&&e.na();i.pa=j;if(h.timestamp){h=h.timestamp;return m}if(j.Ga&&!D(h.month)&&(D(h.date)||g.ya(b))){z=h.month;h.month=h.date;h.date=z}if(h.year&&h.Ha.length===2)h.year=N(X(new s,"FullYear")/100)*100-N(h.year/100)*100+h.year;if(h.month){h.month=
i.getMonth(h.month);if(h.shift&&!h.unit)h.unit=i.units[7]}if(h.weekday&&h.date)delete h.weekday;else if(h.weekday){h.weekday=i.la(h.weekday);if(h.shift&&!h.unit)h.unit=i.units[5]}if(h.day&&(z=i.ia[h.day])){h.day=z.value;e.reset();f=k}else if(h.day&&(r=i.la(h.day))>-1){delete h.day;if(h.num&&h.month){C=function(){var Q=e.la();e.Fa(7*(h.num-1)+(Q>r?r+7:r))};h.day=1}else h.weekday=r}if(h.date&&!B(h.date))h.date=i.xa(h.date);if(i.Ca(h.ampm)&&h.hour<12)h.hour+=12;else if(i.Ba(h.ampm)&&h.hour===12)h.hour=
0;if("offset_hours"in h||"offset_minutes"in h){e.na();h.offset_minutes=h.offset_minutes||0;h.offset_minutes+=h.offset_hours*60;if(h.offset_sign==="-")h.offset_minutes*=-1;h.minute-=h.offset_minutes}if(h.unit){f=k;y=i.ra(h.num);n=i.va(h.unit);if(h.shift||h.edge){y*=(z=i.ia[h.shift])?z.value:0;if(n==="month"&&J(h.date)){e.set({day:h.date},k);delete h.date}if(n==="year"&&J(h.month)){e.set({month:h.month,day:h.date},k);delete h.month;delete h.date}}if(h.sign&&(z=i.ia[h.sign]))y*=z.value;if(J(h.weekday)){e.set({weekday:h.weekday},
k);delete h.weekday}h[n]=(h[n]||0)+y}if(h.year_sign==="-")h.year*=-1;W.slice(1,4).forEach(function(Q,Ub){var zb=h[Q.$],Ab=zb%1;if(Ab){h[W[Ub].$]=N(Ab*(Q.$==="second"?1E3:60));h[Q.$]=O(zb)}});return m}});if(j)if(f)e.advance(h);else{e.ea&&e.reset();rb(e,h,k,m,c)}else e=a?new s(a):new s;if(h&&h.edge){z=i.ia[h.edge];H(W.slice(4),function(aa,ba){if(J(h[ba.$])){n=ba.$;return m}});if(n==="year")h.ga="month";else if(n==="month"||n==="week")h.ga="day";e[(z.value<0?"endOf":"beginningOf")+fb(n)]();z.value===
-2&&e.reset()}C&&C()}return{fa:e,set:h}}function eb(a){var b,c=v.abs(a),d=c,e=0;W.slice(1).forEach(function(f,g){b=O(N(c/f.da()*10)/10);if(b>=1){d=b;e=g+1}});return[d,e,a]}
function sb(a,b,c,d){var e,f=jb(d),g=q(/^[A-Z]/);if(a.isValid())if(Date[b])b=Date[b];else{if(A(b)){e=eb(a.millisecondsFromNow());b=b.apply(a,e.concat(f))}}else return"Invalid Date";if(!b&&c){e=e||eb(a.millisecondsFromNow());if(e[1]===0){e[1]=1;e[0]=1}return f.Ea(e)}b=b||"long";b=f[b]||b;ab.forEach(function(i){b=b.replace(q("\\{("+i.ba+")(\\d)?\\}",i.oa?"i":""),function(j,h,n){j=i.format(a,f,n||1,h);n=h.length;var r=h.match(/^(.)\1+$/);if(i.oa){if(n===3)j=j.slice(0,3);if(r||h.match(g))j=fb(j)}else if(r&&
!i.text)j=(B(j)?P(j,n):j.toString()).slice(-n);return j})});return b}
function tb(a,b,c,d){var e=qb(b,l,l,d),f=0;d=b=0;var g;if(c>0){b=d=c;g=k}if(!e.fa.isValid())return m;if(e.set&&e.set.ga){bb.forEach(function(j){if(j.$===e.set.ga)f=j.da(e.fa,a-e.fa)-1});c=fb(e.set.ga);if(e.set.edge||e.set.shift)e.fa["beginningOf"+c]();if(e.set.ga==="month")i=e.fa.clone()["endOf"+c]().getTime();if(!g&&e.set.sign&&e.set.ga!="millisecond"){b=50;d=-50}}g=a.getTime();c=e.fa.getTime();var i=i||c+f;return g>=c-b&&g<=i+d}
function rb(a,b,c,d,e){function f(j){return J(b[j])?b[j]:b[j+"s"]}var g,i;if(B(b)&&d)b={milliseconds:b};else if(B(b)){a.setTime(b);return a}if(b.date)b.day=b.date;H(W,function(j,h){var n=h.$==="day";if(J(f(h.$))||n&&J(f("weekday"))){b.ga=h.$;i=+j;return m}else if(c&&h.$!=="week"&&(!n||!J(f("week"))))ub(a,h.method,n?1:0)});bb.forEach(function(j){var h=j.$;j=j.method;var n;n=f(h);if(!K(n)){if(d){if(h==="week"){n=(b.day||0)+n*7;j="Date"}n=n*d+X(a,j)}else h==="month"&&J(f("day"))&&ub(a,"Date",15);ub(a,
j,n);if(d&&h==="month"){h=n;if(h<0)h+=12;h%12!=X(a,"Month")&&ub(a,"Date",0)}}});if(!d&&!J(f("day"))&&J(f("weekday"))){g=f("weekday");a.Fa(g)}(function(){var j=new s;return e===-1&&a>j||e===1&&a<j})()&&H(W.slice(i+1),function(j,h){if((h.ka||h.$==="week"&&J(f("weekday")))&&!J(f(h.$))){a[h.ja](e);return m}});return a}function X(a,b){return a["get"+(a.ea?"UTC":"")+b]()}function ub(a,b,c){return a["set"+(a.ea?"UTC":"")+b](c)}
function hb(a,b,c){var d={h:0,m:1,s:2},e;b=b||V;return a.replace(/{([a-z])}/g,function(f,g){var i=[],j=g==="h",h=j&&!c;if(g==="t")return b.ampm.join("|");else{j&&i.push(":");if(e=b.timeSuffixes[d[g]])i.push(e+"\\s*");return i.length===0?"":"(?:"+i.join("|")+")"+(h?"":"?")}})}function vb(a,b){var c,d,e;if(B(a[1]))c=lb(a)[0];else{c=a[0];d=a[1];e=a[2]}return qb(c,d,b,e).fa}
s.extend({create:function(){return vb(arguments)},past:function(){return vb(arguments,-1)},future:function(){return vb(arguments,1)},addLocale:function(a,b){return kb(a,b)},setLocale:function(a){var b=jb(a,m);Ua=b;if(a&&a!=b.code)b.code=a;return b},getLocale:function(a){return!a?Ua:jb(a,m)},addFormat:function(a,b,c){ib(jb(c),a,b)}},m,m);
s.extend({set:function(){var a=lb(arguments);return rb(this,a[0],a[1])},setWeekday:function(a){if(!K(a))return ub(this,"Date",X(this,"Date")+a-X(this,"Day"))},setWeek:function(a){if(!K(a)){X(this,"Date");ub(this,"Month",0);ub(this,"Date",a*7+1);return this.getTime()}},getWeek:function(){var a=this;a=a.clone();var b=X(a,"Day")||7;a.addDays(4-b).reset();return 1+O(a.daysSince(a.clone().beginningOfYear())/7)},getUTCOffset:function(a){var b=this.ea?0:this.getTimezoneOffset(),c=a===k?":":"";if(!b&&a)return"Z";
return P(N(-b/60),2,k)+c+P(b%60,2)},utc:function(a){this.ea=a===k||arguments.length===0;return this},isUTC:function(){return!!this.ea||this.getTimezoneOffset()===0},advance:function(){var a=lb(arguments,k);return rb(this,a[0],a[1],1)},rewind:function(){var a=lb(arguments,k);return rb(this,a[0],a[1],-1)},isValid:function(){return!isNaN(this.getTime())},isAfter:function(a,b){return this.getTime()>s.create(a).getTime()-(b||0)},isBefore:function(a,b){return this.getTime()<s.create(a).getTime()+(b||0)},
isBetween:function(a,b,c){var d=this.getTime();a=s.create(a).getTime();var e=s.create(b).getTime();b=v.min(a,e);a=v.max(a,e);c=c||0;return b-c<d&&a+c>d},isLeapYear:function(){var a=X(this,"FullYear");return a%4===0&&a%100!==0||a%400===0},daysInMonth:function(){return 32-X(new s(X(this,"FullYear"),X(this,"Month"),32),"Date")},format:function(a,b){return sb(this,a,m,b)},relative:function(a,b){if(D(a)){b=a;a=l}return sb(this,a,k,b)},is:function(a,b,c){var d,e;if(this.isValid()){if(D(a)){a=a.trim().toLowerCase();
e=this.clone().na(c);switch(k){case a==="future":return this.getTime()>(new s).getTime();case a==="past":return this.getTime()<(new s).getTime();case a==="weekday":return X(e,"Day")>0&&X(e,"Day")<6;case a==="weekend":return X(e,"Day")===0||X(e,"Day")===6;case (d=V.weekdays.indexOf(a)%7)>-1:return X(e,"Day")===d;case (d=V.months.indexOf(a)%12)>-1:return X(e,"Month")===d}}return tb(this,a,b,c)}},reset:function(a){var b={},c;a=a||"hours";if(a==="date")a="days";c=bb.some(function(d){return a===d.$||a===
d.$+"s"});b[a]=a.match(/^days?/)?1:0;return c?this.set(b,k):this},clone:function(){var a=new s(this.getTime());a.ea=this.ea;return a}});s.extend({iso:function(){return this.toISOString()},getWeekday:s.prototype.getDay,getUTCWeekday:s.prototype.getUTCDay});
function wb(a,b){function c(){return N(this*b)}function d(){return vb(arguments)[a.ja](this)}function e(){return vb(arguments)[a.ja](-this)}var f=a.$,g={};g[f]=c;g[f+"s"]=c;g[f+"Before"]=e;g[f+"sBefore"]=e;g[f+"Ago"]=e;g[f+"sAgo"]=e;g[f+"After"]=d;g[f+"sAfter"]=d;g[f+"FromNow"]=d;g[f+"sFromNow"]=d;u.extend(g)}u.extend({duration:function(a){return jb(a).ua(this)}});
...
value:1}],dateParse:["{num} {unit} {sign}","{sign} {num} {unit}","{num} {unit=4-5} {sign} {day}","{month} {year}","{shift} {unit=5-7}","{0} {edge} of {shift?} {unit=4-7?}{month?}{year?}"],timeParse:["{0} {num}{1} {day} of {month} {year?}","{weekday?} {month} {date}{1} {year?}","{date} {month} {year}","{shift} {weekday}","{shift} week {weekday}","{weekday} {2} {shift} week","{0} {date}{1} of {month}","{0}{month?} {date?}{1} of {shift} {unit=6-7}"]});W=bb.concat().reverse();Za=bb.concat();
Za.splice(2,1);
I(s,k,m,bb,function(a,b,c){var d=b.$,e=fb(d),f=b.da(),g,i;b.ja="add"+e+"s";g=function(j,h){return N((this.getTime()-s.create(j,h).getTime())/f)};i=function(j,h){return N((s.create(j,h).getTime()-this.getTime())/f)};a[d+"sAgo"]=i;a[d+"sUntil"]=i;a[d+"sSince"]=g;a[d+"sFromNow"]=g;a[b.ja]=function(j,h){var n={};n[d]=j;return this.advance(n,h)};wb(b,f);c<3&&["Last","This","Next"].forEach(function(j){a["is"+j+e]=function(){return this.is(j+" "+d)}});if(c<4){a["beginningOf"+e]=function(){var j={};switch(d){case "year":j.year=
X(this,"FullYear");break;case "month":j.month=X(this,"Month");break;case "day":j.day=X(this,"Date");break;case "week":j.weekday=0}return this.set(j,k)};a["endOf"+e]=function(){var j={hours:23,minutes:59,seconds:59,milliseconds:999};switch(d){case "year":j.month=11;j.day=31;break;case "month":j.day=this.daysInMonth();break;case "week":j.weekday=6}return this.set(j,k)}}});V.addFormat("([+-])?(\\d{4,4})[-.]?{full_month}[-.]?(\\d{1,2})?",k,["year_sign","year","month","date"],m,k);
V.addFormat("(\\d{1,2})[-.\\/]{full_month}(?:[-.\\/](\\d{2,4}))?",k,["date","month","year"],k);V.addFormat("{full_month}[-.](\\d{4,4})",m,["month","year"]);V.addFormat("\\/Date\\((\\d+(?:\\+\\d{4,4})?)\\)\\/",m,["timestamp"]);V.addFormat(hb(Wa,V),m,Va);$a=V.ha.slice(0,7).reverse();V.ha=V.ha.slice(7).concat($a);I(s,k,m,"short,long,full",function(a,b){a[b]=function(c){return sb(this,b,m,c)}});
...
(function(){var a="today,yesterday,tomorrow,weekday,weekend,future,past".split(","),b=V.weekdays.slice(0,7),c=V.months.slice(0,12);I(s,k,m,a.concat(b).concat(c),function(d,e){d["is"+fb(e)]=function(f){return this.is(e,0,f)}})})();s.extend({RFC1123:"{Dow}, {dd} {Mon} {yyyy} {HH}:{mm}:{ss} {tz}",RFC1036:"{Weekday}, {dd}-{Mon}-{yy} {HH}:{mm}:{ss} {tz}",ISO8601_DATE:"{yyyy}-{MM}-{dd}",ISO8601_DATETIME:"{yyyy}-{MM}-{dd}T{HH}:{mm}:{ss}.{fff}{isotz}"},m,m);
...
F(DateRange,k,m,{isValid:function(){return this.start<this.end},duration:function(){return this.isValid()?this.end.getTime()-this.start.getTime():NaN},contains:function(a){var b=this;return(a.start&&a.end?[a.start,a.end]:[a]).every(function(c){return c>=b.start&&c<=b.end})},every:function(a,b){var c=this.start.clone(),d=[],e=0,f;if(D(a)){c.advance(mb(a,0),k);f=mb(a)}else f={milliseconds:a};for(;c<=this.end;){d.push(c);b&&b(c,e);c=c.clone().advance(f,k);e++}return d},union:function(a){return new DateRange(this.start<
...
function xb(a,b,c,d,e){if(!a.timers)a.timers=[];B(b)||(b=0);a.timers.push(setTimeout(function(){a.timers.splice(f,1);c.apply(d,e||[])},b));var f=a.timers.length}
F(Function,k,m,{lazy:function(a,b){function c(){if(!(f&&e.length>b-2)){e.push([this,arguments]);g()}}var d=this,e=[],f=m,g,i,j;a=a||1;b=b||Infinity;i=N(a,void 0,"ceil");j=N(i/a);g=function(){if(!(f||e.length==0)){for(var h=v.max(e.length-j,0);e.length>h;)Function.prototype.apply.apply(d,e.shift());xb(c,i,function(){f=m;g()});f=k}};return c},delay:function(a){var b=G(arguments).slice(1);xb(this,a,this,this,b);return this},throttle:function(a){return this.lazy(a,1)},debounce:function(a){var b=this;
return function(){b.cancel();xb(b,a,b,this,arguments)}},cancel:function(){if(fa(this.timers))for(;this.timers.length>0;)clearTimeout(this.timers.shift());return this},after:function(a){var b=this,c=0,d=[];if(B(a)){if(a===0){b.call();return b}}else a=1;return function(){var e;d.push(G(arguments));c++;if(c==a){e=b.call(this,d);c=0;d=[];return e}}},once:function(){var a=this;return function(){return oa(a,"memo")?a.memo:a.memo=a.apply(this,arguments)}},fill:function(){var a=this,b=G(arguments);return function(){var c=
G(arguments);b.forEach(function(d,e){if(d!=l||e>=c.length)c.splice(e,0,d)});return a.apply(this,c)}}});
function yb(a,b,c,d,e,f){var g=a.toFixed(20),i=g.search(/\./);g=g.search(/[1-9]/);i=i-g;if(i>0)i-=1;e=v.max(v.min((i/3).floor(),e===m?c.length:e),-d);d=c.charAt(e+d-1);if(i<-9){e=-3;b=i.abs()-9;d=c.slice(0,1)}return(a/(f?(2).pow(10*e):(10).pow(e*3))).round(b||0).format()+d.trim()}
F(u,m,m,{random:function(a,b){var c,d;if(arguments.length==1){b=a;a=0}c=v.min(a||0,K(b)?1:b);d=v.max(a||0,K(b)?1:b);return N(v.random()*(d-c)+c)}});
...
d=B(a)?N(this,a||0).toFixed(v.max(a,0)):this.toString();b=b||",";c=c||".";e=d.split(".");d=e[0];for(e=e[1]||"";d.match(f);)d=d.replace(f,"$1"+b+"$2");if(e.length>0)d+=c+qa((a||0)-e.length,"0")+e;return d},hex:function(a){return this.pad(a||1,m,16)},upto:function(a,b,c){return M(this,a,b,c||1)},downto:function(a,b,c){return M(this,a,b,-(c||1))},times:function(a){if(a)for(var b=0;b<this;b++)a.call(this,b);return this.toNumber()},chr:function(){return t.fromCharCode(this)},pad:function(a,b,c){return P(this,
a,b,c)},ordinalize:function(){var a=this.abs();a=parseInt(a.toString().slice(-2));return this+ra(a)},toNumber:function(){return parseFloat(this,10)}});I(u,k,m,"round,floor,ceil",function(a,b){a[b]=function(c){return N(this,c,b)}});I(u,k,m,"abs,pow,sin,asin,cos,acos,tan,atan,exp,pow,sqrt",function(a,b){a[b]=function(c,d){return v[b](this,c,d)}});
...
F(q,k,m,{getFlags:function(){return ta(this)},setFlags:function(a){return q(this.source,a)},addFlag:function(a){return this.setFlags(ta(this,a))},removeFlag:function(a){return this.setFlags(ta(this).replace(a,""))}});
var Eb,Fb;
...
" ")},stripTags:function(){var a=this;G(arguments.length>0?arguments:[""],function(b){a=a.replace(q("</?"+R(b)+"[^<>]*>","gi"),"")});return a},removeTags:function(){var a=this;G(arguments.length>0?arguments:["\\S+"],function(b){b=q("<("+b+")[^<>]*(?:\\/>|>.*?<\\/\\1>)","gi");a=a.replace(b,"")});return a},truncate:function(a,b,c,d){var e="",f="",g=this.toString(),i="["+sa()+"]+",j="[^"+sa()+"]*",h=q(i+j+"$");d=K(d)?"...":t(d);if(g.length<=a)return g;switch(c){case "left":a=g.length-a;e=d;g=g.slice(a);
h=q("^"+j+i);break;case "middle":a=O(a/2);f=d+g.slice(g.length-a).trimLeft();g=g.slice(0,a);break;default:a=a;f=d;g=g.slice(0,a)}if(b===m&&this.slice(a,a+1).match(/\S/))g=g.remove(h);return e+g+f},pad:function(a,b){return qa(b,a)+this+qa(b,a)},padLeft:function(a,b){return qa(b,a)+this},padRight:function(a,b){return this+qa(b,a)},first:function(a){if(K(a))a=1;return this.substr(0,a)},last:function(a){if(K(a))a=1;return this.substr(this.length-a<0?0:this.length-a)},repeat:function(a){var b="",c=0;if(B(a)&&
a>0)for(;c<a;){b+=this;c++}return b},toNumber:function(a){var b=this.replace(/,/g,"");return b.match(/\./)?parseFloat(b):parseInt(b,a||10)},capitalize:function(a){var b;return this.toLowerCase().replace(a?/[\s\S]/g:/^\S/,function(c){var d=c.toUpperCase(),e;e=b?c:d;b=d!==c;return e})},assign:function(){var a={};G(arguments,function(b,c){if(na(b))pa(a,b);else a[c+1]=b});return this.replace(/\{([^{]+?)\}/g,function(b,c){return oa(a,c)?a[c]:b})},namespace:function(a){a=a||da;H(this.split("."),function(b,
c){return!!(a=a[c])});return a}});F(t,k,m,{insert:t.prototype.add});
(function(a){if(this.btoa){Eb=this.btoa;Fb=this.atob}else{var b=/[^A-Za-z0-9\+\/\=]/g;Eb=function(c){var d="",e,f,g,i,j,h,n=0;do{e=c.charCodeAt(n++);f=c.charCodeAt(n++);g=c.charCodeAt(n++);i=e>>2;e=(e&3)<<4|f>>4;j=(f&15)<<2|g>>6;h=g&63;if(isNaN(f))j=h=64;else if(isNaN(g))h=64;d=d+a.charAt(i)+a.charAt(e)+a.charAt(j)+a.charAt(h)}while(n<c.length);return d};Fb=function(c){var d="",e,f,g,i,j,h=0;if(c.match(b))throw Error("String contains invalid base64 characters");c=c.replace(/[^A-Za-z0-9\+\/\=]/g,"");
do{e=a.indexOf(c.charAt(h++));f=a.indexOf(c.charAt(h++));i=a.indexOf(c.charAt(h++));j=a.indexOf(c.charAt(h++));e=e<<2|f>>4;f=(f&15)<<4|i>>2;g=(i&3)<<6|j;d+=t.fromCharCode(e);if(i!=64)d+=t.fromCharCode(f);if(j!=64)d+=t.fromCharCode(g)}while(h<c.length);return d}}})("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=");
...
Z={acronym:function(a){Jb[a.toLowerCase()]=a;a=o.keys(Jb).map(function(b){return Jb[b]});Z.acronymRegExp=q(a.join("|"),"g")},plural:function(a,b){Mb(Gb,a,b)},singular:function(a,b){Mb(Hb,a,b)},irregular:function(a,b){var c=a.first(),d=a.from(1),e=b.first(),f=b.from(1),g=e.toUpperCase(),i=e.toLowerCase(),j=c.toUpperCase(),h=c.toLowerCase();Lb(Y,a);Lb(Y,b);if(j==g){Z.plural(new q("({1}){2}$".assign(c,d),"i"),"$1"+f);Z.plural(new q("({1}){2}$".assign(e,f),"i"),"$1"+f);Z.singular(new q("({1}){2}$".assign(e,
f),"i"),"$1"+d)}else{Z.plural(new q("{1}{2}$".assign(j,d)),g+f);Z.plural(new q("{1}{2}$".assign(h,d)),i+f);Z.plural(new q("{1}{2}$".assign(g,f)),g+f);Z.plural(new q("{1}{2}$".assign(i,f)),i+f);Z.singular(new q("{1}{2}$".assign(g,f)),j+d);Z.singular(new q("{1}{2}$".assign(i,f)),h+d)}},uncountable:function(a){var b=p.isArray(a)?a:G(arguments);Y=Y.concat(b)},human:function(a,b){Ib.unshift({ma:a,sa:b})},clear:function(a){if(Nb(a,"singulars"))Hb=[];if(Nb(a,"plurals"))Gb=[];if(Nb(a,"uncountables"))Y=[];
...
{ca:["Thai"],source:"\u0e00-\u0e7f"}].forEach(function(a){var b=q("^["+a.source+"\\s]+$"),c=q("["+a.source+"]");a.ca.forEach(function(d){ka(t.prototype,"is"+d,function(){return b.test(this.trim())});ka(t.prototype,"has"+d,function(){return c.test(this)})})});

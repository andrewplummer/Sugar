 ...
 *
 * ---------------------------- */
(function(){var j=true,k=null,m=false;function o(a){return function(){return a}}var r=Object,s=Array,t=RegExp,u=Date,v=String,w=Number,x=Math,y="Array,Boolean,Date,Function,Number,String,RegExp".split(","),aa=z(y[0]),ba=z(y[1]),ca=z(y[2]),D=z(y[3]),E=z(y[4]),F=z(y[5]),G=z(y[6]);function z(a){return function(b){return da(b,a)}}
function ea(a){if(!a.SugarMethods){fa(a,"SugarMethods",{});H(a,m,m,{restore:function(){var b=arguments.length===0,c=I(arguments);J(a.SugarMethods,function(d,e){if(b||c.indexOf(d)>-1)fa(e.Aa?a.prototype:a,d,e.method)})},extend:function(b,c,d){H(a,d!==m,c,b)}})}}var ga=typeof global!=="undefined"?global:this,ha=r.defineProperty&&r.defineProperties;
function H(a,b,c,d){var e=b?a.prototype:a,g;ea(a);J(d,function(f,i){g=e[f];if(typeof c==="function")i=ia(e[f],i,c);if(c!==m||!e[f])fa(e,f,i);a.SugarMethods[f]={Aa:b,method:i,Ha:g}})}function ia(a,b,c){return function(){return a&&(c===j||!c.apply(this,arguments))?a.apply(this,arguments):b.apply(this,arguments)}}function fa(a,b,c){if(ha)r.defineProperty(a,b,{value:c,configurable:j,enumerable:m,writable:j});else a[b]=c}
function K(a,b,c,d,e){var g={};d=F(d)?d.split(","):d;d.forEach(function(f,i){e(g,f,i)});H(a,b,c,g)}function I(a,b){var c=[],d=0;for(d=0;d<a.length;d++){c.push(a[d]);b&&b.call(a,a[d],d)}return c}function L(a){return a!==void 0}function M(a){return a===void 0}function ja(a){return a&&typeof a==="object"}function ka(a){return!!a&&da(a,"Object")&&v(a.constructor)===v(r)}function la(a,b){return r.hasOwnProperty.call(a,b)}function da(a,b){return r.prototype.toString.call(a)==="[object "+b+"]"}
function J(a,b){for(var c in a)if(la(a,c))if(b.call(a,c,a[c])===m)break}function ma(a,b){J(b,function(c){a[c]=b[c]});return a}function na(a){return a.slice(0,1).toUpperCase()+a.slice(1)}function N(a,b,c,d){var e=[];a=parseInt(a);for(var g=d<0;!g&&a<=b||g&&a>=b;){e.push(a);c&&c.call(this,a);a+=d||1}return e}function O(a,b,c){c=x[c||"round"];var d=x.pow(10,x.abs(b||0));if(b<0)d=1/d;return c(a*d)/d}function P(a,b){return O(a,b,"floor")}
function oa(){return"\t\n\u000b\u000c\r \u00a0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u2028\u2029\u3000\ufeff"}function pa(a,b){return s(x.max(0,L(a)?a:1)+1).join(b||"")}function Q(a,b,c,d){d=x.abs(a).toString(d||10);d=pa(b-d.replace(/\.\d+/,"").length,"0")+d;if(c||a<0)d=(a<0?"-":"+")+d;return d}function ra(a){if(a>=11&&a<=13)return"th";else switch(a%10){case 1:return"st";case 2:return"nd";case 3:return"rd";default:return"th"}}
function sa(a,b){var c=a.toString().match(/[^/]*$/)[0];if(b)c=(c+b).split("").sort().join("").replace(/([gimy])\1+/g,"$1");return c}function R(a){F(a)||(a=v(a));return a.replace(/([\\/'*+?|()\[\]{}.^$])/g,"\\$1")}
...
function ta(a,b,c){var d=[],e=a.length,g=b[b.length-1]!==m,f;I(b,function(i){if(ba(i))return m;if(g){i%=e;if(i<0)i=e+i}f=c?a.charAt(i)||"":a[i];d.push(f)});return d.length<2?d[0]:d}function ua(a,b){K(b,j,m,a,function(c,d){c[d+(d==="equal"?"s":"")]=function(){return r[d].apply(k,[this].concat(I(arguments)))}})}ea(r);J(y,function(a,b){ea(ga[b])});
...
function wa(a,b,c,d){var e=a.length,g=0,f=c!==void 0;xa(b);if(e==0&&!f)throw new TypeError("Reduce called on empty array with no initial value");else if(f)c=c;else{c=a[d?e-1:g];g++}for(;g<e;){f=d?e-g-1:g;if(f in a)c=b.call(void 0,c,a[f],f,a);g++}return c}function xa(a){if(!a||!a.call)throw new TypeError("Callback is not callable");}function ya(a){if(a.length===0)throw new TypeError("First argument must be defined");}H(s,m,m,{isArray:function(a){return da(a,"Array")}});
...
function bb(a,b,c,d){a.ga.unshift({Fa:d,Ba:a,Da:t("^"+b+"$","i"),to:c})}function cb(a,b,c){var d;if(!a||!F(a))return Ra;d=$a[a]||$a[a.slice(0,2)];if(!d||c)d=db(a,c,b);return d}
...
function rb(a,b,c){var d=ob(b),e=0,g=b=0,f;if(c>0){b=g=c;f=j}if(!d.ea.isValid())return m;if(d.set&&d.set.ha){Za.forEach(function(h){if(h.$===d.set.ha)e=h.da(d.ea,a-d.ea)-1});if(d.set.edge||d.set.shift)d.ea["beginningOf"+na(d.set.ha)]();if(!f&&d.set.sign&&d.set.ha!="millisecond"){b=50;g=-50}}c=a.getTime();f=d.ea.getTime();var i=f+e;i+=(a.getTimezoneOffset()-d.ea.getTimezoneOffset()).minutes();return c>=f-b&&c<=i+g}
function pb(a,b,c,d,e,g){function f(n){return L(b[n])?b[n]:b[n+"s"]}var i;if(E(b)&&e)b={milliseconds:b};else if(E(b)){a.setTime(b);return a}if(b.date)b.day=b.date;J(Wa,function(n,p){var q=p.$==="day";if(L(f(p.$))||q&&L(f("weekday"))){b.ha=p.$;return m}else if(c&&p.$!=="week"&&(!q||!L(f("week"))))X(a,"set",d,p.method,q?1:0)});Za.forEach(function(n,p){var q=n.$,B=n.method,C=Za[p-1],A;A=f(q);if(!M(A)){g&&n.pa&&!L(f(C.$))&&X(new u,"get",d,n.method)>=A===(g===1)&&a[C.ka](g);if(e){if(q==="week"){A=(b.day||
...
H(xb,j,j,{toString:function(){return this.isValid()?this.start.full()+".."+this.end.full():"Invalid DateRange"},isValid:function(){return this.start<this.end},duration:function(){return this.isValid()?this.end.getTime()-this.start.getTime():NaN},contains:function(a){var b=this;return(a.start&&a.end?[a.start,a.end]:[a]).every(function(c){return c>=b.start&&c<=b.end})},every:function(a,b){var c=this.start.clone(),d=[],e=0,g;if(F(a)){c.advance(kb(a,0),j);g=kb(a)}else g={milliseconds:a};for(;c<=this.end;){d.push(c);
b&&b(c,e);c=c.clone().advance(g,j);e++}return d},union:function(a){return new xb(this.start<a.start?this.start:a.start,this.end>a.end?this.end:a.end)},intersect:function(a){return new xb(this.start>a.start?this.start:a.start,this.end<a.end?this.end:a.end)}});K(xb,j,m,"Millisecond,Second,Minute,Hour,Day,Week,Month,Year",function(a,b){a["each"+b]=function(c){return this.every(b,c)}});H(u,m,m,{range:function(a,b){return new xb(a,b)}});
...
a,b,c)},ordinalize:function(){var a=this.abs();a=parseInt(a.toString().slice(-2));return this+ra(a)},toNumber:function(){return parseFloat(this,10)}});K(w,j,m,"round,floor,ceil",function(a,b){a[b]=function(c){return O(this,c,b)}});K(w,j,m,"abs,pow,sin,asin,cos,acos,tan,atan,exp,pow,sqrt",function(a,b){a[b]=function(c,d){return x[b](this,c,d)}});
var Ab="isObject,isNaN".split(","),Bb="keys,values,each,merge,isEmpty,clone,equal,watch,tap,has".split(",");
function V(a){r.merge(this,a)}V.prototype.constructor=r;function Cb(a,b,c,d){var e=/^(.+?)(\[.*\])$/,g,f,i;if(d!==m&&(f=b.match(e))){i=f[1];b=f[2].replace(/^\[|\]$/g,"").split("][");b.forEach(function(h){g=!h||h.match(/^\d+$/);if(!i&&aa(a))i=a.length;a[i]||(a[i]=g?[]:{});a=a[i];i=h});if(!i&&g)i=a.length.toString();Cb(a,i,c)}else a[b]=c.match(/^[\d.]+$/)?parseFloat(c):c==="true"?j:c==="false"?m:c}
H(r,m,j,{watch:function(a,b,c){if(ha){var d=a[b];r.defineProperty(a,b,{enumerable:j,configurable:j,get:function(){return d},set:function(e){d=c.call(a,b,d,e)}})}}});H(r,m,function(a,b){return D(b)},{keys:function(a,b){var c=r.keys(a);r.keys(a).forEach(function(d){b.call(a,d,a[d])});return c}});
H(r,m,m,{isObject:function(a){return ka(a)},isNaN:function(a){return E(a)&&a.valueOf()!==a.valueOf()},equal:function(a,b){return S(a)===S(b)},extended:function(a){return new V(a)},merge:function(a,b,c,d){var e,g;if(a&&typeof b!="string")for(e in b)if(la(b,e)&&a){g=b[e];if(a[e]!==void 0){if(d===m)continue;if(D(d))g=d.call(b,e,a[e],b[e])}if(c===j&&g&&ja(g))if(ca(g))g=new u(g.getTime());else if(G(g))g=new t(g.source,sa(g));else{a[e]||(a[e]=s.isArray(g)?[]:{});r.merge(a[e],b[e],c,d);continue}a[e]=g}return a},
...
d.split("=");d.length===2&&Cb(c,d[0],d[1],b)});return c},tap:function(a,b){var c=b;D(b)||(c=function(){b&&a[b]()});c.call(a,a);return a},has:function(a,b){return la(a,b)}});K(r,m,m,y,function(a,b){var c="is"+b;Ab.push(c);a[c]=function(d){return da(d,b)}});(function(){H(r,m,function(){return arguments.length===0},{extend:function(){ua(Ab.concat(Bb),r)}})})();ua(Bb,V);
...
{ca:["Thai"],source:"\u0e00-\u0e7f"}].forEach(function(a){var b=t("^["+a.source+"\\s]+$"),c=t("["+a.source+"]");a.ca.forEach(function(d){fa(v.prototype,"is"+d,function(){return b.test(this.trim())});fa(v.prototype,"has"+d,function(){return c.test(this)})})});

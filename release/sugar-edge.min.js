...
s(w,x,x,{create:function(){var a=[];C(arguments,function(b){if(b&&b.callee)b=A(b);a=a.concat(b)});return a},isArray:function(a){return S(a,"Array")}});s(w,i,function(){var a=arguments;return a.length===0||j.isFunction(a[0])},{every:function(a,b){var c=this.length,d=0;for(U(arguments);d<c;){if(d in this&&!K(this[d],a,b,[d,this]))return x;d++}return i},some:function(a,b){var c=this.length,d=0;for(U(arguments);d<c;){if(d in this&&K(this[d],a,b,[d,this]))return i;d++}return x},map:function(a,b){var c=
...
10)},ceil:function(a){return y(this,a,"ceil")},floor:function(a){return y(this,a,"floor")},abs:function(){return Math.abs(this)},pow:function(a){if(q(a))a=1;return Math.pow(this,a)},round:function(a){return y(this,a,"round")},chr:function(){return B.fromCharCode(this)},isOdd:function(){return!this.isMultipleOf(2)},isEven:function(){return this.isMultipleOf(2)},isMultipleOf:function(a){return this%a===0},upto:function(a,b,c){return ma(this,a,b,c||1)},downto:function(a,b,c){return ma(this,a,b,-(c||
...
{type:"p",shift:65248,start:91,end:96},{type:"p",shift:65248,start:123,end:126}],oa={},pa={},Ra=/[\u0020-\u00A5]|[\uFF61-\uFF9F][\uff9e\uff9f]?/g,Sa=/[\u3000-\u301C]|[\u301A-\u30FC]|[\uFF01-\uFF60]|[\uFFE0-\uFFE6]/g,Ta=/[\u30ab\u30ad\u30af\u30b1\u30b3\u30b5\u30b7\u30b9\u30bb\u30bd\u30bf\u30c1\u30c4\u30c6\u30c8\u30cf\u30d2\u30d5\u30d8\u30db]/,Ua=/[\u30cf\u30d2\u30d5\u30d8\u30db\u30f2]/;s(B,i,x,{escapeRegExp:function(){return r.escape(this)},escapeURL:function(a){return a?encodeURIComponent(this):encodeURI(this)},
...
c){F("p","\uff61\uff64\uff62\uff63\u00a5\u00a2\u00a3".charAt(c),b)});F("k","\uff73\uff9e","\u30f4");F("k","\uff66\uff9e","\u30fa");F("s"," ","\u3000")})();(function(){Pa.each(function(a){var b=r("^["+a.source+"\\s]+$"),c=r("["+a.source+"]");a.d.each(function(d){t(B.prototype,"is"+d,function(){return b.test(this.trim())});t(B.prototype,"has"+d,function(){return c.test(this)})})})})();English=m.setLocale("en");(function(){p(R,function(a,b){var c=a.a,d=c.capitalize(),e=a.e();t(m.prototype,c+"sSince",

...
(function(){function G(){return"\t\n\u000b\u000c\r \u00a0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u2028\u2029\u3000\ufeff"}function t(a,b,c,d){var e=b?a.prototype:a;Ba(a,b,d);C(d,function(f,h){if(j.isFunction(c))s(e,f,Ca(e[f],h,c));else if(c===i||!e[f])s(e,f,h);a.j[f]={u:b,method:h}})}function Ba(a){if(!a.j){a.j={};s(a,"sugar",function(){var b=arguments,c=b.length===0,d=z;if(a===j&&c){ga(j.prototype);ha(j.prototype)}C(a.j,function(e,f){if(c||H(b,e)){s(f.u?
a.prototype:a,e,f.method);d=i}});return d})}}function Ca(a,b,c){return function(){return a&&(c===i||c.apply(this,arguments))?a.apply(this,arguments):b.apply(this,arguments)}}function s(a,b,c){if(ia)j.defineProperty(a,b,{value:c,configurable:i,enumerable:z,writable:i});else a[b]=c}function C(a,b){var c=0,d;for(d in a)if(a.hasOwnProperty(d)){b.call(a,d,a[d],c);c++}}function ja(a,b,c){var d=j.prototype.toString.call(a).match(/\[object (\w+)\]/)[1];if(a===b)return a!==0||1/a===1/b;else if(a===l||q(a)||
...
r(b).test(a):j.isFunction(b)?b.apply(c,[a].concat(d)):j.equal(b,a)}function I(a,b,c,d,e){return q(b)?c:j.isFunction(b)?b.apply(e||a,[c].concat([d,a])):j.isFunction(c[b])?c[b].call(c):c[b]}function D(a,b){return Array.prototype.slice.call(a,b)}function A(a,b,c){a=D(a);if(c!==z)a=M(a);p(a,b)}function ka(a,b,c){var d=[],e=a.length,f=b[b.length-1]!==z,h;A(b,function(g){if(j.isBoolean(g))return z;if(f){g%=e;if(g<0)g=e+g}h=c?a.charAt(g)||"":a[g];d.push(h)});return d.length<2?d[0]:d}function R(a,b){return j.prototype.toString.call(a)===
"[object "+b+"]"}function S(a){return typeof a=="object"}function q(a){return a===v}function la(a,b){var c;if(j.isArray(a))c=[];else if(!S(a)||a===l)return a;else c=a.keys?j.extended():{};C(a,function(d,e){c[d]=b===i&&(j.isObject(e)||j.isArray(e))?la(e,b):e});return c}function ma(a,b,c,d){var e=/^(.+?)(\[.*\])$/,f,h,g;if(d!==z&&(h=b.match(e))){g=h[1];b=h[2].replace(/^\[|\]$/g,"").split("][");p(b,function(k){f=!k||k.match(/^\d+$/);if(!g&&j.isArray(a))g=a.length;a[g]||(a[g]=f?[]:{});a=a[g];g=k});if(!g&&
f)g=a.length.toString();ma(a,g,c)}else a[b]=c.match(/^\d+$/)?parseInt(c):c==="true"?i:c==="false"?z:c}function $(a){var b=this;C(a,function(c,d){b[c]=d})}function ga(a){var b=a===j;p(["Array","Boolean","Date","Function","Number","String","RegExp"],function(c){s(a,"is"+c,function(d){return R(b?d:this,c)})})}function ha(a){p(["keys","values","each","merge","isEmpty","clone","equal","watch"],function(b){s(a,b=="equal"?"equals":b,function(){return j[b].apply(l,[this].concat(D(arguments)))})})}function p(a,
b,c,d,e){var f,h;T(b);h=isNaN(c)?0:parseInt(c>>0);for(f=d===i?a.length+h:a.length;h<f;){c=h%a.length;if(!(c in a)&&e===i)return Da(a,b,h,d);else if(b.call(a,a[c],c,a)===z)break;h++}}function H(a,b,c,d,e){var f,h;p(a,function(g,k,n){if(K(g,b,n,[k,n])){f=g;h=k;return z}},c,d);return e?h:f}function L(a,b){function c(e){return I(a,b,e)===d}var d;return a.reduce(function(e,f,h){d=I(a,b,f,h);if(e.none(b?c:f))e.push(f);return e},[])}function M(a){var b=[];p(a,function(c){if(w.isArray(c))b=b.concat(M(c));
else b.push(c)});return b}function T(a){if(!a||!a.call)throw new TypeError("Callback is not callable");}function U(a){if(a.length===0)throw new TypeError("First argument must be defined");}function Da(a,b,c){var d=[],e;for(e in a)e in a&&e>>>0==e&&e!=4294967295&&e>=c&&d.push(e.toNumber());d.sort().each(function(f){return b.call(a,a[f],f,a)});return a}function V(a,b,c,d){var e=c==="max",f=c==="min",h=e?-Infinity:Infinity,g=[];C(a,function(k){var n=a[k];k=I(a,b,n,d?k.toNumber():l);if(!q(k))if(k===h)g.push(n);
else if(e&&k>h||f&&k<h){g=[n];h=k}});return g}function x(a,b,c){c=Math[c||"round"];var d=Math.pow(10,(b||0).abs());if(b<0)d=1/d;return c(a*d)/d}function na(a,b,c,d){var e=[];a=parseInt(a);for(var f=d>0;f&&a<=b||!f&&a>=b;){e.push(a);c&&c.call(this,a);a+=d}return e}function Ea(a,b){function c(){return x(this*b)}function d(){return W(arguments)[f](this)}function e(){return W(arguments)[f](-this)}var f="add"+a.capitalize()+"s";s(y.prototype,a,c);s(y.prototype,a+"s",c);s(y.prototype,a+"Before",e);s(y.prototype,
a+"sBefore",e);s(y.prototype,a+"Ago",e);s(y.prototype,a+"sAgo",e);s(y.prototype,a+"After",d);s(y.prototype,a+"sAfter",d);s(y.prototype,a+"FromNow",d);s(y.prototype,a+"sFromNow",d)}function oa(a,b,c,d){var e=D(b).join("");e=e.replace(/all/,"").replace(/(\w)lphabet|umbers?|atakana|paces?|unctuation/g,"$1");return a.replace(c,function(f){return d[f]&&(!e||e.has(d[f].type))?d[f].to:f})}function E(a,b,c){pa[b]={type:a,to:c};qa[c]={type:a,to:b}}function N(a,b,c,d){var e=String(b);if(e!=b)e="";j.isNumber(c)||
...
b<d&&a.setDate(b)}}function W(a){var b;b=j.isNumber(a[1])?P(a)[0]:a[0];return ya(b,a[1]).h}function ea(a,b){var c="";if(b=="g"||a.global)c+="g";if(b=="i"||a.ignoreCase)c+="i";if(b=="m"||a.multiline)c+="m";if(b=="y"||a.B)c+="y";return c}function fa(a,b,c,d,e){if(!a.g)a.g=[];a.g.push(setTimeout(function(){a.g.removeAt(f);c.apply(d,e||[])},b));var f=a.g.length}var j=Object,w=Array,r=RegExp,m=Date,B=String,y=Number,v,ia=j.defineProperty&&j.defineProperties;ga(j);$.prototype.constructor=j;t(j,z,z,{extended:function(a){return new $(a)},
isObject:function(a){return a===l||q(a)?z:R(a,"Object")&&a.constructor===j},each:function(a,b){b&&C(a,function(c,d){b.call(a,c,d,a)});return a},merge:function(){var a=arguments[0];A(arguments,function(b){S(b)&&C(b,function(c,d){a[c]=d})},z);return a},isEmpty:function(a){if(!a)return i;return j.equal(a,{})},equal:function(a,b){return ja(a,b,[])},values:function(a,b){var c=[];C(a,function(d,e){c.push(e);b&&b.call(a,e)});return c},clone:la,fromQueryString:function(a,b){var c=j.extended();a=a&&a.toString?
a.toString():"";a.replace(/^.*?\?/,"").unescapeURL().split("&").each(function(d){d=d.split("=");d.length===2&&ma(c,d[0],d[1],b)});return c}});t(j,z,function(){return arguments.length<2},{keys:function(a,b){if(a===l||!S(a)&&!j.isRegExp(a)&&!j.isFunction(a))throw new TypeError("Object required");var c=[];C(a,function(d){c.push(d);b&&b.call(a,d)});return c}});t(w,z,z,{create:function(){var a=[];A(arguments,function(b){if(b&&b.callee)b=D(b);a=a.concat(b)});return a},isArray:function(a){return R(a,"Array")}});
t(w,i,function(){var a=arguments;return a.length===0||j.isFunction(a[0])},{every:function(a,b){var c=this.length,d=0;for(U(arguments);d<c;){if(d in this&&!K(this[d],a,b,[d,this]))return z;d++}return i},some:function(a,b){var c=this.length,d=0;for(U(arguments);d<c;){if(d in this&&K(this[d],a,b,[d,this]))return i;d++}return z},map:function(a,b){var c=this.length,d=0,e=Array(c);for(U(arguments);d<c;){if(d in this)e[d]=I(this,a,this[d],d,b);d++}return e},filter:function(a,b){var c=this.length,d=0,e=[];
...
r("<("+b+")[^<>]*(?:\\/>|>.*?<\\/\\1>)","gi");a=a.replace(b,"")});return a},truncate:function(a,b,c){var d;b=q(b)?"...":String(b);a-=b.length;if(this.length<=a)return this.toString();d=b.match(/^(.)\1+$/)?b.slice(0,1):"";for(d=r("[^"+G()+d+"]["+G()+d+"]");a>0&&!d.test(this.slice(a-1,a+1))&&c!==i;)a--;return this.slice(0,a)+(a>0?b:"")},assign:function(){var a=j.extended();A(arguments,function(b,c){if(j.isObject(b))a.merge(b);else a[c+1]=b});return this.replace(/\{(.+?)\}/g,function(b,c){return a[c]||
b})}});t(B,i,function(a){return!j.isRegExp(a)},{split:function(a,b){var c=[],d=0;a=r(a).addFlag("g");var e,f,h,g;r.n||(e=RegExp("^"+a.source+"$(?!\\s)",a.getFlags()));if(q(b)||+b<0)b=Infinity;else{b=(+b).floor();if(!b)return[]}for(;f=a.exec(this);){h=f.index+f[0].length;if(h>d){c.push(this.slice(d,f.index));!r.n&&f.length>1&&f[0].replace(e,function(){for(var k=1;k<arguments.length-2;k++)if(q(arguments[k]))f[k]=v});f.length>1&&f.index<this.length&&w.prototype.push.apply(c,f.slice(1));g=f[0].length;
...
wa="\u5341\u767e\u5343\u4e07",La=r("["+X+wa+"]","g"),za=[],xa,Y,Wa=[{src:"(\\d{4})",to:["year"]},{src:"([+-])?(\\d{4})[-.]?({month})[-.]?(\\d{1,2})?",to:["year_sign","year","month","date"]},{src:"(\\d{1,2})[-.\\/]({month})[-.\\/]?(\\d{2,4})?",to:["month","date","year"],l:i}],Na=[{c:"f{1,4}|ms|milliseconds",b:function(a){return a.getMilliseconds()}},{c:"ss?|seconds",b:function(a){return a.getSeconds()}},{c:"mm?|minutes",b:function(a){return a.getMinutes()}},{c:"hh?|hours|12hr",b:function(a){a=a.getHours(void 0);
...
f.length>b-2)){f.push([this,arguments]);c()}}var e=this,f=[],h=z,g,k;a=a||1;b=b||Infinity;g=a.ceil();k=x(g/a);return d},delay:function(a){j.isNumber(a)||(a=0);var b=D(arguments,1);fa(this,a,this,this,b);return this},debounce:function(a,b){var c=this;return b===z?this.lazy(a,1):function(){c.cancel();fa(c,a,c,this,arguments)}},cancel:function(){if(j.isArray(this.g))for(;this.g.length>0;)clearTimeout(this.g.shift());return this},after:function(a){var b=this,c=0;j.isNumber(a)||(a=1);return function(){c++;
...
function(){};var b=a.q();a=new b instanceof b&&!(new a instanceof b)}t(Function,i,!a,{bind:function(c){var d=this,e=D(arguments,1),f,h;if(!j.isFunction(this))throw new TypeError("Function.prototype.bind called on a non-function");h=function(){return d.apply(d.prototype&&this instanceof d?this:c,e.concat(D(arguments)))};f=function(){};f.prototype=this.prototype;h.prototype=new f;return h}})})()})();

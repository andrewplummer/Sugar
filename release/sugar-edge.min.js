...
function ga(a,b,c,d){var e=/^(.+?)(\[.*\])$/,f,h,g;if(d!==l&&(h=b.match(e))){g=h[1];b=h[2].replace(/^\[|\]$/g,"").split("][");I(b,function(k){f=!k||k.match(/^\d+$/);if(!g&&p.isArray(a))g=a.length;a[g]||(a[g]=f?[]:{});a=a[g];g=k});if(!g&&f)g=a.length.toString();ga(a,g,c)}else a[b]=c.match(/^[\d.]+$/)?parseFloat(c):c==="true"?i:c==="false"?l:c}function ha(a){var b=this;x(a,function(c,d){b[c]=d})}ha.prototype.constructor=p;
function da(a,b){var c={};I(a,function(d){c[d+(d==="equal"?"s":"")]=function(){return Object[d].apply(j,[this].concat(E(arguments)))}});w(b,i,l,c)}
w(p,l,l,{extended:function(a){return new ha(a)},isObject:function(a){return a===j||A(a)?l:B(a,"Object")&&a.constructor===p},isNaN:function(a){return p.isNumber(a)&&a.valueOf()!==a.valueOf()},each:function(a,b){b&&x(a,function(c,d){b.call(a,c,d,a)});return a},merge:function(a,b,c){return L(a,b,i,c)},isEmpty:function(a){if(!J(a)||a===j)return!(a&&a.length>0);return p.keys(a).length==0},equal:function(a,b){return ea(a,b,[])},values:function(a,b){var c=[];x(a,function(d,e){c.push(e);b&&b.call(a,e)});
return c},clone:function(a,b){if(!J(a)||a===j)return a;var c=Object.isFunction(a.keys)?Object.extended():{};return L(c,a,b)},fromQueryString:function(a,b){var c=p.extended();a=a&&a.toString?a.toString():"";a.replace(/^.*?\?/,"").unescapeURL().split("&").each(function(d){d=d.split("=");d.length===2&&ga(c,d[0],d[1],b)});return c},tap:function(a,b){D(a,b,a,[a]);return a}});
w(p,l,function(){return arguments.length<2},{keys:function(a,b){if(a===j||!J(a)&&!p.isRegExp(a)&&!p.isFunction(a))throw new TypeError("Object required");var c=[];x(a,function(d,e){c.push(d);b&&b.call(a,d,e)});return c}});function I(a,b,c,d,e){var f,h;ia(b);if(c<0)c=a.length+c;h=isNaN(c)?0:parseInt(c>>0);for(c=d===i?a.length+h:a.length;h<c;){f=h%a.length;if(!(f in a)&&e===i)return ja(a,b,h,d);else if(b.call(a,a[f],f,a)===l)break;h++}}
function z(a,b,c,d,e){var f,h;I(a,function(g,k,n){if(C(g,b,n,[k,n])){f=g;h=k;return l}},c,d);return e?h:f}function M(a,b){function c(e){return D(e,b,a,[e])===d}var d;return a.reduce(function(e,f,h){d=D(f,b,a,[f,h,a]);if(e.none(b?c:f))e.push(f);return e},[])}function G(a,b,c){b=b||Infinity;c=c||0;var d=[];I(a,function(e){if(p.isArray(e)&&c<b)d=d.concat(G(e,b,c+1));else d.push(e)});return d}
function N(a,b,c,d){var e=a.length,f=d==-1,h=f?e-1:0;c=isNaN(c)?h:parseInt(c>>0);if(c<0)c=e+c;if(!f&&c<0||f&&c>=e)c=h;for(;f&&c>=0||!f&&c<e;){if(a[c]===b)return c;c+=d}return-1}function ka(a,b,c,d){var e=a.length,f=0,h=K(c);ia(b);if(e==0&&!h)throw new TypeError("Reduce called on empty array with no initial value");else if(h)c=c;else{c=a[d?e-1:f];f++}for(;f<e;){h=d?e-f-1:f;if(h in a)c=b.call(void 0,c,a[h],h,a);f++}return c}
function ia(a){if(!a||!a.call)throw new TypeError("Callback is not callable");}function O(a){if(a.length===0)throw new TypeError("First argument must be defined");}function ja(a,b,c){var d=[],e;for(e in a)e in a&&e>>>0==e&&e!=4294967295&&e>=c&&d.push(e.toNumber());d.sort().each(function(f){return b.call(a,a[f],f,a)});return a}
function P(a,b,c,d){var e=c==="max",f=c==="min",h=e?-Infinity:Infinity,g=[];x(a,function(k){var n=a[k];k=D(n,b,a,d?[n,k.toNumber(),a]:[]);if(!A(k))if(k===h)g.push(n);else if(e&&k>h||f&&k<h){g=[n];h=k}});return g}w(q,l,l,{create:function(){var a=[];F(arguments,function(b){if(b&&b.callee)b=E(b);a=a.concat(b)});return a},isArray:function(a){return B(a,"Array")}});
...
w(q,i,l,{indexOf:function(a,b){if(p.isString(this))return this.indexOf(a,b);return N(this,a,b,1)},lastIndexOf:function(a,b){if(p.isString(this))return this.lastIndexOf(a,b);return N(this,a,b,-1)},forEach:function(a,b){var c=this.length,d=0;for(ia(a);d<c;){d in this&&a.call(b,this[d],d,this);d++}},reduce:function(a,b){return ka(this,a,b)},reduceRight:function(a,b){return ka(this,a,b,i)},each:function(a,b,c){I(this,a,b,c,i);return this},find:function(a,b,c){return z(this,a,b,c)},findAll:function(a,
b,c){var d=[];I(this,function(e,f,h){C(e,a,h,[f,h])&&d.push(e)},b,c);return d},findIndex:function(a,b,c){a=z(this,a,b,c,i);return K(a)?a:-1},count:function(a){if(A(a))return this.length;return this.findAll(a).length},none:function(){return!this.any.apply(this,arguments)},remove:function(){var a,b=this;F(arguments,function(c){for(a=0;a<b.length;)if(C(b[a],c,b,[a,b]))b.splice(a,1);else a++},l);return b},removeAt:function(a,b){if(A(a))return this;if(A(b))b=a;for(var c=0;c<=b-a;c++)this.splice(a,1);return this},
add:function(a,b){if(!p.isNumber(v(b))||isNaN(b)||b==-1)b=this.length;else if(b<-1)b+=1;q.prototype.splice.apply(this,[b,0].concat(a));return this},include:function(a,b){return this.clone().add(a,b)},exclude:function(){return q.prototype.remove.apply(this.clone(),arguments)},clone:function(){return this.concat()},unique:function(a){return M(this,a)},union:function(){var a=this;F(arguments,function(b){a=a.concat(b)});return M(a)},intersect:function(){var a=[],b=arguments;this.each(function(c){F(b,
function(d){p.isArray(d)||(d=[d]);A(z(a,c))&&K(z(d,c))&&a.push(c)})});return a},subtract:function(){var a=this.clone();F(arguments,function(b){p.isArray(b)||(b=[b]);b.each(function(c){a.remove(c)})});return a},at:function(){return fa(this,arguments)},first:function(a){if(A(a))return this[0];if(a<0)a=0;return this.slice(0,a)},last:function(a){if(A(a))return this[this.length-1];return this.slice(this.length-a<0?0:this.length-a)},from:function(a){return this.slice(a)},to:function(a){if(A(a))a=this.length;
return this.slice(0,a)},min:function(a){return M(P(this,a,"min",i))},max:function(a){return M(P(this,a,"max",i))},least:function(){var a=G(P(this.groupBy.apply(this,arguments),"length","min"));return a.length===this.length?[]:M(a)},most:function(){var a=G(P(this.groupBy.apply(this,arguments),"length","max"));return a.length===this.length?[]:M(a)},sum:function(a){a=a?this.map(a):this;return a.length>0?a.reduce(function(b,c){return b+c}):0},average:function(a){a=a?this.map(a):this;return a.length>0?
a.sum()/a.length:0},groupBy:function(a,b){var c=this,d=p.extended(),e;I(c,function(f,h){e=D(f,a,c,[f,h,c]);d[e]||(d[e]=[]);d[e].push(f)});return d.each(b)},inGroups:function(a,b){var c=arguments.length>1,d=this,e=[],f=(this.length/a).ceil();(0).upto(a-1,function(h){h=h*f;var g=d.slice(h,h+f);c&&g.length<f&&(f-g.length).times(function(){g=g.add(b)});e.push(g)});return e},inGroupsOf:function(a,b){if(this.length===0||a===0)return this;if(A(a))a=1;if(A(b))b=j;var c=[],d=j;this.each(function(e,f){if(f%
a===0){d&&c.push(d);d=[]}if(A(e))e=b;d.push(e)});if(!this.length.isMultipleOf(a)){(a-this.length%a).times(function(){d.push(b)});this.length+=a-this.length%a}d.length>0&&c.push(d);return c},compact:function(a){var b=[];I(this,function(c){if(p.isArray(c))b.push(c.compact());else if(a&&c)b.push(c);else if(!a&&K(c)&&c!==j&&(!p.isNumber(c)||!isNaN(c)))b.push(c)});return b},isEmpty:function(){return this.compact().length==0},flatten:function(a){return G(this,a)},sortBy:function(a,b){var c=this.clone();
c.sort(function(d,e){var f,h;f=D(d,a,c,[d]);h=D(e,a,c,[e]);return(f&&f.compare?f.compare(h):f<h)*(b?-1:1)});return c},randomize:function(){for(var a=this.concat(),b,c,d=a.length;d;b=parseInt(Math.random()*d),c=a[--d],a[d]=a[b],a[b]=c);return a},zip:function(){var a=E(arguments);return this.map(function(b,c){return[b].concat(a.map(function(d){return c in d?d[c]:j}))})},sample:function(a){var b=[],c=this.clone(),d;for(a>0||(a=1);b.length<a;){d=Number.random(0,c.length-1);b.push(c[d]);c.removeAt(d);
if(c.length==0)break}return arguments.length>0?b:b[0]}});w(q,i,l,{all:q.prototype.every,any:q.prototype.some,has:q.prototype.some,insert:q.prototype.add});function Q(a,b,c){c=Math[c||"round"];var d=Math.pow(10,(b||0).abs());if(b<0)d=1/d;return c(a*d)/d}function la(a,b,c,d){var e=[];a=parseInt(a);for(var f=d>0;f&&a<=b||!f&&a>=b;){e.push(a);c&&c.call(this,a);a+=d}return e}
w(v,l,l,{random:function(a,b){var c;if(arguments.length==1){b=a;a=0}c=Math.min(a||0,K(b)?b:1);return Q(Math.random()*(Math.max(a||0,K(b)?b:1)-c)+c)}});
w(v,i,l,{toNumber:function(){return parseFloat(this,10)},ceil:function(a){return Q(this,a,"ceil")},floor:function(a){return Q(this,a,"floor")},abs:function(){return Math.abs(this)},pow:function(a){if(A(a))a=1;return Math.pow(this,a)},round:function(a){return Q(this,a,"round")},chr:function(){return t.fromCharCode(this)},isOdd:function(){return!this.isMultipleOf(2)},isEven:function(){return this.isMultipleOf(2)},isMultipleOf:function(a){return this%a===0},upto:function(a,b,c){return la(this,a,b,c||
1)},downto:function(a,b,c){return la(this,a,b,-(c||1))},times:function(a){if(a)for(var b=0;b<this;b++)a.call(this,b);return this.toNumber()},ordinalize:function(){var a;if(this>=11&&this<=13)a="th";else switch(this%10){case 1:a="st";break;case 2:a="nd";break;case 3:a="rd";break;default:a="th"}return this.toString()+a},pad:function(a,b,c){c=c||10;c=this.toNumber()===0?"":this.toString(c).replace(/^-/,"");c=R(c,"0",a-c.replace(/\.\d+$/,"").length,0);if(b||this<0)c=(this<0?"-":"+")+c;return c},format:function(a,
...
/\b[a-z]/g:/^[a-z]/,function(b){return b.toUpperCase()})},pad:function(a,b){return R(this,a,b,b)},padLeft:function(a,b){return R(this,a,b,0)},padRight:function(a,b){return R(this,a,0,b)},repeat:function(a){var b="",c=0;if(p.isNumber(a)&&a>0)for(;c<a;){b+=this;c++}return b},each:function(a,b){if(p.isFunction(a)){b=a;a=/./g}else if(a)if(p.isString(a))a=r(r.escape(a),"gi");else{if(p.isRegExp(a))a=a.addFlag("g")}else a=/./g;var c=this.match(a)||[];if(b)for(var d=0;d<c.length;d++)c[d]=b.call(this,c[d],
...
function Ha(a){var b=s.addFormat,c=a.code;if(!a.q){b("("+a.months.compact().join("|")+")",["month"],c);b("("+a.weekdays.compact().join("|")+")",["weekday"],c);b("("+a.modifiers.filter(function(d){return d.name==="day"}).map("text").join("|")+")",["day"],c);I(a.formats,function(d){var e=[];d=d.replace(/\s+/g,"[-,. ]*");d=d.replace(/\{(.+?)\}/g,function(f,h){var g=h.match(/\?$/),k=h.match(/(\d)(?:-(\d))?/),n=h.match(/^\d+$/),o=h.replace(/[^a-z]+$/,""),u,H;if(o==="time"){e=e.concat(va);return g?xa:wa}if(n)u=
a.optionals[n[0]-1];else if(a[o])u=a[o];else if(a[o+"s"]){u=a[o+"s"];if(k){H=[];I(u,function(Oa,Pa){var ya=Pa%(a.units?8:u.length);if(ya>=k[1]&&ya<=(k[2]||k[1]))H.push(Oa)});u=H}u=u.compact().join("|")}if(n)return"(?:"+u+")?";else{e.push(o);return"("+u+")"+(g?"?":"")}});b(d,e,c)});a.q=i}}function Y(a,b,c){if(b&&(!p.isString(a)||!a))a=Date.currentLocale;a&&!Fa[a]&&Ia(a,c);return Fa[a]}
function Ia(a,b){function c(f,h){f=f.split("+").map(function(g){return g.replace(/(.+):(.+)$/,function(k,n,o){return o.split("|").map(function(u){return n+u}).join("|")})}).join("|");return I(f.split("|"),h)}function d(f,h,g){var k=[];if(b[f]){I(b[f],function(n,o){c(n,function(u,H){k[H*g+o]=u.toLowerCase()})});if(h)k=k.concat(b[f].map(function(n){return n.slice(0,3).toLowerCase()}));return b[f]=k}}function e(f,h){var g="[0-9\uff10-\uff19]"+(f?"{"+f+","+h+"}":"+");if(b.digits)g+="|["+b.digits+"]+";
return g}b=b||Ja(a);if(!b)throw Error("Invalid locale.");d("months",i,12);d("weekdays",i,7);d("units",l,8);d("numbers",l,10);b.code=a;b.date=e(1,2);b.year=e(4,4);b.num=function(){var f=[e()].concat(b.articles);b.digits||(f=f.concat(b.numbers));return f.compact().join("|")}();(function(){var f=[];b.i={};I(b.modifiers,function(h){c(h.text,function(g){b.i[g]=h;f.push({name:h.name,text:g,value:h.value})})});f.groupBy("name",function(h,g){g=g.map("text");if(h==="day")g=g.concat(b.weekdays);b[h]=g.join("|")});
b.modifiers=f})();if(b.monthSuffix){b.month=e(1,2);b.months=(1).upto(12).map(function(f){return f+b.monthSuffix})}Fa[a]=new Ka(b)}
function Ja(a){function b(e){return!!(d[0]&Math.pow(2,e-1))}if(a.slice(0,3)=="en-")a="en";if(!Ga[a])return j;var c={modifiers:[]},d=Ga[a].split(";");I(["months","weekdays","units","numbers","articles","optionals","formats"],function(e,f){c[e]=d[f+2]?d[f+2].split(","):[]});c.outputFormat=d[9];I(["day","sign","shift","edge"],function(e,f){d[f+10]&&I(d[f+10].split(","),function(h,g){h&&c.modifiers.push({name:e,text:h,value:g-2})})});if(b(1)){c.digits=V+za;if(c.numbers.length>0)c.digits+=c.numbers.join("");
...
"week"){g=(b.day||0)+g*7;f="Date"}g=g*e+a["get"+f](void 0)}a["set"+(d?"UTC":"")+f](g);h==="month"&&g%12!=a.getMonth()&&a.setDate(0)}});return a}function Sa(a){var b;a=a.millisecondsFromNow();var c=a.abs(),d=c,e=0;I(W.from(1),function(f,h){b=Q(c/f.e(),1).floor();if(b>=1){d=b;e=h+1}});return[d,e,a]}function S(a){var b;b=p.isNumber(a[1])?Z(a)[0]:a[0];return Qa(b,a[1]).h}
w(s,l,l,{create:function(){return S(arguments)},now:function(){return(new s).getTime()},setLocale:function(a,b){var c=Y(a,l,b);if(c){Date.currentLocale=a;Ha(c);return c}},getLocale:function(a){return Y(a,i)},addFormat:function(a,b,c,d){Ba.push({k:d,u:c,v:r("^"+a+"$","i"),to:b})}});
...
E(arguments);I(b,function(d,e){if(K(d)||e>=c.length)c.splice(e,0,d)});return a.apply(this,c)}}});(function(){var a={};I(["Array","Boolean","Date","Function","Number","String","RegExp"],function(b){a["is"+b]=function(c){return B(c,b)}});w(Object,l,l,a)})();da(["keys","values","each","merge","isEmpty","clone","equal","watch","tap"],ha);w(p,l,i,{watch:function(a,b,c){if(aa){var d=a[b];p.defineProperty(a,b,{get:function(){return d},set:function(e){d=c.call(a,b,d,e)},enumerable:i,configurable:i})}}});
...
(function(){var a;I(oa,function(b){b.start.upto(b.end,function(c){U(b.type,c.chr(),(c+b.shift).chr())})});"\u30a2\u30a4\u30a6\u30a8\u30aa\u30a1\u30a3\u30a5\u30a7\u30a9\u30ab\u30ad\u30af\u30b1\u30b3\u30b5\u30b7\u30b9\u30bb\u30bd\u30bf\u30c1\u30c4\u30c3\u30c6\u30c8\u30ca\u30cb\u30cc\u30cd\u30ce\u30cf\u30d2\u30d5\u30d8\u30db\u30de\u30df\u30e0\u30e1\u30e2\u30e4\u30e3\u30e6\u30e5\u30e8\u30e7\u30e9\u30ea\u30eb\u30ec\u30ed\u30ef\u30f2\u30f3\u30fc\u30fb".each(function(b,c){a="\uff71\uff72\uff73\uff74\uff75\uff67\uff68\uff69\uff6a\uff6b\uff76\uff77\uff78\uff79\uff7a\uff7b\uff7c\uff7d\uff7e\uff7f\uff80\uff81\uff82\uff6f\uff83\uff84\uff85\uff86\uff87\uff88\uff89\uff8a\uff8b\uff8c\uff8d\uff8e\uff8f\uff90\uff91\uff92\uff93\uff94\uff6c\uff95\uff6d\uff96\uff6e\uff97\uff98\uff99\uff9a\uff9b\uff9c\uff66\uff9d\uff70\uff65".charAt(c);
U("k",a,b);b.match(ta)&&U("k",a+"\uff9e",b.shift(1));b.match(ua)&&U("k",a+"\uff9f",b.shift(2))});"\u3002\u3001\u300c\u300d\uffe5\uffe0\uffe1".each(function(b,c){U("p","\uff61\uff64\uff62\uff63\u00a5\u00a2\u00a3".charAt(c),b)});U("k","\uff73\uff9e","\u30f4");U("k","\uff66\uff9e","\u30fa");U("s"," ","\u3000")})();

...
b,c){return P(this,a,b,c)},ordinalize:function(){var a=this.abs();a=parseInt(a.toString().slice(-2));return this+ua(a)},toNumber:function(){return parseFloat(this,10)},bound:function(a,b){if(K(a))a=-Infinity;if(K(b))b=Infinity;if(a>b)return NaN;return v.max(a,Math.min(this,b))},cap:function(a){return this.Fa(-Infinity,a)}});G(u,k,n,"round,floor,ceil",function(a,b){a[b]=function(c){return N(this,c,b)}});

...
function y(a){var b,c;if(a==="String"||a==="Number"||a==="Boolean")b=a.toLowerCase();c=a==="Array"&&q.isArray||function(d){if(b&&typeof d===b)return k;return p.prototype.toString.call(d)==="[object "+a+"]"};return ca[a]=c}
...
function I(a,b,c,d,e){var f={};d=C(d)?d.split(","):d;d.forEach(function(h,i){e(f,h,i)});F(a,b,c,f)}function ia(a,b,c){var d=b.length===0,e=K(b),f=n;G(a.SugarMethods,function(h,i){if(d||e.indexOf(h)>-1){f=k;c(i.xa?a.prototype:a,h,i)}});return f}function ja(a,b,c){return function(){return a&&(c===k||!c.apply(this,arguments))?a.apply(this,arguments):b.apply(this,arguments)}}function E(a,b,c){if(da)p.defineProperty(a,b,{value:c,configurable:k,enumerable:n,writable:k});else a[b]=c}
...
function va(a,b){var c=a.toString().match(/[^/]*$/)[0];if(b)c=(c+b).split("").sort().join("").replace(/([gimy])\1+/g,"$1");return c}function Q(a){C(a)||(a=t(a));return a.replace(/([\\/'*+?|()\[\]{}.^$])/g,"\\$1")}
...
function xa(a){var b=p.prototype.toString.call(a);return b==="[object Date]"||b==="[object Array]"||b==="[object String]"||b==="[object Number]"||b==="[object RegExp]"||b==="[object Boolean]"||b==="[object Arguments]"||na(a)}function ya(a,b,c){var d=[],e=a.length,f=b[b.length-1]!==n,h;K(b,function(i){if(fa(i))return n;if(f){i%=e;if(i<0)i=e+i}h=c?a.charAt(i)||"":a[i];d.push(h)});return d.length<2?d[0]:d}
function za(a,b){I(b,k,n,a,function(c,d){c[d+(d==="equal"?"s":"")]=function(){return p[d].apply(l,[this].concat(K(arguments)))}})}ha(p);G(w,function(a,b){ha(ba[b])});
F(p,n,n,{keys:function(a){var b=[];if(!ma(a)&&!D(a)&&!A(a))throw new TypeError("Object required");G(a,function(c){b.push(c)});return b}});
...
function Ca(a){if(a.length===0)throw new TypeError("First argument must be defined");}F(q,n,n,{isArray:function(a){return ea(a)}});
...
{},c;a=a||"hours";if(a==="date")a="days";c=jb.some(function(d){return a===d.$||a===d.$+"s"});b[a]=a.match(/^days?/)?1:0;return c?this.set(b,k):this},clone:function(){var a=new s(this.getTime());a.utc(this.isUTC());return a}});s.extend({iso:function(){return this.toISOString()},getWeekday:s.prototype.getDay,getUTCWeekday:s.prototype.getUTCDay});
...
function Ib(a,b,c,d,e){var f;if(!a.timers)a.timers=[];B(b)||(b=0);a.timers.push(setTimeout(function(){a.timers.splice(f,1);c.apply(d,e||[])},b));f=a.timers.length}
F(Function,k,n,{lazy:function(a,b){function c(){if(!(f&&e.length>b-2)){e.push([this,arguments]);h()}}var d=this,e=[],f=n,h,i,j;a=a||1;b=b||Infinity;i=O(a,void 0,"ceil");j=O(i/a);h=function(){if(!(f||e.length==0)){for(var g=v.max(e.length-j,0);e.length>g;)Function.prototype.apply.apply(d,e.shift());Ib(c,i,function(){f=n;h()});f=k}};return c},delay:function(a){var b=K(arguments).slice(1);Ib(this,a,this,this,b);return this},throttle:function(a){return this.lazy(a,1)},debounce:function(a){function b(){b.cancel();
Ib(b,a,c,this,arguments)}var c=this;return b},cancel:function(){if(ea(this.timers))for(;this.timers.length>0;)clearTimeout(this.timers.shift());return this},after:function(a){var b=this,c=0,d=[];if(B(a)){if(a===0){b.call();return b}}else a=1;return function(){var e;d.push(K(arguments));c++;if(c==a){e=b.call(this,d);c=0;d=[];return e}}},once:function(){var a=this;return function(){return H(a,"memo")?a.memo:a.memo=a.apply(this,arguments)}},fill:function(){var a=this,b=K(arguments);return function(){var c=
K(arguments);b.forEach(function(d,e){if(d!=l||e>=c.length)c.splice(e,0,d)});return a.apply(this,c)}}});
...
f}return a},values:function(a,b){var c=[];G(a,function(d,e){c.push(e);b&&b.call(a,e)});return c},clone:function(a,b){var c;if(!ma(a))return a;c=a instanceof pa?new pa:new a.constructor;return p.merge(c,a,b)},fromQueryString:function(a,b){var c=p.extended();a=a&&a.toString?a.toString():"";a.replace(/^.*?\?/,"").split("&").forEach(function(d){d=d.split("=");d.length===2&&Mb(c,d[0],decodeURIComponent(d[1]),b)});return c},tap:function(a,b){var c=b;A(b)||(c=function(){b&&a[b]()});c.call(a,a);return a},
has:function(a,b){return H(a,b)},select:function(a){return Nb(a,arguments,k)},reject:function(a){return Nb(a,arguments,n)}});I(p,n,n,w,function(a,b){var c="is"+b;Kb.push(c);a[c]=ca[b]});(function(){F(p,n,function(){return arguments.length===0},{extend:function(){var a=Kb.concat(Lb);if(typeof $a!=="undefined")a=a.concat($a);za(a,p)}})})();za(Lb,pa);
...
if(a===undefined)a="-";if(b.normalize)b=b.normalize();b=b.replace(/[^a-z0-9\-_]+/gi,a);if(a)b=b.replace(new r("^{sep}+|{sep}+$|({sep}){sep}+".assign({sep:Q(a)}),"g"),"$1");return encodeURI(b.toLowerCase())}});t.Inflector=Z;t.Inflector.acronyms=Tb;

...
b,c){return P(this,a,b,c)},ordinalize:function(){var a=this.abs();a=parseInt(a.toString().slice(-2));return this+ua(a)},toNumber:function(){return parseFloat(this,10)},bound:function(a,b){if(K(a))a=-Infinity;if(K(b))b=Infinity;if(a>b)return NaN;return v.max(a,Math.min(this,b))},cap:function(a){if(K(a))a=Infinity;return Math.min(this,a)}});G(u,k,n,"round,floor,ceil",function(a,b){a[b]=function(c){return N(this,c,b)}});
G(u,k,n,"abs,pow,sin,asin,cos,acos,tan,atan,exp,pow,sqrt",function(a,b){a[b]=function(c,d){return v[b](this,c,d)}});

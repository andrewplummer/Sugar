...
var Kb="isObject,isNaN".split(","),Lb="keys,values,select,reject,each,merge,clone,equal,watch,tap,has,toQueryString".split(",");
function Mb(a,b,c,d){var e=/^(.+?)(\[.*\])$/,f,h,i;if(d!==n&&(h=b.match(e))){i=h[1];b=h[2].replace(/^\[|\]$/g,"").split("][");b.forEach(function(j){f=!j||j.match(/^\d+$/);if(!i&&ea(a))i=a.length;H(a,i)||(a[i]=f?[]:{});a=a[i];i=j});if(!i&&f)i=a.length.toString();Mb(a,i,c)}else a[b]=c.match(/^[+-]?\d+(\.\d+)?$/)?parseFloat(c):c==="true"?k:c==="false"?n:c}
function Nb(a,b){var c;if(ma(b)&&!D(b)){c=[];G(b,function(d,e){if(a)d=a+"["+d+"]";c.push(Nb(d,e))});return c.join("&")}else return Ob(a)+"="+Ob(b)}function Ob(a){return!a&&a!==n&&a!==0?"":encodeURIComponent(a).replace(/%20/g,"+")}function Pb(a,b,c){var d={},e;G(a,function(f,h){e=n;ka(b,function(i){if(D(i)?i.test(f):ma(i)?H(i,f):f===t(i))e=k},1);if(e===c)d[f]=h});return d}
...
f}return a},values:function(a,b){var c=[];G(a,function(d,e){c.push(e);b&&b.call(a,e)});return c},clone:function(a,b){var c;if(ga(a)&&a.clone)return a.clone();else if(ma(a))c=a instanceof pa?new pa:new a.constructor;else return a;return p.merge(c,a,b)},fromQueryString:function(a,b){var c=p.extended();a=a&&a.toString?a.toString():"";a.replace(/^.*?\?/,"").split("&").forEach(function(d){d=d.split("=");d.length===2&&Mb(c,d[0],decodeURIComponent(d[1]),b)});return c},toQueryString:function(a,b){return Nb(b,
p(a))},tap:function(a,b){var c=b;A(b)||(c=function(){b&&a[b]()});c.call(a,a);return a},has:function(a,b){return H(a,b)},select:function(a){return Pb(a,arguments,k)},reject:function(a){return Pb(a,arguments,n)}});I(p,n,n,w,function(a,b){var c="is"+b;Kb.push(c);a[c]=ca[b]});(function(){F(p,n,function(){return arguments.length===0},{extend:function(){var a=Kb.concat(Lb);if(typeof $a!=="undefined")a=a.concat($a);za(a,p)}})})();za(Lb,pa);
...
(function(a){if(this.btoa){Qb=this.btoa;Rb=this.atob}else{var b=/[^A-Za-z0-9\+\/\=]/g;Qb=function(c){var d="",e,f,h,i,j,g,m=0;do{e=c.charCodeAt(m++);f=c.charCodeAt(m++);h=c.charCodeAt(m++);i=e>>2;e=(e&3)<<4|f>>4;j=(f&15)<<2|h>>6;g=h&63;if(isNaN(f))j=g=64;else if(isNaN(h))g=64;d=d+a.charAt(i)+a.charAt(e)+a.charAt(j)+a.charAt(g)}while(m<c.length);return d};Rb=function(c){var d="",e,f,h,i,j,g=0;if(c.match(b))throw Error("String contains invalid base64 characters");c=c.replace(/[^A-Za-z0-9\+\/\=]/g,"");
...
var Sb=[],Tb=[],Y=[],Ub=[],Vb={},Wb,Z;function Xb(a,b){var c=a.indexOf(b);c>-1&&a.splice(c,1)}
function Yb(a,b,c){C(b)&&Xb(Y,b);Xb(Y,c);a.unshift({ka:b,pa:c})}function Zb(a,b){return a==b||a=="all"||!a}function $b(a){return Y.some(function(b){return(new r("\\b"+b+"$","i")).test(a)})}function ac(a,b){a=C(a)?a.toString():"";return a.isBlank()||$b(a)?a:bc(a,b?Sb:Tb)}function bc(a,b){G(b,function(c,d){if(a.match(d.ka)){a=a.replace(d.ka,d.pa);return n}});return a}function cc(a){return a.replace(/^\W*[a-z]/,function(b){return b.toUpperCase()})}
Z={acronym:function(a){Vb[a.toLowerCase()]=a;a=p.keys(Vb).map(function(b){return Vb[b]});Z.acronymRegExp=r(a.join("|"),"g")},plural:function(a,b){Yb(Sb,a,b)},singular:function(a,b){Yb(Tb,a,b)},irregular:function(a,b){var c=a.first(),d=a.from(1),e=b.first(),f=b.from(1),h=e.toUpperCase(),i=e.toLowerCase(),j=c.toUpperCase(),g=c.toLowerCase();Xb(Y,a);Xb(Y,b);if(j==h){Z.plural(new r("({1}){2}$".assign(c,d),"i"),"$1"+f);Z.plural(new r("({1}){2}$".assign(e,f),"i"),"$1"+f);Z.singular(new r("({1}){2}$".assign(e,
f),"i"),"$1"+d)}else{Z.plural(new r("{1}{2}$".assign(j,d)),h+f);Z.plural(new r("{1}{2}$".assign(g,d)),i+f);Z.plural(new r("{1}{2}$".assign(h,f)),h+f);Z.plural(new r("{1}{2}$".assign(i,f)),i+f);Z.singular(new r("{1}{2}$".assign(h,f)),j+d);Z.singular(new r("{1}{2}$".assign(i,f)),g+d)}},uncountable:function(a){var b=q.isArray(a)?a:K(arguments);Y=Y.concat(b)},human:function(a,b){Ub.unshift({ka:a,pa:b})},clear:function(a){if(Zb(a,"singulars"))Tb=[];if(Zb(a,"plurals"))Sb=[];if(Zb(a,"uncountables"))Y=[];
if(Zb(a,"humans"))Ub=[];if(Zb(a,"acronyms"))Vb={}}};Wb=["and","or","nor","a","an","the","so","but","to","of","at","by","from","into","on","onto","off","out","in","over","with","for"];Z.plural(/$/,"s");Z.plural(/s$/gi,"s");Z.plural(/(ax|test)is$/gi,"$1es");Z.plural(/(octop|vir|fung|foc|radi|alumn)(i|us)$/gi,"$1i");Z.plural(/(census|alias|status)$/gi,"$1es");Z.plural(/(bu)s$/gi,"$1ses");Z.plural(/(buffal|tomat)o$/gi,"$1oes");Z.plural(/([ti])um$/gi,"$1a");Z.plural(/([ti])a$/gi,"$1a");
...
F(t,k,n,{pluralize:function(){return ac(this,k)},singularize:function(){return ac(this,n)},humanize:function(){var a=bc(this,Ub),b;a=a.replace(/_id$/g,"");a=a.replace(/(_)?([a-z\d]*)/gi,function(c,d,e){b=H(Vb,e)?Vb[e]:l;return(d?" ":"")+(b||e.toLowerCase())});return cc(a)},titleize:function(){var a=/[.:;!]$/,b,c,d;return this.spacify().humanize().words(function(e,f,h){b=a.test(e);d=f==0||f==h.length-1||b||c;c=b;return d||Wb.indexOf(e)===-1?cc(e):e}).join(" ")},parameterize:function(a){var b=this;
if(a===undefined)a="-";if(b.normalize)b=b.normalize();b=b.replace(/[^a-z0-9\-_]+/gi,a);if(a)b=b.replace(new r("^{sep}+|{sep}+$|({sep}){sep}+".assign({sep:R(a)}),"g"),"$1");return encodeURI(b.toLowerCase())}});t.Inflector=Z;t.Inflector.acronyms=Vb;
var dc,fc="",gc,hc=[{type:"a",shift:65248,start:65,end:90},{type:"a",shift:65248,start:97,end:122},{type:"n",shift:65248,start:48,end:57},{type:"p",shift:65248,start:33,end:47},{type:"p",shift:65248,start:58,end:64},{type:"p",shift:65248,start:91,end:96},{type:"p",shift:65248,start:123,end:126}],ic,jc=/[\u0020-\u00A5]|[\uFF61-\uFF9F][\uff9e\uff9f]?/g,kc=/[\u3000-\u301C]|[\u301A-\u30FC]|[\uFF01-\uFF60]|[\uFFE0-\uFFE6]/g,lc="\uff61\uff64\uff62\uff63\u00a5\u00a2\u00a3",mc="\u3002\u3001\u300c\u300d\uffe5\uffe0\uffe1",
nc=/[\u30ab\u30ad\u30af\u30b1\u30b3\u30b5\u30b7\u30b9\u30bb\u30bd\u30bf\u30c1\u30c4\u30c6\u30c8\u30cf\u30d2\u30d5\u30d8\u30db]/,oc=/[\u30cf\u30d2\u30d5\u30d8\u30db\u30f2]/,pc="\uff71\uff72\uff73\uff74\uff75\uff67\uff68\uff69\uff6a\uff6b\uff76\uff77\uff78\uff79\uff7a\uff7b\uff7c\uff7d\uff7e\uff7f\uff80\uff81\uff82\uff6f\uff83\uff84\uff85\uff86\uff87\uff88\uff89\uff8a\uff8b\uff8c\uff8d\uff8e\uff8f\uff90\uff91\uff92\uff93\uff94\uff6c\uff95\uff6d\uff96\uff6e\uff97\uff98\uff99\uff9a\uff9b\uff9c\uff66\uff9d\uff70\uff65",
qc="\u30a2\u30a4\u30a6\u30a8\u30aa\u30a1\u30a3\u30a5\u30a7\u30a9\u30ab\u30ad\u30af\u30b1\u30b3\u30b5\u30b7\u30b9\u30bb\u30bd\u30bf\u30c1\u30c4\u30c3\u30c6\u30c8\u30ca\u30cb\u30cc\u30cd\u30ce\u30cf\u30d2\u30d5\u30d8\u30db\u30de\u30df\u30e0\u30e1\u30e2\u30e4\u30e3\u30e6\u30e5\u30e8\u30e7\u30e9\u30ea\u30eb\u30ec\u30ed\u30ef\u30f2\u30f3\u30fc\u30fb";
function rc(a,b,c,d){ic||sc();var e=K(b).join(""),f=ic[d];e=e.replace(/all/,"").replace(/(\w)lphabet|umbers?|atakana|paces?|unctuation/g,"$1");return a.replace(c,function(h){return f[h]&&(!e||e.has(f[h].type))?f[h].to:h})}
function sc(){var a;ic={zenkaku:{},hankaku:{}};hc.forEach(function(b){qa(b.start,b.end,function(c){$(b.type,t.fromCharCode(c),t.fromCharCode(c+b.shift))})});qc.each(function(b,c){a=pc.charAt(c);$("k",a,b);b.match(nc)&&$("k",a+"\uff9e",b.shift(1));b.match(oc)&&$("k",a+"\uff9f",b.shift(2))});mc.each(function(b,c){$("p",lc.charAt(c),b)});$("k","\uff73\uff9e","\u30f4");$("k","\uff66\uff9e","\u30fa");$("s"," ","\u3000")}function $(a,b,c){ic.zenkaku[b]={type:a,to:c};ic.hankaku[c]={type:a,to:b}}
function tc(){dc={};G(gc,function(a,b){b.split("").forEach(function(c){dc[c]=a});fc+=b});fc=r("["+fc+"]","g")}
gc={A:"A\u24b6\uff21\u00c0\u00c1\u00c2\u1ea6\u1ea4\u1eaa\u1ea8\u00c3\u0100\u0102\u1eb0\u1eae\u1eb4\u1eb2\u0226\u01e0\u00c4\u01de\u1ea2\u00c5\u01fa\u01cd\u0200\u0202\u1ea0\u1eac\u1eb6\u1e00\u0104\u023a\u2c6f",B:"B\u24b7\uff22\u1e02\u1e04\u1e06\u0243\u0182\u0181",C:"C\u24b8\uff23\u0106\u0108\u010a\u010c\u00c7\u1e08\u0187\u023b\ua73e",D:"D\u24b9\uff24\u1e0a\u010e\u1e0c\u1e10\u1e12\u1e0e\u0110\u018b\u018a\u0189\ua779",E:"E\u24ba\uff25\u00c8\u00c9\u00ca\u1ec0\u1ebe\u1ec4\u1ec2\u1ebc\u0112\u1e14\u1e16\u0114\u0116\u00cb\u1eba\u011a\u0204\u0206\u1eb8\u1ec6\u0228\u1e1c\u0118\u1e18\u1e1a\u0190\u018e",
...
F(t,k,n,{normalize:function(){dc||tc();return this.replace(fc,function(a){return dc[a]})},hankaku:function(){return rc(this,arguments,kc,"hankaku")},zenkaku:function(){return rc(this,arguments,jc,"zenkaku")},hiragana:function(a){var b=this;if(a!==n)b=b.zenkaku("k");return b.replace(/[\u30A1-\u30F6]/g,function(c){return c.shift(-96)})},katakana:function(){return this.replace(/[\u3041-\u3096]/g,function(a){return a.shift(96)})}});

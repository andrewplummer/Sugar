...
q(n,{keys:function(a){var b=[];if(!L(a)&&!Ca(a)&&!K(a))throw new TypeError("Object required");r(a,function(a){b.push(a)});return b}},!1,!0);function lb(a,b,c,d){var e=a.length,f=-1==d,g=f?e-1:0;c=isNaN(c)?g:parseInt(c>>0);0>c&&(c=e+c);if(!f&&0>c||f&&c>=e)c=g;for(;f&&0<=c||!f&&c<e;){if(a[c]===b)return c;c+=d}return-1}
...
pb=!!qb.toISOString&&"2000-01-01T00:00:00.000Z"===qb.toISOString();Ea(y,"toISOString,toJSON",function(a,b){a[b]=function(){return R(this.getUTCFullYear(),4)+"-"+R(this.getUTCMonth()+1,2)+"-"+R(this.getUTCDate(),2)+"T"+R(this.getUTCHours(),2)+":"+R(this.getUTCMinutes(),2)+":"+R(this.getUTCSeconds(),2)+"."+R(this.getUTCMilliseconds(),3)+"Z"}},!0,!0,!pb);
...
function Cb(a,b,c,d){var e=[],f;0<a.length&&(f=wb(b),U(a,function(a,b,c){f(a,b,c)&&e.push(a)},c,d));return e}function Db(a,b,c){if(!H(A(c))||isNaN(c))c=a.length;v.prototype.splice.apply(a,[c,0].concat(b));return a}function Eb(a,b){M(b,function(b){var d=0;for(b=wb(b);d<a.length;)b(a[d],d,a)?a.splice(d,1):d++});return a}function Fb(a,b){var c=[],d={},e;U(a,function(f,g){e=b?T(f,b,a,[f,g,a]):f;Gb(d,e)||c.push(f)});return c}
function Hb(a,b,c){var d=[],e={};U(b,function(a){Gb(e,a)});U(a,function(a){var b=db(a),h=!fb(a);if(Ib(e,b,a,h)!==c){var m=0;if(h)for(b=e[b];m<b.length;)b[m]===a?b.splice(m,1):m+=1;else delete e[b];d.push(a)}});return d}function Jb(a,b,c){b=b||Infinity;c=c||0;var d=[];U(a,function(a){J(a)&&c<b?d=d.concat(Jb(a,b,c+1)):d.push(a)});return d}function Kb(a,b,c){var d={},e;U(a,function(c,g){e=T(c,b,a,[c,g,a]);d[e]||(d[e]=[]);d[e].push(c)});c&&r(d,c);return d}
function Lb(a,b){b&&(a=F.map(a,b));return 0<a.length?a.reduce(function(a,b){return a+b}):0}function Mb(a,b){var c=[];U(a,function(a){J(a)?c.push(Mb(a)):b&&a?c.push(a):b||null==a||a.valueOf()!==a.valueOf()||c.push(a)});return c}function Nb(a){a=La([],a);for(var b=a.length,c,d;b;)c=E.random()*b|0,d=a[--b],a[b]=a[c],a[c]=d;return a}function Ob(a){var b=[];M(a,function(a){b=b.concat(a)});return b}function Ib(a,b,c,d){var e=u(a,b);d&&(a[b]||(a[b]=[]),e=-1!==a[b].indexOf(c));return e}
function Gb(a,b){var c=db(b),d=!fb(b),e=Ib(a,c,b,d);d?a[c].push(b):a[c]=b;return e}function Pb(a,b,c,d){var e,f,g,h=[],m="max"===c,p="min"===c,w=v.isArray(a);for(e in a)if(a.hasOwnProperty(e)){c=a[e];g=T(c,b,a,w?[c,parseInt(e),a]:[]);if(O(g))throw new TypeError("Cannot compare with undefined");if(g===f)h.push(c);else if(O(f)||m&&g>f||p&&g<f)h=[c],f=g}w||(h=Jb(h,1));return d?h:h[0]}
...
q(v,{find:function(a){var b=arguments[1];Ia(a);return Bb(this,a,0,!1,!1,b)},findIndex:function(a){var b;b=arguments[1];Ia(a);b=Bb(this,a,0,!1,!0,b);return O(b)?-1:b}},!0,!0);
q(v,{findFrom:function(a,b,c){return Bb(this,a,b,c)},findIndexFrom:function(a,b,c){b=Bb(this,a,b,c,!0);return O(b)?-1:b},findAll:function(a,b,c){return Cb(this,a,b,c)},count:function(a){return O(a)?this.length:Cb(this,a).length},removeAt:function(a,b){if(O(a))return this;O(b)&&(b=a);this.splice(a,b-a+1);return this},include:function(a,b){return Db(La([],this),a,b)},exclude:function(){return Eb(La([],this),arguments)},clone:function(){return La([],this)},unique:function(a){return Fb(this,a)},flatten:function(a){return Jb(this,
...
function Wb(a,b){Ea(n,a,function(a,d){var e=F[d].method;a[d]=function(a,c,d){var m=n.keys(Ma(a)),p;b||(p=wb(c,!0));d=e.call(m,function(d){var e=a[d];return b?T(e,c,a,[d,e,a]):p(e,d,a)},d);J(d)&&(d=d.reduce(function(b,c){b[c]=a[c];return b},{}));return d}},!1);ib(a,Na)}
...
function qc(a,b){return b.replace(x(a.num,"g"),function(b){return rc(a,b)||""})}function rc(a,b){var c;return H(b)?b:b&&-1!==(c=a.numbers.indexOf(b))?(c+1)%10:1}function X(a,b){var c;I(a)||(a="");c=ic[a]||ic[a.slice(0,2)];if(!1===b&&!c)throw new TypeError("Invalid locale.");return c||Xb}
...
[a,!0])})}var p,w,C,B,s,k,D,ra,la,Aa,na;p=tc();B=[];vc(p,d);Ba(a)?vc(p,!!a._utc||0===a.getTimezoneOffset()).setTime(a.getTime()):H(a)||null===a?p.setTime(a):L(a)?(Bc(p,[a,!0]),k=a):I(a)&&(C=X(b),a=Hc(a),C&&r(C.cachedFormat?[C.cachedFormat].concat(C.compiledFormats):C.compiledFormats,function(c,d){var f=a.match(d.reg);if(f){s=d.locale;k=Gc(f,d.to);s.cachedFormat=d;k.utc&&vc(p,!0);if(k.timestamp)return k=k.timestamp,!1;d.variant&&!I(k.month)&&(I(k.date)||pc(C,b))&&(na=k.month,k.month=k.date,k.date=
...
(k.hour=0);if("offset_hours"in k||"offset_minutes"in k)vc(p,!0),k.offset_minutes=k.offset_minutes||0,k.offset_minutes+=60*k.offset_hours,"-"===k.offset_sign&&(k.offset_minutes*=-1),k.minute-=k.offset_minutes;k.unit&&(w=!0,Aa=rc(s,k.num),ra=s.units.indexOf(k.unit)%8,D=V.units[ra],m(),k.shift&&(Aa*=(na=s.modifiersByName[k.shift])?na.value:0),k.sign&&(na=s.modifiersByName[k.sign])&&(Aa*=na.value),N(k.weekday)&&(Bc(p,[{weekday:k.weekday},!0]),delete k.weekday),k[D]=(k[D]||0)+Aa);k.edge&&e(h);"-"===k.year_sign&&
...
Ea(y,"short,long,full",function(a,b){a[b]=function(a){return Sc(this,b,!1,a)}});"\u3007\u4e00\u4e8c\u4e09\u56db\u4e94\u516d\u4e03\u516b\u4e5d\u5341\u767e\u5343\u4e07".split("").forEach(function(a,b){9<b&&(b=Pa(10,b-9));Zb[a]=b});La(Zb,Va);$b=x("([\u671f\u9031\u5468])?([\u3007\u4e00\u4e8c\u4e09\u56db\u4e94\u516d\u4e03\u516b\u4e5d\u5341\u767e\u5343\u4e07"+Ua+"]+)(?!\u6628)","g");
Ea(y,"today yesterday tomorrow weekday weekend future past".split(" ").concat(V.weekdays.slice(0,7)).concat(V.months.slice(0,12)),function(a,b){a["is"+nc(b)]=function(a){return Tc(this,b,0,a)}});q(y,{utc:{create:function(){return Y(arguments,0,!0)},past:function(){return Y(arguments,-1,!0)},future:function(){return Y(arguments,1,!0)}}},!1);
...
function bd(a){return null==a?a:Ba(a)?a.getTime():a.valueOf()}function cd(a){a=a.toString().split(".");return a[1]?a[1].length:0}function dd(a){return null==a?new y:new y(a)}function $c(a){return Ba(a)?new y(a.getTime()):bd(a)}function ed(a){var b=bd(a);return(!!b||0===b)&&-Infinity!==a&&Infinity!==a}
function fd(a){var b;if(H(a))return a;b=a.match(Xc);a=parseInt(b[1])||1;b=b[2].slice(0,1).toUpperCase()+b[2].slice(1).toLowerCase();b.match(/hour|minute|second/i)?b+="s":"Year"===b?b="FullYear":"Day"===b&&(b="Date");return[a,b]}function gd(a,b){var c,d,e,f;if(H(b))return new y(a.getTime()+b);c=b[0];d=b[1];e=S(a,d);f=new y(a.getTime());cb(f,d,e+c);return f}function hd(a,b){return z.fromCharCode(a.charCodeAt(0)+b)}function id(a,b,c){return Ta(a+b,c)}
Range.prototype.toString=function(){return this.isValid()?this.start+".."+this.end:"Invalid Range"};
q(Range,{isValid:function(){return ed(this.start)&&ed(this.end)&&typeof this.start===typeof this.end},span:function(){return this.isValid()?Oa(ad(this.end)-ad(this.start))+1:NaN},contains:function(a){return null==a?!1:a.start&&a.end?a.start>=this.start&&a.start<=this.end&&a.end>=this.start&&a.end<=this.end:a>=this.start&&a<=this.end},every:function(a,b){var c,d,e=this.start,f=this.end,g=f<e,h=e,m=0,p=[];if(!this.isValid())return[];K(a)&&(b=a,a=null);a=a||1;H(e)?(c=id,d=Q(cd(e),cd(a))):I(e)?c=hd:Ba(e)&&
(a=fd(a),c=gd);for(g&&0<a&&(a*=-1);g?h>=f:h<=f;)p.push(h),b&&b(h,m),h=c(h,a,d),m++;return p},union:function(a){return new Range(this.start<a.start?this.start:a.start,this.end>a.end?this.end:a.end)},intersect:function(a){return a.start>this.end||a.end<this.start?new Range(NaN,NaN):new Range(this.start>a.start?this.start:a.start,this.end<a.end?this.end:a.end)},clone:function(){return new Range(this.start,this.end)},clamp:function(a){var b=this.start,c=this.end,d=c<b?c:b,b=b>c?b:c;return $c(a<d?d:a>
b?b:a)}});function jd(a,b){return new Range(a,b)}function kd(a,b){if(G.create){if(1===arguments.length&&I(a)){var c;c=a;var d,e,f,g,h;if(d=c.match(Wc))c=kd(d[1],d[2]);else{if(d=c.match(Yc))f=d[1],e=d[2];if(d=c.match(Zc))e=d[1],f=d[2];e&&f&&(g=G.create(e),h=gd(g,fd(f)));c=kd(g,h)}return c}a=G.create(a);b=G.create(b)}else a=dd(a),b=dd(b);return new Range(a,b)}q(A,{range:jd},!1);q(z,{range:jd},!1);q(y,{range:kd},!1);
...
function ld(a,b,c,d,e){Infinity!==b&&(a.timers||(a.timers=[]),H(b)||(b=1),a.ja=!1,a.timers.push(setTimeout(function(){a.ja||c.apply(d,e||[])},b)))}
function md(a){var b=a.timers,c;if(J(b))for(;c=b.shift();)clearTimeout(c);a.ja=!0;return a}function nd(a,b,c,d){function e(){f.length<d-(g&&c?1:0)&&f.push([this,arguments]);g||(g=!0,c?h():ld(e,m,h));return w}var f=[],g=!1,h,m,p,w;b=b||1;d=d||Infinity;m=Qa(b);p=Ra(m/b)||1;h=function(){var b=f.length,c;if(0!=b){for(c=Q(b-p,0);b>c;)w=oa.prototype.apply.apply(a,f.shift()),b--;ld(e,m,function(){g=!1;h()})}};return e}
q(oa,{lazy:function(a,b,c){return nd(this,a,b,c)},throttle:function(a){return nd(this,a,!0,1)},debounce:function(a){function b(){md(b);ld(b,a,c,this,arguments)}var c=this;return b},delay:function(a){var b=M(arguments,null,1);ld(this,a,this,this,b);return this},every:function(a){function b(){c.apply(c,d);ld(c,a,b)}var c=this,d=arguments,d=1<d.length?M(d,null,1):[];ld(c,a,b);return c},cancel:function(){return md(this)},after:function(a){var b=this,c=0,d=[];if(!H(a))a=1;else if(0===a)return b.call(),
b;return function(){var e;d.push(M(arguments));c++;if(c==a)return e=b.call(this,d),c=0,d=[],e}},once:function(){return nd(this,Infinity,!0,1)},fill:function(){var a=this,b=M(arguments);return function(){var c=M(arguments);b.forEach(function(a,b){(null!=a||b>=c.length)&&c.splice(b,0,a)});return a.apply(this,c)}}});
function od(a,b,c,d,e,f){var g=a.toFixed(20),h=g.search(/\./),g=g.search(/[1-9]/),h=h-g;0<h&&(h-=1);e=Q(Sa(P(h/3),!1===e?c.length:e),-d);d=c.charAt(e+d-1);-9>h&&(e=-3,b=Oa(h)-9,d=c.slice(0,1));c=f?Pa(2,10*e):Pa(10,3*e);return pd(Ta(a/c,b||0))+d.trim()}
...
q(A,{log:function(a){return E.log(this)/(a?E.log(a):1)},abbr:function(a){return od(this,a,"kmbt",0,4)},metric:function(a,b){return od(this,a,"n\u03bcm kMGTPE",4,O(b)?1:b)},bytes:function(a,b,c){return od(this,a,"kMGTPE",0,O(b)?4:b,!0!==c)+"B"},isInteger:function(){return 0===this%1},isOdd:function(){return 0===this%1&&0!==this%2},isEven:function(){return 0===this%2},isMultipleOf:function(a){return 0===this%a},format:function(a,b,c){return pd(this,a,b,c)},hex:function(a){return R(this,a||1,!1,16)},
times:function(a){if(a)for(var b=0;b<this;b++)a.call(this,b);return+this},chr:function(){return z.fromCharCode(this)},pad:function(a,b,c){return R(this,a,b,c)},ordinalize:function(){var a=Oa(this);return this+$a(parseInt(a.toString().slice(-2)))},toNumber:function(){return parseFloat(this,10)}});
(function(){function a(a){return function(c){return c?Ta(this,c,a):a(this)}}q(A,{ceil:a(Qa),round:a(Ra),floor:a(P)});Ea(A,"abs,pow,sin,asin,cos,acos,tan,atan,exp,pow,sqrt",function(a,c){a[c]=function(a,b){return E[c](this.valueOf(),a,b)}})})();
var qd=["isObject","isNaN"],rd="equals keys values select reject each map size merge clone watch tap has toQueryString".split(" ");
function sd(a,b,c,d){var e,f,g;(f=b.match(/^(.+?)(\[.*\])$/))?(g=f[1],b=f[2].replace(/^\[|\]$/g,"").split("]["),b.forEach(function(b){e=!b||b.match(/^\d+$/);!g&&J(a)&&(g=a.length);u(a,g)||(a[g]=e?[]:{});a=a[g];g=b}),!g&&e&&(g=a.length.toString()),sd(a,g,c,d)):a[b]=d&&"true"===c?!0:d&&"false"===c?!1:c}function td(a,b){var c;return J(b)||L(b)&&b.toString===sa?(c=[],r(b,function(b,e){a&&(b=a+"["+b+"]");c.push(td(b,e))}),c.join("&")):a?ud(a)+"="+(Ba(b)?b.getTime():ud(b)):""}
function ud(a){return a||!1===a||0===a?encodeURIComponent(a).replace(/%20/g,"+"):""}function vd(a,b,c){var d,e=a instanceof Na?new Na:{};r(a,function(a,g){d=!1;Ha(b,function(b){(Ca(b)?b.test(a):L(b)?b[a]===g:a===z(b))&&(d=!0)},1);d===c&&(e[a]=g)});return e}var wd=n.getOwnPropertyNames,yd=ea?n.defineProperty:xd,Ad=ea?n.getOwnPropertyDescriptor:zd,Cd=ea?Bd:r;function Bd(a,b){wd(a).forEach(b)}function zd(a,b){return a.hasOwnProperty(b)?{value:a[b]}:void 0}function xd(a,b,c){a[b]=c.value}
function Dd(a,b,c,d){if(Ga(b))return a;Cd(b,function(e){var f=Ad(b,e),g=Ad(a,e),h=f&&f.value,m=g&&g.value,p=L(h),p=c&&p;if(N(g)&&null!=g.value){if(!p&&!1===d)return;K(d)&&(f.value=d.call(b,e,m,h))}p&&(g=m,Ba(h)?h=new y(h.getTime()):Ca(h)?h=new x(h.source,ab(h)):(L(g)||(g=J(h)?[]:{}),h=Dd(g,h,c,d)),f.value=h);yd(a,e,f)});return a}function Ed(){var a=n.prototype;qd.concat(rd).forEach(function(b){a[b]&&delete a[b]})}
q(n,{watch:function(a,b,c){var d,e;if(!ea)return!1;e=Ad(a,b);if(!e.configurable||e.get||e.set)return!1;d=e.value;yd(a,b,{enumerable:e.enumerable,configurable:e.configurable,get:function(){return d},set:function(e){d=c.call(a,b,d,e)}});return!0}},!1,!0,!0);q(n,{keys:function(a,b){var c=n.keys(a);c.forEach(function(c){b.call(a,c,a[c])});return c}},!1,function(){return 1<arguments.length});
...
new Na;else if(J(a,c))c=[];else if(Ja(a,c))c={};else throw new TypeError("Clone must be a basic data type.");return Dd(c,a,b)},fromQueryString:function(a,b){var c=new Na;a=a&&a.toString?a.toString():"";a.replace(/^.*?\?/,"").split("&").forEach(function(a){a=a.split("=");2===a.length&&sd(c,a[0],decodeURIComponent(a[1]),b)});return c},toQueryString:function(a,b){return td(b,a)},tap:function(a,b){var c=b;K(b)||(c=function(){if(b)a[b]()});c.call(a,a);return a},has:function(a,b){return u(a,b)},select:function(a){return vd(a,
arguments,!0)},reject:function(a){return vd(a,arguments,!1)},map:function(a,b){var c={},d,e;for(d in a)u(a,d)&&(e=a[d],c[d]=T(e,b,a,[d,e,a]));return c},each:function(a,b){Ia(b);r(a,b);return a},size:function(a){return n.keys(Ma(a)).length}},!1);q(Sugar,{extendObject:function(a){!1!==a?ib(qd.concat(rd),n):Ed();return!0}},!1);Ea(n,fa,function(a,b){var c="is"+b;qd.push(c);a[c]=va[b]},!1);ib(rd,Na);
...
var Fd=/&#(x)?([\w\d]{0,5});/i,Gd="area base br col command embed hr img input keygen link meta param source track wbr".split(" ");function Hd(a){a=+a;if(0>a||Infinity===a)throw new RangeError("Invalid number");return a}
function Id(a,b){return Ya(N(b)?b:" ",a)}function Jd(a,b,c,d,e){var f;if(a.length<=b)return a.toString();d=O(d)?"...":d;switch(c){case "left":return a=e?Kd(a,b,!0):a.slice(a.length-b),d+a;case "middle":return c=Qa(b/2),f=P(b/2),b=e?Kd(a,c):a.slice(0,c),a=e?Kd(a,f,!0):a.slice(a.length-f),b+d+a;default:return b=e?Kd(a,b):a.slice(0,b),b+d}}
function Ld(a,b,c){var d,e,f;K(b)?(c=b,b=/[\s\S]/g):b?I(b)?b=x(bb(b),"gi"):Ca(b)&&(b=x(b.source,ab(b,"g"))):b=/[\s\S]/g;f=a.match(b)||[];if(c)for(b=0,d=f.length;b<d;b++)if(e=c.call(a,f[b],b,f),!1===e){f.length=b+1;break}else N(e)&&(f[b]=e);return f}function Md(a,b){return Ld(a.trim(),/\S+/g,b)}function Nd(a,b){var c=[],d,e;d=0;for(e=a.length;d<e;d++){var f=a.charCodeAt(d);c.push(f);b&&b.call(a,f,d)}return c}function Od(a,b){var c="";b=b||0;Nd(a,function(a){c+=z.fromCharCode(a+b)});return c}
function Pd(a){var b=qa.Inflector;return a.replace(/[-\s]+/g,"_").replace(b&&b.ma,function(a,b){return(0<b?"_":"")+a.toLowerCase()}).replace(/([A-Z\d]+)([A-Z][a-z])/g,"$1_$2").replace(/([a-z\d])([A-Z])/g,"$1_$2").toLowerCase()}function Qd(a,b){var c;return a.toLowerCase().replace(b?/[^']/g:/^\S/,function(a){var b=a.toUpperCase(),f;f=c?a:b;c=b!==a;return f})}function Rd(a){return a.split("").reverse().join("")}function Sd(a,b){O(b)&&(b=1);return a.substr(0,b)}
function Z(a,b){var c={};Ha(b,function(a,b){L(a)?La(c,a):c[b+1]=a});return a.replace(/\{([^{]+?)\}/g,function(a,b){return u(c,b)?c[b]:a})}function Kd(a,b,c){if(c)return Rd(Kd(Rd(a),b));c=x("(?=["+Xa()+"])");var d=0;return a.split(c).filter(function(a){d+=a.length;return d<=b}).join("")}function Td(a){return a.replace(Fd,function(a,c,d){return z.fromCharCode(parseInt(d,c?16:10))})}
function Ud(a,b,c){var d=b.length-1,e=b[d],f;K(e)&&(f=e,b.length=d);b=Ha(b).map(function(a){return bb(a)}).join("|");b=x("<(\\/)?("+(b||"[^\\s>]+")+")\\s*([^<>]*?)\\s*(\\/)?\\s*>","gi");return Vd(a,b,c,f)}
function Vd(a,b,c,d,e){function f(f,g,k,p){var s=a.slice(m,f);d?(g=d.call(e,g,s,k,e),N(g)?s=g:c||(s="")):c||(s="");h+=Vd(s,b,c,d,e);m=f+(p||0)}var g,h="",m=0,p,w,C=0;e=e||a;for(b=x(b.source,"gi");g=b.exec(a);){var B=g[2],s=g[3],k=!!g[1],D=!!g[4],ra=g[0].length,D=!k&&!D&&-1===Gd.indexOf(B.toLowerCase()),la=B===p;p||(h+=a.slice(m,g.index),m=g.index);D?p?la&&C++:(p=B,w=s,C++,m+=ra):k&&la?(C--,0===C&&(f(g.index,p,w,ra),w=p=null)):p||f(g.index,B,s,ra)}p&&f(a.length,p,w);return h+=a.slice(m)}
function Wd(a,b,c){I(b)&&(b=a.indexOf(b),-1===b&&(b=c?a.length:0));return b}var Xd,Yd;function Zd(a){if(null==a)throw new TypeError;return z(a)}function $d(a){if(Ca(a))throw new TypeError;return z(a)}q(z,{contains:function(a){return-1<Zd(this).indexOf(a,arguments[1])},repeat:function(a){a=Hd(a);return Ya(this,a)}},!0,!0);
...
decodeBase64:function(){return Yd(this)},each:function(a,b){return Ld(this,a,b)},map:function(a,b){var c=this.toString();if(K(a)){var d=a;a=function(a,f){return d.call(b,a,f,c)}}return c.split("").map(a,b).join("")},shift:function(a){return Od(this,a)},codes:function(a){return Nd(this,a)},chars:function(a){return Ld(this,a)},words:function(a){return Md(this,a)},lines:function(a){return Ld(this.trim(),/^.*$/gm,a)},paragraphs:function(a){var b=this.trim().split(/[\r\n]{2,}/);return b=b.map(function(b){if(a)var d=
a.call(b);return d?d:b})},isBlank:function(){return 0===this.trim().length},add:function(a,b){b=O(b)?this.length:b;return this.slice(0,b)+a+this.slice(b)},remove:function(a){return this.replace(a,"")},reverse:function(){return Rd(this)},compact:function(){return this.trim().replace(/([\r\n\s\u3000])+/g,function(a,b){return"\u3000"===b?b:" "})},at:function(){return gb(this,arguments,!0)},from:function(a){return this.slice(Wd(this,a,!0))},to:function(a){O(a)&&(a=this.length);return this.slice(0,Wd(this,
a))},dasherize:function(){return Pd(this).replace(/_/g,"-")},underscore:function(){return Pd(this)},camelize:function(a){return Pd(this).replace(/(^|_)([^_]+)/g,function(b,c,d,e){b=(b=qa.Inflector)&&b.acronyms[d];b=I(b)?b:void 0;e=!1!==a||0<e;return b?e?b:b.toLowerCase():e?Qd(d):d})},spacify:function(){return Pd(this).replace(/_/g," ")},stripTags:function(){return Ud(this,arguments,!0)},removeTags:function(){return Ud(this,arguments,!1)},truncate:function(a,b,c){return Jd(this,a,b,c)},truncateOnWord:function(a,
b,c){return Jd(this,a,b,c,!0)},pad:function(a,b){var c,d;a=Hd(a);c=Q(0,a-this.length)/2;d=P(c);c=Qa(c);return Id(d,b)+this+Id(c,b)},padLeft:function(a,b){a=Hd(a);return Id(Q(0,a-this.length),b)+this},padRight:function(a,b){a=Hd(a);return this+Id(Q(0,a-this.length),b)},first:function(a){return Sd(this,a)},last:function(a){O(a)&&(a=1);return this.substr(0>this.length-a?0:this.length-a)},toNumber:function(a){return Za(this,a)},capitalize:function(a){return Qd(this,a)},assign:function(){return Z(this,
arguments)},trimLeft:function(){return this.replace(x("^["+Xa()+"]+"),"")},trimRight:function(){return this.replace(x("["+Xa()+"]+$"),"")}});ka(z,"insert","add");
(function(){var a=!0;try{"".startsWith(/./)}catch(b){a=!1}q(z,{startsWith:function(a){var b,e,f,g;f=arguments[1];b=Zd(this);a=$d(a);e=A(f)||0;f=b.length;e=Sa(Q(e,0),f);g=a.length;return g+e>f?!1:b.substr(e,g)===a?!0:!1},endsWith:function(a){var b,e,f,g=arguments[1];b=Zd(this);a=$d(a);f=e=b.length;N(g)&&(f=A(g)||0);e=Sa(Q(f,0),e);f=a.length;e-=f;return 0>e?!1:b.substr(e,f)===a?!0:!1}},!0,!0,a)})();
...
(B=64),c=c+a.charAt(w)+a.charAt(d)+a.charAt(C)+a.charAt(B);while(s<b.length);return c};d=function(b){var c="",d,m,p,w,C,B=0;if(b.match(e))return"";b=b.replace(/[^A-Za-z0-9\+\/\=]/g,"");do d=a.indexOf(b.charAt(B++)),m=a.indexOf(b.charAt(B++)),w=a.indexOf(b.charAt(B++)),C=a.indexOf(b.charAt(B++)),d=d<<2|m>>4,m=(m&15)<<4|w>>2,p=(w&3)<<6|C,c+=z.fromCharCode(d),64!=w&&(c+=z.fromCharCode(m)),64!=C&&(c+=z.fromCharCode(p));while(B<b.length);return c}}Xd=function(a){return c(unescape(encodeURIComponent(a)))};
Yd=function(a){return decodeURIComponent(escape(d(a)))}}})("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=");
var ae=[],be=[],ce=[],de=[],ee={},fe,$,ge={},he,ie;function je(a){var b=ce;a=b.indexOf(a);-1<a&&b.splice(a,1)}function ke(a,b,c){I(b)&&je(b);je(c);a.unshift({ia:b,la:c})}function le(a,b){return a==b||"all"==a||!a}function me(a){return ce.some(function(b){return(new x("\\b"+b+"$","i")).test(a)})}
function ne(a,b){a=I(a)?a.toString():"";return 0===a.trim().length||me(a)?a:oe(a,b?ae:be)}function oe(a,b){r(b,function(b,d){if(a.match(d.ia))return a=a.replace(d.ia,d.la),!1});return a}function pe(a){return a.replace(/^\W*[a-z]/,function(a){return a.toUpperCase()})}function qe(a){a=oe(a,de);var b;a=a.replace(/_id$/g,"");a=a.replace(/(_)?([a-z\d]*)/gi,function(a,d,e){a=e.toLowerCase();b=u(ee,a)?ee[a]:null;return(d?" ":"")+(b||a)});return pe(a)}
function re(a){return a.replace(he,function(a){return ge[a]})}
$={acronym:function(a){ee[a.toLowerCase()]=a;a=n.keys(ee).map(function(a){return ee[a]});$.ma=x(a.join("|"),"g")},plural:function(a,b){ke(ae,a,b)},singular:function(a,b){ke(be,a,b)},irregular:function(a,b){var c=Sd(a),d=a.slice(Wd(a,1,!0)),e=Sd(b),f=b.slice(Wd(b,1,!0)),g=e.toUpperCase(),h=e.toLowerCase(),m=c.toUpperCase(),p=c.toLowerCase();je(a);je(b);m==g?($.plural(new x(Z("({1}){2}$",[c,d]),"i"),"$1"+f),$.plural(new x(Z("({1}){2}$",[e,f]),"i"),"$1"+f),$.singular(new x(Z("({1}){2}$",[e,f]),"i"),
"$1"+d)):($.plural(new x(Z("{1}{2}$",[m,d])),g+f),$.plural(new x(Z("{1}{2}$",[p,d])),h+f),$.plural(new x(Z("{1}{2}$",[g,f])),g+f),$.plural(new x(Z("{1}{2}$",[h,f])),h+f),$.singular(new x(Z("{1}{2}$",[g,f])),m+d),$.singular(new x(Z("{1}{2}$",[h,f])),p+d))},uncountable:function(a){var b=v.isArray(a)?a:M(arguments);ce=ce.concat(b)},human:function(a,b){de.unshift({ia:a,la:b})},clear:function(a){le(a,"singulars")&&(be=[]);le(a,"plurals")&&(ae=[]);le(a,"uncountables")&&(ce=[]);le(a,"humans")&&(de=[]);le(a,
"acronyms")&&(ee={})}};fe="and or nor a an the so but to of at by from into on onto off out in over with for".split(" ");$.plural(/$/,"s");$.plural(/s$/gi,"s");$.plural(/(ax|test)is$/gi,"$1es");$.plural(/(octop|fung|foc|radi|alumn|cact)(i|us)$/gi,"$1i");$.plural(/(census|alias|status|fetus|genius|virus)$/gi,"$1es");$.plural(/(bu)s$/gi,"$1ses");$.plural(/(buffal|tomat)o$/gi,"$1oes");$.plural(/([ti])um$/gi,"$1a");$.plural(/([ti])a$/gi,"$1a");$.plural(/sis$/gi,"ses");$.plural(/f+e?$/gi,"ves");
...
q(z,{pluralize:function(){return ne(this,!0)},singularize:function(){return ne(this,!1)},humanize:function(){return qe(this)},titleize:function(){var a=/[.:;!]$/,b,c,d,e=qe(Pd(this).replace(/_/g," "));return Md(e,function(e,g,h){b=a.test(e);d=0==g||g==h.length-1||b||c;c=b;return d||-1===fe.indexOf(e)?pe(e):e}).join(" ")},parameterize:function(a){var b=re(this);void 0===a&&(a="-");b=b.replace(/[^a-z0-9\-_]+/gi,a);a&&(b=b.replace(new x(Z("^{sep}+|{sep}+$|({sep}){sep}+",[{sep:bb(a)}]),"g"),"$1"));return encodeURI(b.toLowerCase())},
toAscii:function(){return re(this)}});qa.Inflector=$;qa.Inflector.acronyms=ee;(function(){var a,b,c="";for(a in ie)ie.hasOwnProperty(a)&&(b=ie[a],b.split("").forEach(function(b){ge[b]=a}),c+=b);he=RegExp("["+c+"]","g")})();
var se=[{type:"a",start:65,end:90},{type:"a",start:97,end:122},{type:"n",start:48,end:57},{type:"p",start:33,end:47},{type:"p",start:58,end:64},{type:"p",start:91,end:96},{type:"p",start:123,end:126}],te,ue=/[\u0020-\u00A5]|[\uFF61-\uFF9F][\uff9e\uff9f]?/g,ve=/[\u3000-\u301C]|[\u301A-\u30FC]|[\uFF01-\uFF60]|[\uFFE0-\uFFE6]/g,we=/[\u30ab\u30ad\u30af\u30b1\u30b3\u30b5\u30b7\u30b9\u30bb\u30bd\u30bf\u30c1\u30c4\u30c6\u30c8\u30cf\u30d2\u30d5\u30d8\u30db]/,xe=/[\u30cf\u30d2\u30d5\u30d8\u30db\u30f2]/;
function ye(a,b,c,d){te||ze();var e=M(b).join(""),f=te[d],e=e.replace(/all/,"").replace(/(\w)lphabet|umbers?|atakana|paces?|unctuation/g,"$1");return a.replace(c,function(a){return!f[a]||e&&-1===e.indexOf(f[a].type)?a:f[a].to})}
function ze(){var a;te={zenkaku:{},hankaku:{}};se.forEach(function(a){Ka(a.end-a.start+1,function(c){c+=a.start;Ae(a.type,z.fromCharCode(c),z.fromCharCode(c+65248))})});Ld("\u30a2\u30a4\u30a6\u30a8\u30aa\u30a1\u30a3\u30a5\u30a7\u30a9\u30ab\u30ad\u30af\u30b1\u30b3\u30b5\u30b7\u30b9\u30bb\u30bd\u30bf\u30c1\u30c4\u30c3\u30c6\u30c8\u30ca\u30cb\u30cc\u30cd\u30ce\u30cf\u30d2\u30d5\u30d8\u30db\u30de\u30df\u30e0\u30e1\u30e2\u30e4\u30e3\u30e6\u30e5\u30e8\u30e7\u30e9\u30ea\u30eb\u30ec\u30ed\u30ef\u30f2\u30f3\u30fc\u30fb",function(b,
...
function(a,c){Ae("p","\uff61\uff64\uff62\uff63\u00a5\u00a2\u00a3".charAt(c),a)});Ae("k","\uff73\uff9e","\u30f4");Ae("k","\uff66\uff9e","\u30fa");Ae("s"," ","\u3000")}function Ae(a,b,c){te.zenkaku[b]={type:a,to:c};te.hankaku[c]={type:a,to:b}}function Be(a,b){return ye(a,b,ue,"zenkaku")}
q(z,{hankaku:function(){return ye(this,arguments,ve,"hankaku")},zenkaku:function(){return Be(this,arguments)},hiragana:function(a){var b=this;!1!==a&&(b=Be(b,["k"]));return b.replace(/[\u30A1-\u30F6]/g,function(a){return Od(a,-96)})},katakana:function(){return this.replace(/[\u3041-\u3096]/g,function(a){return Od(a,96)})}});

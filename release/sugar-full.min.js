...
function Oc(a){var b=G.millisecondsFromNow(a);a.getTime()>z.now()&&(a=new z(a.getTime()+5));return Mc(b,function(b){return Na(G[b.name+"sFromNow"](a))})}function Pc(a,b,c){function d(a,c){var d=T(a,"Month");return X(c).months[d+12*b]}Qc(a,d,c);Qc(mc(a),d,c,1)}function Qc(a,b,c,d){W[a]=function(a,f){var g=b(a,f);c&&(g=g.slice(0,c));d&&(g=g.slice(0,d).toUpperCase()+g.slice(d));return g}}

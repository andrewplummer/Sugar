...
arguments)},clone:function(){return na([],this)},unique:function(a){return Ca(this,a)},flatten:function(a){return Ea(this,a)},union:function(){return Ca(this.concat(Ha(arguments)))},intersect:function(){return Da(this,Ha(arguments),m)},subtract:function(){return Da(this,Ha(arguments),j)},at:function(){return ta(this,arguments)},first:function(a){if(L(a))return this[0];if(a<0)a=0;return this.slice(0,a)},last:function(a){if(L(a))return this[this.length-1];return this.slice(this.length-a<0?0:this.length-
...
function ob(a,b,c){var d=new t,e=m,g,f,i,h,l,n,o,q,B;if(fa(a))d=a.clone();else if(D(a))d=new t(a);else if(la(a)){d=(new t).set(a,j);h=a}else if(E(a)){g=hb(b);a=mb(a);g&&I(g.wa(),function(C,A){var Fa=a.match(A.Ca);if(Fa){i=A;f=i.Aa;h=lb(Fa,i.to,f);f.oa=i;if(h.timestamp){h=h.timestamp;return m}if(i.Ea&&!E(h.month)&&(E(h.date)||g.ya(b))){q=h.month;h.month=h.date;h.date=q}if(h.year&&h.Fa.length===2)h.year=O((new t).getFullYear()/100)*100-O(h.year/100)*100+h.year;if(h.month){h.month=f.getMonth(h.month);

...
function na(a,b,c,d){var e=E(b).join("");e=e.replace(/all/,"").replace(/(\w)lphabet|umbers?|atakana|paces?|unctuation/g,"$1");return a.replace(c,function(f){return d[f]&&(!e||e.has(d[f].type))?d[f].to:f})}
var oa=[{type:"a",shift:65248,start:65,end:90},{type:"a",shift:65248,start:97,end:122},{type:"n",shift:65248,start:48,end:57},{type:"p",shift:65248,start:33,end:47},{type:"p",shift:65248,start:58,end:64},{type:"p",shift:65248,start:91,end:96},{type:"p",shift:65248,start:123,end:126}],pa={},qa={},ra=/[\u0020-\u00A5]|[\uFF61-\uFF9F][ﾞﾟ]?/g,sa=/[\u3000-\u301C]|[\u301A-\u30FC]|[\uFF01-\uFF60]|[\uFFE0-\uFFE6]/g,ta=/[カキクケコサシスセソタチツテトハヒフヘホ]/,ua=/[ハヒフヘホヲ]/;
function U(a,b,c){pa[b]={type:a,to:c};qa[c]={type:a,to:b}}function R(a,b,c,d){var e=String(b);if(e!=b)e="";p.isNumber(c)||(c=1);p.isNumber(d)||(d=1);return e.repeat(c)+a+e.repeat(d)}

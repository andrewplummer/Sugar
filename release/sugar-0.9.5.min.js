...
a.constructor===Object},each:function(a,b){p(a,function(c,d){b&&b.call(a,c,d,a)});return a},merge:function(){var a=arguments[0];r(arguments,function(b){typeof b==="object"&&p(b,function(c,d){a[c]=d})},1);return a},isEmpty:function(a){if(!a)return true;return A(a,{})},equals:function(a,b){return A(a,b)},values:function(a,b){var c=[];p(a,function(d,e){c.push(e);b&&b.call(a,e)});return c},clone:E,fromQueryString:function(a,b){var c={};a.replace(/^.*?\?/,"").unescapeURL().split("&").each(function(d){d=
d.split("=");S(c,d[0],d[1],b)});return c}});k(Object,false,function(){return arguments.length<2},{keys:function(a,b){if(a===null||typeof a!="object")throw new TypeError("object required");var c=[];p(a,function(d){c.push(d);b&&b.call(a,d)});return c}});k(Array,false,false,{isArray:function(a){return L(a,"Array")}});k(Array,true,function(){return arguments.length===0||Object.isFunction(arguments[0])},{every:function(a,b){var c=this.length,d=0;for(D(arguments);d<c;){if(d in this&&!v(this[d],a,b,[d,this]))return false;
d++}return true},some:function(a,b){var c=this.length,d=0;for(D(arguments);d<c;){if(d in this&&v(this[d],a,b,[d,this]))return true;d++}return false},map:function(a,b){var c=this.length,d=0,e=Array(c);for(D(arguments);d<c;){if(d in this)e[d]=x(arguments,this[d],b,[d,this]);d++}return e},filter:function(a,b){var c=this.length,d=0,e=[];for(D(arguments);d<c;){d in this&&v(this[d],a,b,[d,this])&&e.push(this[d]);d++}return e}});k(Array,true,false,{indexOf:function(a,b){var c=this.length,d=isNaN(b)?0:parseInt(b>>
0);if(Object.isString(this))return this.indexOf(a,b);if(d<0)d=Math.max(c+d,0);if(c==0||d>c)return-1;for(;d<c;){if(d in this&&this[d]===a)return d;d++}return-1},lastIndexOf:function(a,b){var c=this.length,d=isNaN(b)?c:parseInt(b>>0);if(Object.isString(this))return this.lastIndexOf(a,b);if(d<0)d=c+d;if(c==0||d<0)return-1;for(;d>=0;){if(d in this&&this[d]===a)return d;d--}return-1},forEach:function(a,b){var c=this.length,d=0;for(C(a);d<c;){d in this&&a.call(b,this[d],d,this);d++}},reduce:function(a,
b){var c=this.length,d=0,e=arguments.length>1&&b;C(a);if(c==0&&!e)throw new TypeError("Reduce called on empty array with no initial value");else if(e)e=e;else{e=this[d];d++}for(;d<c;){if(d in this)e=a.call(undefined,e,this[d],d,this);d++}return e},reduceRight:function(a,b){var c=this.length,d=c-1,e=arguments.length>1&&b;C(a);if(c==0&&!e)throw new TypeError("Reduce called on empty array with no initial value");else if(e)c=e;else{c=this[d];d--}for(;d>=0;){if(d in this)c=a.call(undefined,c,this[d],d,
this);d--}return c},each:function(a,b,c){m(this,a,b,c);return this},find:function(a,b,c){return u(this,a,b,c)},findAll:function(a,b,c){var d=[];m(this,function(e,f,g){v(e,a,g,[f,g])&&d.push(e)},b,c);return d},count:function(a){if(a===undefined)return this.length;return this.findAll(a).length},none:function(){return!this.any.apply(this,arguments)},remove:function(){var a,b=this;r(arguments,function(c){for(a=0;a<b.length;)if(v(b[a],c,b,[a,b]))b.splice(a,1);else a++});return b},removeAt:function(a,b){if(a===
undefined)return this;if(b===undefined)b=a;for(var c=0;c<=b-a;c++)this.splice(a,1);return this},add:function(a,b){if(!Object.isNumber(b)||isNaN(b))b=this.length;Array.prototype.splice.apply(this,[b,0].concat(a));return this},include:function(a,b){return this.clone().add(a,b)},exclude:function(){return Array.prototype.remove.apply(this.clone(),arguments)},clone:function(){return this.concat()},unique:function(){return w(this)},union:function(){var a=this;r(arguments,function(b){a=a.concat(b)});return w(a)},
intersect:function(){var a=[],b=arguments;this.each(function(c){r(b,function(d){Array.isArray(d)||(d=[d]);u(a,c)===undefined&&u(d,c)!==undefined&&a.push(c)})});return a},subtract:function(){var a=this.clone();r(arguments,function(b){Array.isArray(b)||(b=[b]);b.each(function(c){a.remove(c)})});return a},at:function(){return Q(this,arguments,false)},first:function(a){if(a===undefined)return this[0];if(a<0)a=0;return this.slice(0,a)},last:function(a){if(a===undefined)return this[this.length-1];return this.slice(this.length-
a<0?0:this.length-a)},from:function(a){return this.slice(a)},to:function(a){if(a===undefined)a=this.length;return this.slice(0,a)},min:function(){return w(B(this,arguments,"min"))},max:function(){return w(B(this,arguments,"max"))},least:function(){var a=B(this.groupBy.apply(this,arguments),["length"],"min").flatten();return a.length===this.length?[]:w(a)},most:function(){var a=B(this.groupBy.apply(this,arguments),["length"],"max").flatten();return a.length===this.length?[]:w(a)},sum:function(a){a=
a?this.map(a):this;return a.length>0?a.reduce(function(b,c){return b+c}):0},average:function(a){a=a?this.map(a):this;return a.length>0?a.sum()/a.length:0},groupBy:function(){var a={},b=arguments,c;this.each(function(d){c=x(b,d);a[c]||(a[c]=[]);a[c].push(d)});return a},inGroups:function(a,b){var c=arguments.length>1,d=this,e=[],f=Math.ceil(this.length/a);(0).upto(a-1,function(g){g=g*f;var h=d.slice(g,g+f);c&&h.length<f&&(f-h.length).times(function(){h=h.add(b)});e.push(h)});return e},inGroupsOf:function(a,
b){if(this.length===0||a===0)return this;if(a===undefined)a=1;if(b===undefined)b=null;var c=[],d=null;this.each(function(e,f){if(f%a===0){d&&c.push(d);d=[]}if(e===undefined)e=b;d.push(e)});if(!this.length.isMultipleOf(a)){(a-this.length%a).times(function(){d.push(b)});this.length+=a-this.length%a}d.length>0&&c.push(d);return c},compact:function(a){var b=[];this.each(function(c){if(Array.isArray(c))b.push(c.compact());else if(a&&c)b.push(c);else if(!a&&c!==undefined&&c!==null&&(typeof c!="number"||
!isNaN(c)))b.push(c)});return b},isEmpty:function(){return this.compact().length==0},flatten:function(){var a=[];this.each(function(b){if(Array.isArray(b))a=a.concat(b.flatten());else a.push(b)});return a},sortBy:function(a,b){var c=arguments;this.sort(function(d,e){var f=x(c,d),g=x(c,e),h=typeof f=="number";return h&&b?g-f:h&&!b?f-g:f===g?0:b?f<g?1:-1:f<g?-1:1});return this},randomize:function(){for(var a=this.concat(),b,c,d=a.length;d;b=parseInt(Math.random()*d),c=a[--d],a[d]=a[b],a[b]=c);return a}});
k(Array,true,false,{all:Array.prototype.every,any:Array.prototype.some,has:Array.prototype.some,insert:Array.prototype.add});var M=function(a,b,c){c=Math[c];var d=Math.pow(10,Math.abs(b||0));if(b<0)d=1/d;return c(a*d)/d};k(Number,false,false,{random:function(a,b){var c;if(arguments.length==1){b=a;a=0}c=Math.min(a||0,b||1);return Math.round(Math.random()*(Math.max(a||0,b||1)-c)+c)}});k(Number,true,false,{toNumber:function(){return parseFloat(this,10)},ceil:function(a){return M(this,a,"ceil")},floor:function(a){return M(this,
a,"floor")},abs:function(){return Math.abs(this)},pow:function(a){if(a===undefined||a==null)a=1;return Math.pow(this,a)},round:function(a){return M(this,a,"round")},chr:function(){return String.fromCharCode(this)},isOdd:function(){return!this.isMultipleOf(2)},isEven:function(){return this.isMultipleOf(2)},isMultipleOf:function(a){return this%a===0},upto:function(a,b,c){return R(this,a,b,c||1)},downto:function(a,b,c){return R(this,a,b,-(c||1))},times:function(a){if(a)for(var b=0;b<this;b++)a.call(this,
b);return this.toNumber()},ordinalize:function(){var a;if(this>=11&&this<=13)a="th";else switch(this%10){case 1:a="st";break;case 2:a="nd";break;case 3:a="rd";break;default:a="th"}return this.toString()+a},pad:function(a,b,c){c=c||10;c=this.toNumber()===0?"":this.toString(c).replace(/^-/,"");c=F(c,"0",a-c.replace(/\.\d+$/,"").length,0);if(b||this<0)c=(this<0?"-":"+")+c;return c},format:function(a,b){a=a||",";b=b||".";var c=this.toString().split("."),d=c[0];c=c.length>1?b+c[1]:"";for(var e=/(\d+)(\d{3})/;e.test(d);)d=
d.replace(e,"$1"+a+"$2");return d+c},hex:function(a){return this.pad(a||1,false,16)}});var ga=[{base:"A",reg:/[A\u24b6\uff21\u00c0\u00c1\u00c2\u1ea6\u1ea4\u1eaa\u1ea8\u00c3\u0100\u0102\u1eb0\u1eae\u1eb4\u1eb2\u0226\u01e0\u00c4\u01de\u1ea2\u00c5\u01fa\u01cd\u0200\u0202\u1ea0\u1eac\u1eb6\u1e00\u0104\u023a\u2c6f]/g},{base:"B",reg:/[B\u24b7\uff22\u1e02\u1e04\u1e06\u0243\u0182\u0181]/g},{base:"C",reg:/[C\u24b8\uff23\u0106\u0108\u010a\u010c\u00c7\u1e08\u0187\u023b\ua73e]/g},{base:"D",reg:/[D\u24b9\uff24\u1e0a\u010e\u1e0c\u1e10\u1e12\u1e0e\u0110\u018b\u018a\u0189\ua779]/g},
{base:"E",reg:/[E\u24ba\uff25\u00c8\u00c9\u00ca\u1ec0\u1ebe\u1ec4\u1ec2\u1ebc\u0112\u1e14\u1e16\u0114\u0116\u00cb\u1eba\u011a\u0204\u0206\u1eb8\u1ec6\u0228\u1e1c\u0118\u1e18\u1e1a\u0190\u018e]/g},{base:"F",reg:/[F\u24bb\uff26\u1e1e\u0191\ua77b]/g},{base:"G",reg:/[G\u24bc\uff27\u01f4\u011c\u1e20\u011e\u0120\u01e6\u0122\u01e4\u0193\ua7a0\ua77d\ua77e]/g},{base:"H",reg:/[H\u24bd\uff28\u0124\u1e22\u1e26\u021e\u1e24\u1e28\u1e2a\u0126\u2c67\u2c75\ua78d]/g},{base:"I",reg:/[I\u24be\uff29\u00cc\u00cd\u00ce\u0128\u012a\u012c\u0130\u00cf\u1e2e\u1ec8\u01cf\u0208\u020a\u1eca\u012e\u1e2c\u0197]/g},
{base:"J",reg:/[J\u24bf\uff2a\u0134\u0248]/g},{base:"K",reg:/[K\u24c0\uff2b\u1e30\u01e8\u1e32\u0136\u1e34\u0198\u2c69\ua740\ua742\ua744\ua7a2]/g},{base:"L",reg:/[L\u24c1\uff2c\u013f\u0139\u013d\u1e36\u1e38\u013b\u1e3c\u1e3a\u0141\u023d\u2c62\u2c60\ua748\ua746\ua780]/g},{base:"M",reg:/[M\u24c2\uff2d\u1e3e\u1e40\u1e42\u2c6e\u019c]/g},{base:"N",reg:/[N\u24c3\uff2e\u01f8\u0143\u00d1\u1e44\u0147\u1e46\u0145\u1e4a\u1e48\u0220\u019d\ua790\ua7a4]/g},{base:"O",reg:/[O\u24c4\uff2f\u00d2\u00d3\u00d4\u1ed2\u1ed0\u1ed6\u1ed4\u00d5\u1e4c\u022c\u1e4e\u014c\u1e50\u1e52\u014e\u022e\u0230\u00d6\u022a\u1ece\u0150\u01d1\u020c\u020e\u01a0\u1edc\u1eda\u1ee0\u1ede\u1ee2\u1ecc\u1ed8\u01ea\u01ec\u00d8\u01fe\u0186\u019f\ua74a\ua74c]/g},
{base:"P",reg:/[P\u24c5\uff30\u1e54\u1e56\u01a4\u2c63\ua750\ua752\ua754]/g},{base:"Q",reg:/[Q\u24c6\uff31\ua756\ua758\u024a]/g},{base:"R",reg:/[R\u24c7\uff32\u0154\u1e58\u0158\u0210\u0212\u1e5a\u1e5c\u0156\u1e5e\u024c\u2c64\ua75a\ua7a6\ua782]/g},{base:"S",reg:/[S\u24c8\uff33\u1e9e\u015a\u1e64\u015c\u1e60\u0160\u1e66\u1e62\u1e68\u0218\u015e\u2c7e\ua7a8\ua784]/g},{base:"T",reg:/[T\u24c9\uff34\u1e6a\u0164\u1e6c\u021a\u0162\u1e70\u1e6e\u0166\u01ac\u01ae\u023e\ua786]/g},{base:"U",reg:/[U\u24ca\uff35\u00d9\u00da\u00db\u0168\u1e78\u016a\u1e7a\u016c\u00dc\u01db\u01d7\u01d5\u01d9\u1ee6\u016e\u0170\u01d3\u0214\u0216\u01af\u1eea\u1ee8\u1eee\u1eec\u1ef0\u1ee4\u1e72\u0172\u1e76\u1e74\u0244]/g},
